...
template<>
void equations<float128, float128>(float128* elem, Cfunction<float128, float128> *F1, grid<float128>& grid1,  float128* params, const My_Int& i, const My_Int& j, const My_Int& k){
...
template<>
void bconditions<float128, float128>(float128* elem, Cfunction<float128, float128> *F1,float128* params,  const My_Int& i, const My_Int& j, const My_Int& k){
    Cfunction<float128,float128> &Qtt=F1[0];
    Cfunction<float128,float128> &Qrr=F1[1];
    Cfunction<float128,float128> &Q=F1[2];
    Cfunction<float128,float128> &B=F1[3];
...
template<>
void ksi2<float128, float128>(float128* elem, Cfunction<float128, float128> *F1, grid<float128>& grid1, float128* params, const My_Int& i, const My_Int& j, const My_Int& k){
    Cfunction<float128,float128> &Qtt=F1[0];
    Cfunction<float128,float128> &Qrr=F1[1];
    Cfunction<float128,float128> &Q=F1[2];
    Cfunction<float128,float128> &B=F1[3];
...
template<>
void psi<float128, float128>(float128* elem, Cfunction<float128, float128> *F1, grid<float128>& grid1, float128* params, const My_Int& i, const My_Int& j, const My_Int& k){
    Cfunction<float128,float128> &Qtt=F1[0];
    Cfunction<float128,float128> &Qrr=F1[1];
    Cfunction<float128,float128> &Q=F1[2];
    Cfunction<float128,float128> &B=F1[3];
