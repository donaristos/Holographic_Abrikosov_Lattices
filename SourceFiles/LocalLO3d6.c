...
elem[37]+=
-4*Q.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*Q.diff(d020,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*Q.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (Qtr.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     Qr2(i,j,k)*Qt1(i,j,k))/(2.*pow(rh,2)) + 
  (Qt2.diff(d001,i,j,k)*L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
...
- (1 - pow(1 - rgrid[i],2))*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     pow(Qr2(i,j,k),2)*Qt1(i,j,k))/(2.*pow(rh,2)) + 
  ...
  (4*Qtt.diff(d010,i,j,k)*pow(rh,4)*(1 - rgrid[i])*
     (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (Qr1.diff(d010,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     (-(pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       4*(1 - rgrid[i])*(L2*R0*Qr2(i,j,k) + 
          2*L1*Qr1(i,j,k)*sqrt(1 + pow(R0,2)))))/(2.*pow(rh,2)) + 
  ...
  Qrr.diff(d010,i,j,k)*(-(((-2*(1 - pow(1 - rgrid[i],2)) + 
            4*pow(1 - rgrid[i],2))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
  ...
  (pow(Qt2.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
       ...
       L2*Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
   (L1*pow(rh,4)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) - (pow(Qt1.diff(d001,i,j,k),2)*L1*
  ...
  Qt1.diff(d010,i,j,k)*((L1*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Q.diff(d010,i,j,k)*(-8*pow(1 - rgrid[i],2) + 
     (8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Q(i,j,k))/
      (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
  ...
  (L1*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
   ...
   (2.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (L1*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
   ...
   (pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Q.diff(d100,i,j,k)*((4*Q.diff(d010,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
     (L1*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*Qt1(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/(L2*pow(rh,4)) + 
