...
elem[113]+=
(2*Qrr.diff(d010,i,j,k)*Qtr.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
   (L1*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) - 
  (2*Qrr.diff(d010,i,j,k)*Qt2.diff(d100,i,j,k)*L2*
  ...
  Qrr.diff(d010,i,j,k)*((-4*Qtr.diff(d010,i,j,k)*
        ...
        Qr1(i,j,k))/
      (L1*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) + 
     (4*Qt1.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
     ...
     (4*Qt2.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),4)*
        pow(1 - rgrid[i],2)*Qr1(i,j,k)*Qr2(i,j,k))/
      (L1*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) + 
     (4*Qt2.diff(d001,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  (2*Qt1.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*pow(rh,4)*(1 - rgrid[i])*Qt1(i,j,k)*
     (((1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  a0.diff(d010,i,j,k)*((-64*a2.diff(d010,i,j,k)*pow(rh,4)*
     ...
     (64*a0.diff(d001,i,j,k)*pow(rh,4)*
      ...
      (L1*L2*pow(-1 + rgrid[i],4)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))) + 
  Qt1.diff(d100,i,j,k)*((-2*Qrr.diff(d010,i,j,k)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  H*((64*L2*pow(q,2)*pow(rh,6)*a0(i,j,k)*
        (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
     ...
     (64*a0.diff(d001,i,j,k)*pow(rh,4)*
      ...
      (L2*pow(-1 + rgrid[i],4)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))) + 
  Qt2.diff(d010,i,j,k)*((16*R.diff(d001,i,j,k)*pow(rh,2)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L1*L2*pow(-1 + rgrid[i],2)*
