...
(-((ar.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*
    ...
    (a2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (L1*L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
    (H*pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),3)*
       pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
       (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             pow(rgrid[i],3) + 
...
+ (4*a0.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*
                    ...
                    (pow(H,2)*pow(-2 + rgrid[i],3)*
                      ...
                      pow(rh,2)*
                       (pow(mu,2)*pow(-2 + rgrid[i],3)*
                        ...
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                  (2.*pow(rh,4))))*
            (16*a0(i,j,k)*pow(1 - rgrid[i],4) + 
              (ar(i,j,k)*pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],4)*
            ...
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                 ...
                 4*pow(rh,2)*
                  (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                    4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
         16*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
     ...
     (4.*L2*(1 - rgrid[i])) + (ar.diff(d001,i,j,k)*
       pow(1 + pow(R0,2),0.25)*
       (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
       pow(-1 + rgrid[i],2)*
