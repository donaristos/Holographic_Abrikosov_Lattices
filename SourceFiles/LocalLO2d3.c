...
elem[18]+=
(-2*pow(Q.diff(d100,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3) - 
  (8*pow(1 - rgrid[i],2)*pow(Q(i,j,k),2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3) - 
  ...
  (8*pow(Q.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),4)*
     pow(1 - rgrid[i],2)*pow(Qr1(i,j,k),2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3) - 
  (8*pow(Q.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  Qr1.diff(d010,i,j,k)*((8*(1 - pow(1 - rgrid[i],2))*
     ...
     (8*Q.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) + 
  (L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (4*(1 - rgrid[i])*(-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     ...
     Qt1(i,j,k)*((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
...
- Qtr(i,j,k)))/(4.*pow(rh,2)) + 
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (R.diff(d100,i,j,k)*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),
   ...
   (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (2*R.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
   ...
   ((32*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (64*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  pow(H,2)*((2*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           pow(Qr1(i,j,k),2)*
           (1 + pow(R0,2) + 
...
+ Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))))/
  ...
  Qt2.diff(d010,i,j,k)*(-((L2*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (4*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      ...
      (pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d001,i,j,k)*(-((L2*pow(1 - pow(1 - rgrid[i],2),3)*
          (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ L2*Qr2(i,j,k)*(Qt1(i,j,k)*(1 + pow(R0,2) + 
   ...
   ((-2*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
  (4*(1 - rgrid[i])*Q(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
        ((pow(-1 + rgrid[i],2)*
             (3*pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],2) + 
               3*pow(H,2)*pow(-2 + rgrid[i],2)*pow(rgrid[i],3) + 
  ...
  ((1 - rgrid[i])*Qrr(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (pow(B(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),7)*
        ((pow(-1 + rgrid[i],2)*
             (3*pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],2) + 
               3*pow(H,2)*pow(-2 + rgrid[i],2)*pow(rgrid[i],3) + 
               pow(rh,2)*(3*pow(mu,2)*pow(-2 + rgrid[i],3)*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)))*pow(Qt2(i,j,k),2)*pow(R(i,j,k),2) + 
       2*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),6)*pow(Qt2(i,j,k),2)*
       ...
       8*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (B(i,j,k)*(sqrt(1 + pow(R0,2)) + 
             pow(R0,2)*(sqrt(1 + pow(R0,2)) - 
                sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) \
+ R0*R(i,j,k)*(2*sqrt(1 + pow(R0,2)) - 
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) + 
                   ...
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
                     ...
                     pow(rh,2)*
                      (pow(mu,2)*pow(-2 + rgrid[i],3)*
                        ...
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                 (2.*pow(rh,4))) - 
             (2*R0*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                  pow(rh,2)*
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],3) + 
                  ...
                  pow(rh,2)*
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                     ...
                     4*pow(rh,2)*
                      (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                ((1 + pow(R0,2))*B(i,j,k) + R0*R(i,j,k)))/pow(rh,4)) \
+ 8*B(i,j,k)*(1 - rgrid[i])*R(i,j,k)*(R0*B(i,j,k) + R(i,j,k))*
           sqrt(1 + pow(R0,2)) + 
                   ...
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                     ...
                     4*pow(rh,2)*
                      (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
              (2.*pow(rh,4)))*
           (pow(Qt1(i,j,k),2) + pow(Qt2(i,j,k),2))*pow(R(i,j,k),2) \
+ pow(B(i,j,k),2)*pow(Qt2(i,j,k),2)*
           ((1 + pow(R0,2))*
              ((pow(-1 + rgrid[i],2)*
                   (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],2) + 
           ...
           (Qt2(i,j,k)*(-2*R0*
             ...
             ((pow(-1 + rgrid[i],2)*
              ...
              sqrt(1 + pow(R0,2) + 
                ...
                pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) + 
       4*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (pow(1 + pow(R0,2),1.5)*pow(B(i,j,k),2) + 
          2*pow(R(i,j,k),2)*sqrt(1 + pow(R0,2)) + 
          2*R0*B(i,j,k)*R(i,j,k)*
           (2*sqrt(1 + pow(R0,2)) - 
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
             ...
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
             ((1 + pow(R0,2))*pow(Qt1(i,j,k),2) + 
               (1 + pow(R0,2))*pow(Qt2(i,j,k),2) - 
       ...
       2*pow(1 - pow(1 - rgrid[i],2),4)*
        (2*pow(B(i,j,k),2)*(1 - rgrid[i])*
           (((1 + pow(R0,2))*pow(-1 + rgrid[i],2)*
                (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                  pow(rh,2)*
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],3) + 
  ...
  a2.diff(d010,i,j,k)*((4*ar.diff(d010,i,j,k)*
     ...
     a1.diff(d001,i,j,k)*((-4*pow(1 - pow(1 - rgrid[i],2),4)*
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(rh + rh*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
        (32*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           ((pow(L1,2)*pow(1 + 
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     a0.diff(d001,i,j,k)*((4*L1*pow(1 - pow(1 - rgrid[i],2),4)*
           pow(1 - rgrid[i],4)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
         ...
         (pow(1 + pow(R0,2),0.25)*pow(rh,2)*
           ...
           pow(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
        (32*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
                pow(-1 + rgrid[i],2)*
                (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
         ...
         (L1*L2*pow(1 + pow(R0,2),0.25)*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  H*((-2*a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
...
- L2*Qr2(i,j,k)*(L2*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
        ...
        (32*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*
         ...
         (pow(L1,2)*pow(1 + pow(R0,2),0.25)*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     a1.diff(d001,i,j,k)*((4*L2*pow(1 + pow(R0,2),0.25)*
           pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],4)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
     ...
     a0.diff(d001,i,j,k)*((-64*pow(rh,4)*
           ...
           ((L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
                ...
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))\
)/(16.*pow(rh,6)) + (L2*pow(1 - pow(1 - rgrid[i],2),3)*
                pow(-1 + rgrid[i],4)*
                pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
                  pow(rh,2)*
                     ...
                     pow(rh,2)*
                      (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       pow(rgrid[i],3) + 
                        ...
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
                   Qr1(i,j,k)*Qr2(i,j,k))/(2.*pow(rh,2)) + 
                (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                 (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
                (pow(1 - pow(1 - rgrid[i],2),2)*
                   pow(-1 + rgrid[i],4)*
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
        (128*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],6)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           ((L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
                pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (16*pow(rh,4)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Q.diff(d100,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     (4*Qr2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        (1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) + 
     (8*Q.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        (1 - rgrid[i])*Qr1(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3) + 
     (8*Q.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Q.diff(d010,i,j,k)*((16*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (8*Qr2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) - 
     (16*Q.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
     ...
     (4*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Q.diff(d001,i,j,k)*((16*pow(1 - pow(1 - rgrid[i],2),2)*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)),2)*(-Qrr(i,j,k) + Qtt(i,j,k))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
       (pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
...
+ Qtr(i,j,k),2)*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
          sqrt(1 + pow(R0,2) + 
            2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
        (4.*pow(rh,14)) + ((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               4*pow(rh,2)*
          ...
          sqrt(1 + pow(R0,2) + 
            2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
        pow(rh,4) + (pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
          pow(-1 + rgrid[i],6)*
          pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               ...
               (64*pow(q,2)*pow(ar(i,j,k),2)*
                 ...
                 64*pow(q,2)*pow(a0(i,j,k),2)*
                  ...
                  pow(L1*Qr1(i,j,k)*Qt1(i,j,k) + 
                    L2*Qr2(i,j,k)*Qt2(i,j,k),2)*sqrt(1 + pow(R0,2)) \
+ 8*pow(1 - pow(1 - rgrid[i],2),3)*
                  ...
                  sqrt(1 + pow(R0,2)) - 
                 32*pow(q,2)*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
                  (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
                  pow(1 - pow(1 - rgrid[i],2),5)*
                  pow(1 - rgrid[i],4)*
                  (L1*Qr1(i,j,k)*Qt1(i,j,k) + 
...
+ pow(1 - pow(1 - rgrid[i],2),4)*
                  (128*L2*pow(q,2)*pow(1 + pow(R0,2),0.25)*
                     a0(i,j,k)*a2(i,j,k)*
                     (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
               ...
               sqrt(1 + pow(R0,2) + 
                 ...
                 pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
             (2.*sqrt(1 + pow(R0,2))) - 
            48*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
             pow(1 - rgrid[i],3)*
             ((pow(-1 + rgrid[i],2)*
                  (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],2) + 
...
+ pow(L1,2)*pow(Qr1(i,j,k),2)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qrr.diff(d100,i,j,k)*((pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
        (-((1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
              pow(-1 + rgrid[i],6)*
              pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                 pow(rgrid[i],3) + 
...
+ 4*(1 - rgrid[i])*(2*L1*L2*R0*Qr1(i,j,k)*Qr2(i,j,k)*
  ...
  (2*pow(ar.diff(d001,i,j,k),2)*
   ...
   (pow(L2,2)*pow(rh,2)*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),
      2)) - (16*Qrr.diff(d020,i,j,k)*pow(rh,2)*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (pow(Qtr.diff(d001,i,j,k),2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (pow(L2,2)*pow(rh,4)*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),
      2)) + (pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  (pow(a1.diff(d100,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (2.*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) - 
  (B.diff(d100,i,j,k)*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),
      2)*(pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
        ((pow(-1 + rgrid[i],2)*
             (3*pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],2) + 
               3*pow(H,2)*pow(-2 + rgrid[i],2)*
  ...
  (2*B(i,j,k)*(1 - rgrid[i])*pow(1 + 
   ...
   (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     (1 - pow(1 - rgrid[i],2))*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) - 
  (2*B.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     Qr1(i,j,k)*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)*
     (pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
        ((pow(-1 + rgrid[i],2)*
             (3*pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],2) + 
   ...
   (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) - 
  (2*B.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     Qr2(i,j,k)*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)*
     (pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
        ((pow(-1 + rgrid[i],2)*
             (3*pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],2) + 
