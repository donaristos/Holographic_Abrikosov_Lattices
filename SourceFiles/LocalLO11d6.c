...
elem[165]+=
-4*a0.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*a0.diff(d010,i,j,k)*Qr1.diff(d010,i,j,k)*
  ...
  8*a0.diff(d020,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*a0.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) + 
  Q.diff(d010,i,j,k)*((4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2))/
      (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  ...
  Qrr.diff(d010,i,j,k)*((-2*a0(i,j,k)*
  ...
  a0.diff(d001,i,j,k)*((L1*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  Qtr.diff(d010,i,j,k)*(-((a2.diff(d010,i,j,k)*
     ...
     (a0.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (L1*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d100,i,j,k)*((-2*Q.diff(d010,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
     ...
     (Qt1.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (2.*L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d010,i,j,k)*(8*(1 - pow(1 - rgrid[i],2)) - 
     4*pow(1 - rgrid[i],2) + 
     4*Qr2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2) - (4*(1 - pow(1 - rgrid[i],2))*
  ...
  Qt1.diff(d001,i,j,k)*((2*a1.diff(d001,i,j,k)*L1*
      ...
      (pow(L2,2)*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (L1*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
...
- (a1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (pow(L2,2)*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) \
+ a2.diff(d100,i,j,k)*(-(Qt2.diff(d010,i,j,k)*
         (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
         pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
         (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
           pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  Qt2.diff(d100,i,j,k)*(-(a0.diff(d001,i,j,k)*L1*
     ...
     (a1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
      ...
      (2.*L2*pow(rh,4)*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  H*((L1*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
