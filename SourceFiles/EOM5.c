...
elem[4]=
R.diff(d100,i-1,j,k)-R.diff(d100,i,j,k)
;
}
else if(k==0){
elem[4]=
R(i,j,0)-R(i,j,ygrid.TotalLength()-1)
;
}
else if(k==ygrid.TotalLength()-1){
elem[4]=
R.diff(d001,i,j,ygrid.TotalLength()-1)-R.diff(d001,i,j,0)
;
}
else{
{elem[4]=
R.diff(d200,i,j,k) + (4*R.diff(d100,i,j,k)*(1 - rgrid[i]))/
   (1 - pow(1 - rgrid[i],2)) - 
  4*(R.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     2*R.diff(d010,i,j,k)*(1 - rgrid[i]))*(1 - rgrid[i])*Qr1(i,j,k) - 
  4*(R.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     2*R.diff(d001,i,j,k)*(1 - rgrid[i]))*(1 - rgrid[i])*Qr2(i,j,k) - 
  (2*R(i,j,k))/(1 - pow(1 - rgrid[i],2)) - 
  ...
  R.diff(d011,i,j,k)*(8*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  ((B.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
   ...
   (1 - pow(1 - rgrid[i],2)) - 
  (4*pow(R.diff(d010,i,j,k),2)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     (4*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
  ...
  (4*pow(R.diff(d001,i,j,k),2)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
          ...
          4*(1 - rgrid[i])*(-(pow(L2,2)*
              ...
              sqrt((1 + pow(R0,2))*
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))) \
- pow(L2,2)*(2*pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),4)*
           (1 - rgrid[i])*((pow(-1 + rgrid[i],2)*
                (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],2) + 
                  3*pow(H,2)*pow(-2 + rgrid[i],2)*
              ...
              ((pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),2)*
                 ...
                 sqrt((1 + pow(R0,2))*
                   (1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))\
)))))/(2.*L1*pow(L2,3)*(1 - pow(1 - rgrid[i],2))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  R.diff(d010,i,j,k)*((8*R.diff(d001,i,j,k)*pow(rh,2)*
        (1 - pow(1 - rgrid[i],2))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        (-((L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
               pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
  ...
  (Qtr.diff(d001,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*Qr1(i,j,k)*
       ...
       2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (4.*L2*pow(rh,2)) + (4*Qtt.diff(d001,i,j,k)*L1*pow(rh,4)*
...
+ ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
  ...
  (pow(a1.diff(d100,i,j,k),2)*(1 - pow(1 - rgrid[i],2))*
   ...
   (2.*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (Qr2.diff(d001,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
       ...
       4*(1 - rgrid[i])*(2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
          ...
          2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
           (-(pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
             ...
             pow(L2,2)*sqrt(1 + pow(R0,2)))))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (4.*L2*pow(rh,2)) - (pow(a2.diff(d010,i,j,k),2)*
     (1 - pow(1 - rgrid[i],2))*
     ...
     (4*pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
       ...
       8*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0,2) + 
          ...
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (8.*pow(L1,2)*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
     ...
     (4*pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
       ...
       8*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0,2) + 
          ...
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (8.*pow(L2,2)*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (pow(a1.diff(d001,i,j,k),2)*(1 - pow(1 - rgrid[i],2))*
     sqrt(1 + pow(R0,2))*(4*pow(L1,2)*
        pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        pow(Qr1(i,j,k),2)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
       4*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (8*pow(a0.diff(d001,i,j,k),2)*pow(rh,4)*
     ...
     ((pow(L1,2)*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),4)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/(4.*pow(rh,6)) + 
       pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (-4*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
          (pow(-1 + rgrid[i],4)*
...
+ (L1*pow(L2,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (8*pow(q,2)*pow(rh,2)*(pow(h1(i,j,k),2)*
     ...
     ((pow(L1,2)*pow(L2,2)*pow(a2(i,j,k),2)*
          ...
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
        sqrt(1 + pow(R0,2)) + 
       pow(L1,2)*pow(L2,2)*pow(a1(i,j,k),2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*sqrt(1 + pow(R0,2)) \
- (2*L1*L2*a0(i,j,k)*a2(i,j,k)*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - rgrid[i],2)*
          (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*Qt2(i,j,k)*
        ...
        (pow(L1,2)*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
          ...
          2*pow(L1,2)*pow(L2,2)*
           ...
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
       2*L1*L2*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*
        ((L1*L2*a2(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  R.diff(d020,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2)*pow(Qr1(i,j,k),2) + 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  R.diff(d002,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2) + 
  ...
  B.diff(d001,i,j,k)*((-8*Qr1.diff(d010,i,j,k)*
     ...
     (8*Qr1.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(1 - rgrid[i],2)*Qr2(i,j,k)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))/
      L2 - (8*Qr2.diff(d010,i,j,k)*L2*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k)*pow(1 + pow(R0 + 
            (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))/
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) + 
     ((1 - rgrid[i])*Qr1(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          ...
          4*(1 - rgrid[i])*(pow(L2,2)*
             ...
             pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
               2)*((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
                   ...
                   pow(Qt2(i,j,k),2))/(4.*pow(rh,4)) - 
                pow(L2,2)*sqrt(1 + pow(R0,2))))))/
      (L1*pow(L2,3)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  ...
  B.diff(d010,i,j,k)*((-8*Qr1.diff(d010,i,j,k)*
     ...
     (8*Qr2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (R0 + pow(R0,3) + (1 + 3*pow(R0,2))*
          ...
          pow(1 - pow(1 - rgrid[i],2),3)*pow(R(i,j,k),3)))/
      (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
     (8*B.diff(d001,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))*
        (4*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
          ...
          4*(1 - rgrid[i])*(pow(L2,2)*
             ...
             pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
               2)*((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
                   ...
                   pow(Qt2(i,j,k),2))/(4.*pow(rh,4)) - 
                pow(L2,2)*sqrt(1 + pow(R0,2))))))/
      (pow(L1,3)*L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  ...
  2*Qr1.diff(d010,i,j,k)*(1 - rgrid[i])*
   (4*Qr2.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      (R0 + pow(R0,3) + (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*
         R(i,j,k) + 3*R0*pow(1 - pow(1 - rgrid[i],2),2)*
         pow(R(i,j,k),2) + pow(1 - pow(1 - rgrid[i],2),3)*
         pow(R(i,j,k),3)) - (4*Qr2.diff(d010,i,j,k)*L2*
     ...
     (L2*pow(-1 + rgrid[i],2)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (8.*L1*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - rgrid[i]))) + 2*Qr1.diff(d001,i,j,k)*(1 - rgrid[i])*
   (4*Qr2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      (R0 + pow(R0,3) + (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*
         R(i,j,k) + 3*R0*pow(1 - pow(1 - rgrid[i],2),2)*
         pow(R(i,j,k),2) + pow(1 - pow(1 - rgrid[i],2),3)*
         pow(R(i,j,k),3)) - (4*Qr2.diff(d001,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))/
      L2 - (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (16*pow(1 - rgrid[i],3) - 
             ...
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
             Qr2(i,j,k)*(L2*pow(1 - pow(1 - rgrid[i],2),2)*
                ((pow(-1 + rgrid[i],2)*
                     (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                       pow(rgrid[i],2) + 
                       3*pow(H,2)*pow(-2 + rgrid[i],2)*
               ...
               4*L2*(1 - rgrid[i])*
                (2*L1*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                  ...
                  2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                   Qr2(i,j,k)*sqrt(1 + pow(R0,2)))))/(2.*pow(rh,2)))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (4.*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2))) + 
  Qrr.diff(d001,i,j,k)*((4*Qr1.diff(d010,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     ...
     (4*Qr1.diff(d001,i,j,k)*L1*
        ...
        Qr2(i,j,k)*sqrt(1 + pow(R0 + 
            (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
     (L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
...
- (Qtr.diff(d001,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (a0.diff(d001,i,j,k)*pow(1 - rgrid[i],2)*
     ((a2.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
       ...
       (2*ar.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          (1 - rgrid[i])*(2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  Q.diff(d001,i,j,k)*((16*R.diff(d010,i,j,k)*pow(rh,2)*
     ...
     ((1 - rgrid[i])*Qr1(i,j,k)*
           ...
           (L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*
             ...
             4*(1 - rgrid[i])*
              (L1*L2*R0 - (L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
                   ...
                   Qt1(i,j,k)*Qt2(i,j,k))/(4.*pow(rh,4))))*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
          pow(L2,2)*(pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
              ((pow(-1 + rgrid[i],2)*
                   (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],2) + 
                     3*pow(H,2)*pow(-2 + rgrid[i],2)*
      ...
      (L1*pow(L2,3)*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
       ...
       (2*ar.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          ...
          (2*L2*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
            ...
            2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))\
)/(pow(L1,2)*L2*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   (1 - pow(1 - rgrid[i],2)) + 
  (a2.diff(d010,i,j,k)*L2*((-2*ar.diff(d001,i,j,k)*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
          (2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
                    ...
                    (pow(mu,2)*pow(-2 + rgrid[i],3)*
                      ...
                      4*pow(rh,2)*
                       (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                 (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
                 Qr1(i,j,k)*(2*L1*pow(1 - pow(1 - rgrid[i],2),2)*
                    (1 - rgrid[i])*Qr1(i,j,k)*Qt1(i,j,k) + 
                   2*L2*pow(1 - pow(1 - rgrid[i],2),2)*
                    (1 - rgrid[i])*Qr2(i,j,k)*Qt2(i,j,k) - 
                   2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
             ...
             (-(L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
               ...
               L1*L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
                sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) \
+ 2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*Qr2(i,j,k)*
             Qt1(i,j,k)*(L1*L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
                (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
               L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                (1 - pow(1 - rgrid[i],2))*Qt2(i,j,k)*
                sqrt(1 + pow(R0,2) + 
