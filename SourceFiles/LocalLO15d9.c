...
elem[232]+=
-2*Qr2.diff(d100,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3) + 
  4*Qr2.diff(d010,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr1(i,j,k) + 
  2*L2*q*a0(i,j,k)*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) - 
  L2*q*a0(i,j,k)*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
   (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) - 
  4*h2.diff(d100,i,j,k)*L2*q*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],3)*Qr2(i,j,k) - 
  2*a0.diff(d100,i,j,k)*L2*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],3)*Qr2(i,j,k) - 
  8*L2*pow(q,2)*a0(i,j,k)*ar(i,j,k)*h1(i,j,k)*(1 - pow(1 - rgrid[i],2))*
   pow(1 - rgrid[i],4)*Qr2(i,j,k) - 
  4*L2*q*a0(i,j,k)*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
   pow(1 - rgrid[i],4)*Qr2(i,j,k) + 
  4*Qr1.diff(d010,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr2(i,j,k) + 
  8*Qr2.diff(d001,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr2(i,j,k) - 
  (8*L2*q*pow(rh,4)*a0(i,j,k)*h2(i,j,k)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
  (2*Q.diff(d100,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
  (16*L2*q*a0(i,j,k)*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],4)*Q(i,j,k)*Qr2(i,j,k))/
   (4 + 4*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (4*Q.diff(d010,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
  ...
  (8*pow(L2,2)*pow(q,2)*a0(i,j,k)*a2(i,j,k)*h1(i,j,k)*
     ...
     pow(Qr2(i,j,k),2))/pow(1 + pow(R0,2),0.25) + 
  (4*Q.diff(d001,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],4)*
     pow(Qr2(i,j,k),2))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (Qrr.diff(d100,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*Qr2(i,j,k))/
  ...
  8*L1*L2*pow(q,2)*pow(a0(i,j,k),2)*h1(i,j,k)*
   ...
   Qr2(i,j,k)*Qt1(i,j,k) + (32*pow(q,2)*R0*pow(rh,2)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  8*pow(L2,2)*pow(q,2)*pow(a0(i,j,k),2)*h1(i,j,k)*
  ...
  8*L2*pow(q,2)*pow(a0(i,j,k),2)*h1(i,j,k)*
   ...
   Qtr(i,j,k) - (Qtt.diff(d100,i,j,k)*L2*q*a0(i,j,k)*h2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*Qr2(i,j,k))/
  ...
  (16*B.diff(d001,i,j,k)*q*pow(rh,2)*a0(i,j,k)*h2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (L2*pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
