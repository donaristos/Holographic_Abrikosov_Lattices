...
+ (1 - pow(1 - rgrid[i],2))*
  ...
  (8*L1*q*pow(rh,4)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  4*Qr1.diff(d001,i,j,k)*q*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k)*
   (L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k) - 
     L1*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      Qt1(i,j,k)) + 2*Qr1.diff(d100,i,j,k)*q*(1 - pow(1 - rgrid[i],2))*
   (1 - rgrid[i])*(-(L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)) + 
     L1*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
  ...
  4*L2*q*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],4)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  4*Qr2.diff(d010,i,j,k)*q*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k)*
   ((L2*a2(i,j,k))/pow(1 + pow(R0,2),0.25) - 
     L2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      Qt2(i,j,k)) + 2*Qr2.diff(d100,i,j,k)*q*(1 - pow(1 - rgrid[i],2))*
   (1 - rgrid[i])*(-((L2*a2(i,j,k))/pow(1 + pow(R0,2),0.25)) + 
     L2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      Qt2(i,j,k)) + q*(-2*(1 - pow(1 - rgrid[i],2)) + 
     4*pow(1 - rgrid[i],2))*Qr2(i,j,k)*
   (-((L2*a2(i,j,k))/pow(1 + pow(R0,2),0.25)) + 
     L2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      Qt2(i,j,k)) + 2*q*pow(1 - rgrid[i],2)*
...
) + (Q.diff(d100,i,j,k)*q*(1 - pow(1 - rgrid[i],2))*
  ...
  4*q*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
   ((1 - pow(1 - rgrid[i],2))*
      (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - Qtr(i,j,k)) + 
  ...
  (8*q*pow(rh,4)*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (2*Q.diff(d010,i,j,k)*q*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*Qr1(i,j,k)*
     ((-2*ar(i,j,k)*(1 - rgrid[i]))/(1 - pow(1 - rgrid[i],2)) + 
       2*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k) + 
     ...
     ((-2*ar(i,j,k)*(1 - rgrid[i]))/(1 - pow(1 - rgrid[i],2)) + 
       ...
       2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
        (-((1 - pow(1 - rgrid[i],2))*
             (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))) + 
          Qtr(i,j,k))))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  Qr1.diff(d010,i,j,k)*q*pow(1 - rgrid[i],2)*
   (-4*ar(i,j,k) + 8*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*
     ...
     4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
      (-((1 - pow(1 - rgrid[i],2))*
        ...
        Qtr(i,j,k))) + Qr2.diff(d001,i,j,k)*q*pow(1 - rgrid[i],2)*
   (-4*ar(i,j,k) + 4*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*
      pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k) + 
     (8*L2*a2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr2(i,j,k))/
      pow(1 + pow(R0,2),0.25) + 
     4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
      (-((1 - pow(1 - rgrid[i],2))*
           (L1*Qr1(i,j,k)*Qt1(i,j,k) + 2*L2*Qr2(i,j,k)*Qt2(i,j,k))) + 
        Qtr(i,j,k))) + (Qtt.diff(d100,i,j,k)*q*
     (1 - pow(1 - rgrid[i],2))*
     ((2*ar(i,j,k)*(1 - rgrid[i]))/(1 - pow(1 - rgrid[i],2)) - 
       2*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k) - 
