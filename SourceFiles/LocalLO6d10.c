...
- (1 - pow(1 - rgrid[i],2))*
   ...
   (2.*pow(rh,2)) + (16*pow(a0.diff(d001,i,j,k),2)*
...
- (1 - pow(1 - rgrid[i],2))*
   ...
   (8.*pow(rh,2)*(1 - rgrid[i])) - 
  (2*Qtr.diff(d001,i,j,k)*(1 - rgrid[i])*
     (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (Qt1.diff(d100,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (4.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (4.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) - (16*a0.diff(d001,i,j,k)*a0.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],6)*
  ...
  (Qr1.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ...
     (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
       ...
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (4.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (16*h2.diff(d001,i,j,k)*q*pow(rh,2)*a0(i,j,k)*h1(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
...
- Qtr(i,j,k)))/(4.*pow(rh,8)) + 
          4*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
           pow(-1 + rgrid[i],2)*
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                 pow(rgrid[i],3) + 
           ...
           ((1 - pow(1 - rgrid[i],2))*
              (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - 
             Qtr(i,j,k)) + (L1*L2*(1 - pow(1 - rgrid[i],2))*
             pow(-1 + rgrid[i],4)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
        ...
        sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
   (8.*pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
