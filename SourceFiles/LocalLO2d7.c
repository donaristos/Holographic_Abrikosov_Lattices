...
elem[22]+=
-4*Qrr.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*Qrr.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*Qrr.diff(d002,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) - 
  (12*pow(Qrr.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  (4*Q.diff(d001,i,j,k)*Q.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) + 
  (8*Q.diff(d001,i,j,k)*Q.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) + 
  8*pow(h1.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  8*pow(h2.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  (8*pow(Q.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) + 
  (Qtr.diff(d100,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
     ...
     Qt2(i,j,k))/(2.*pow(rh,2)) + 
  (L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
...
- (1 - pow(1 - rgrid[i],2))*
   ...
   pow(rh,2) - (Qr1.diff(d100,i,j,k)*L1*L2*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  h2.diff(d100,i,j,k)*(-4*h2.diff(d001,i,j,k)*
      pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
   ...
   (-4*h1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     L2*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      ...
      ((-4*a2(i,j,k))/pow(1 + pow(R0,2),0.25) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt2(i,j,k))) + h1.diff(d010,i,j,k)*
   (8*h1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr1(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     2*L2*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr1(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      ((-4*a2(i,j,k))/pow(1 + pow(R0,2),0.25) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt2(i,j,k))) + h2.diff(d010,i,j,k)*
...
- (1 - pow(1 - rgrid[i],2))*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     Qt2(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,2)*(1 - rgrid[i])) - 
  (2*Qtt.diff(d001,i,j,k)*Qtt.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  (4*Qtt.diff(d001,i,j,k)*Qtt.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  (4*pow(Qtt.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  Qtt.diff(d001,i,j,k)*((8*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     ...
     (4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      ...
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) - 
  (4*R.diff(d001,i,j,k)*R.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
  (8*R.diff(d001,i,j,k)*R.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
  (8*pow(R.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
  (4*B.diff(d001,i,j,k)*B.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  (8*B.diff(d001,i,j,k)*B.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
  ...
  (8*pow(B.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  Qr1.diff(d010,i,j,k)*((8*Q.diff(d001,i,j,k)*
  ...
  Qtr.diff(d010,i,j,k)*((L2*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
           ...
           ((pow(-1 + rgrid[i],2)*
             ...
             ((-1 + rgrid[i])*
              ...
              (2.*pow(rh,4))))*Qr1(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt2(i,j,k))/
      pow(rh,2) - (2*Qt1.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
      ...
      (L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
  (Qr2.diff(d100,i,j,k)*pow(L2,2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  (L2*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
   ...
   (4.*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) + 
  (Qr2.diff(d001,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
        ...
        (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
           ...
           pow(rh,4) + ((pow(-1 + rgrid[i],2)*
             ...
             ((-1 + rgrid[i])*
              ...
              (2.*pow(rh,4)))*Qtr(i,j,k)) + 
       4*(1 - rgrid[i])*(L1*R0*Qr1(i,j,k) + 
          2*L2*Qr2(i,j,k)*sqrt(1 + pow(R0,2)))))/pow(rh,2) + 
  ...
  h1.diff(d001,i,j,k)*(-8*h1(i,j,k)*(1 - pow(1 - rgrid[i],2))*
      pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     2*L2*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr2(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      ((-4*a2(i,j,k))/pow(1 + pow(R0,2),0.25) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt2(i,j,k)) + (2*q*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
  ...
  h2.diff(d001,i,j,k)*(-8*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
      pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     4*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
...
+ Qtr(i,j,k)) + 4*L1*a1(i,j,k)*Qr1(i,j,k)*sqrt(1 + pow(R0,2)))))/
      pow(1 + pow(R0,2),0.25)) + 
  Qrr.diff(d001,i,j,k)*(-8*pow(1 - rgrid[i],2) + 
     ...
     2*(1 - rgrid[i])*(-4*(1 - rgrid[i]) + 
        ...
        (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
         ...
         (4.*pow(rh,2)))) + (Qt1.diff(d010,i,j,k)*L1*L2*
   ...
   (pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (4*pow(H,2)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
  ...
  a0.diff(d100,i,j,k)*((-2*a2.diff(d010,i,j,k)*L2*
     ...
     (8*a0.diff(d001,i,j,k)*pow(rh,2)*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Q.diff(d001,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*
  ...
  (L2*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
   ...
   (2.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (L2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (-32*pow(1 + pow(R0,2),0.25)*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i])*(4*pow(q,2)*a2(i,j,k)*ar(i,j,k)*
           (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
           pow(1 - rgrid[i],2) + 
                    ...
                    pow(rh,2)*
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                (2.*pow(rh,4)))*Qt2(i,j,k)*Qtr(i,j,k))/pow(rh,2))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
       32*pow(q,2)*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
        ...
        (4*a2(i,j,k)*(L1*Qr1(i,j,k)*Qt1(i,j,k) + 
             2*L2*Qr2(i,j,k)*Qt2(i,j,k)) + 
          pow(1 + pow(R0,2),0.25)*Qt2(i,j,k)*
           (4*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*Qr1(i,j,k) + 
             4*a0(i,j,k)*pow(1 - rgrid[i],2)*Qtr(i,j,k)))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
       128*pow(q,2)*pow(a0(i,j,k),2)*
        ...
        Qt2(i,j,k)*(L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))*
        sqrt(1 + pow(R0,2))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
       4*pow(1 - pow(1 - rgrid[i],2),2)*Qt2(i,j,k)*
        (2*(1 - rgrid[i])*(16*pow(q,2)*a0(i,j,k)*ar(i,j,k)*
              (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
              pow(1 - rgrid[i],4) + 
             (2*pow(-1 + rgrid[i],4)*
                pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                   ...
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
                     ...
                     pow(rh,2)*
                      (pow(mu,2)*pow(-2 + rgrid[i],3)*
                        ...
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                 (2.*pow(rh,4)),2))*Qtr(i,j,k))*sqrt(1 + pow(R0,2))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
       4*pow(1 - pow(1 - rgrid[i],2),3)*
        (-32*pow(q,2)*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*a2(i,j,k)*
           (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
           pow(1 - rgrid[i],5)*Qtr(i,j,k) + 
          2*L1*Qr1(i,j,k)*(-16*pow(q,2)*a1(i,j,k)*a2(i,j,k)*
              (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
              pow(1 - rgrid[i],3) + 
           ...
           sqrt(1 + pow(R0,2)) + 
          2*L2*Qr2(i,j,k)*(-16*pow(q,2)*pow(a2(i,j,k),2)*
              (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
              pow(1 - rgrid[i],3) + 
             pow(rh,2)*(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (L1*R0*Qr1(i,j,k)*sqrt(1 + pow(R0,2) + 
          ...
          L2*Qr2(i,j,k)*sqrt((1 + pow(R0,2))*
             (1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))))/
   (16.*sqrt(1 + pow(R0,2))*(1 - rgrid[i])*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qrr.diff(d100,i,j,k)*((6*Qrr.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     (L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
      ...
      (4.*pow(rh,2)*sqrt(1 + 
          pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt1.diff(d001,i,j,k)*(-((L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*
          (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  Qt2.diff(d010,i,j,k)*((L2*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*L2*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      ...
      (L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  B.diff(d001,i,j,k)*((-8*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) - 
