...
((-8*Q.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
       ...
       Qr1(i,j,k)*Qt2(i,j,k))/(4 + 4*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) \
+ (4*Qrr.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
    ...
    (8*Qtt.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
       pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*
       Qr1(i,j,k)*Qt2(i,j,k))/
     (4 + 4*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
    8*Qt2.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
    ...
    (16*Q.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
     ...
     (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
    (16*Qtt.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
       pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
       Qt2(i,j,k)*((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
    ...
    (4*Qr2.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
     ...
     ((L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (16*Q.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
       pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
       ((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*
          (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
     ...
     (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (16*Qt1.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
       (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],4)*
     ...
     (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       pow(rh + rh*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (16*Qt2.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
       (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],4)*
       (-(pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
             pow(1 - pow(1 - rgrid[i],2),4)*pow(-1 + rgrid[i],4)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
...
)/L2 + 2*Qt2.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
     (Qr1(i,j,k) + ((1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
...
+ (2*B.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
    ...
    (16*B.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
       pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
       ...
       pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
         ...
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
    (16*B.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
       pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
       ((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k) - 
         (L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
    ...
    2*pow(1 + pow(R0,2),0.25)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],3)*((4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
          ((pow(-1 + rgrid[i],2)*
        ...
        (pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
       (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Q(i,j,k)*Qr1(i,j,k)*
          Qt2(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
       (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
          Qt2(i,j,k)*Qtt(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
       (2*(1 - rgrid[i])*(L2*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
