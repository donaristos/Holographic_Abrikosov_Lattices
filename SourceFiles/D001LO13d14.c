...
elem[205]+=
((-2*Qrr.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*
       (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qr1(i,j,k))/
     (L2 + L2*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
    (2*Qrr.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*(1 - rgrid[i]))/
    ...
    (4*Qrr.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
     ...
     (2*L2 + 2*L2*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
    (Qtt.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*(1 - rgrid[i]))/
    ...
    (2*B.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*(1 - rgrid[i])*
    ...
    (4*Qr1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
       ...
       (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     pow(L2,2) + (4*Qr2.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*
