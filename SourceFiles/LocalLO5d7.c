...
elem[70]+=
-4*R.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*R.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*R.diff(d002,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (4*B.diff(d001,i,j,k)*B.diff(d100,i,j,k)*
     ...
     (R0 + pow(R0,3) + (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*
        ...
        pow(R(i,j,k),3)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  R.diff(d001,i,j,k)*(-16*pow(1 - rgrid[i],2) + 
  ...
  (Qt2.diff(d001,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     ((1 - pow(1 - rgrid[i],2))*
       ...
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (2.*pow(rh,2)) - (8*pow(R.diff(d001,i,j,k),2)*
...
- pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
  ...
  (Qtr.diff(d001,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (2.*pow(rh,2)) - (Qr1.diff(d001,i,j,k)*pow(L1,2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       pow(1 - pow(1 - rgrid[i],2),3)*
        ((pow(-1 + rgrid[i],2)*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
           ...
           (2.*pow(rh,4)))*Qt1(i,j,k)*Qt2(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (2.*pow(rh,2)) + (4*Qtt.diff(d010,i,j,k)*L2*pow(rh,4)*
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (Qr2.diff(d001,i,j,k)*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
     ...
     (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
       ...
       4*(1 - rgrid[i])*sqrt(1 + pow(R0,2)))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (2.*pow(rh,2)) - (4*pow(H,2)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  (pow(Qt1.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (L2*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (pow(Qt2.diff(d010,i,j,k),2)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  Qt1.diff(d100,i,j,k)*(-(Qt1.diff(d001,i,j,k)*
     ...
     (Qt2.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (2.*L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qtr.diff(d010,i,j,k)*((L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
  ...
  Qr1.diff(d010,i,j,k)*((-8*B.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + pow(R0,3) + (1 + 3*pow(R0,2))*
           (1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          3*R0*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2) + 
  ...
  Qr2.diff(d010,i,j,k)*((-8*B.diff(d001,i,j,k)*L2*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))/
  ...
  Qrr.diff(d010,i,j,k)*(-((L2*
     ...
     (pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      ...
      (2.*L1*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
     (L2*pow(rh,4)*(((-4*(1 - pow(1 - rgrid[i],2))*
