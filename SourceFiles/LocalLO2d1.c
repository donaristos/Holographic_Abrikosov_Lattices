...
elem[16]+=
(pow(Qtt.diff(d100,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2)*
     (-1 - (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3) - 
  (4*pow(Qtt.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),4)*
     pow(1 - rgrid[i],2)*pow(Qr1(i,j,k),2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3) - 
  (4*pow(Qtt.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),4)*
     pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3) + 
  (16*pow(rh,4)*(1 - rgrid[i])*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3)) - 
  (4*pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     pow(Qtt(i,j,k),2))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3) + 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  Qtt.diff(d010,i,j,k)*((-8*Qtt.diff(d001,i,j,k)*
     ...
     (8*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qtt(i,j,k)\
)/pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3) - 
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
          ...
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2))) + 
  Qtt.diff(d001,i,j,k)*((16*pow(rh,4)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3)) + 
     (8*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qtt(i,j,k)\
)/pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3) - 
     ...
     a0.diff(d001,i,j,k)*((-16*pow(1 - pow(1 - rgrid[i],2),4)*
           ...
           ((L1*pow(rh + rh*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
                ...
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))\
)/(4.*pow(rh,4)) + (L2*(1 - pow(1 - rgrid[i],2))*
                pow(-1 + rgrid[i],2)*
                (pow(H,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
                  pow(rh,2)*
             ...
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
             (-24*(1 + ((pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
