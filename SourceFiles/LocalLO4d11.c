...
(2*a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
  ...
  (16*h1.diff(d010,i,j,k)*q*pow(rh,2)*h2(i,j,k)*
   ...
   (L1*pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (2*a2.diff(d100,i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
  ...
  (4*ar.diff(d001,i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
      2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qt2(i,j,k))/
  ...
  (2*a0.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],3)*(pow(Qt1(i,j,k),2) - 
       pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        pow(Qt2(i,j,k),2)))/
   (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
     (-pow(Qt1(i,j,k),2) + pow(1 + 
          B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*pow(Qt2(i,j,k),2)))/
   (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*H*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],2)*(4*L2*pow(q,2)*pow(h1(i,j,k),2)*
        pow(1 - rgrid[i],2)*ygrid[k]*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k) + 
       4*L2*pow(q,2)*pow(h2(i,j,k),2)*pow(1 - rgrid[i],2)*ygrid[k]*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k) + 
  ...
  (4*a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],4)*(L2*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
        pow(Qt1(i,j,k),2) + pow(1 + 
          B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*Qt2(i,j,k)*
  ...
  (4*pow(q,2)*pow(rh,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
     ...
     (-4*a2(i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        Qt2(i,j,k) + 4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
        (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
        (-pow(Qt1(i,j,k),2) + 
          pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           pow(Qt2(i,j,k),2)) + 
       4*a1(i,j,k)*Qt1(i,j,k)*sqrt(1 + pow(R0,2))))/
