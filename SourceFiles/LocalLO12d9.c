...
elem[184]+=
(-2*a0.diff(d010,i,j,k)*Qr2.diff(d100,i,j,k)*L2*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (a0.diff(d010,i,j,k)*Qrr.diff(d100,i,j,k)*L2*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*Qr2(i,j,k))/
   (L1*pow(1 + pow(R0,2),0.25)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) - 
  (a0.diff(d010,i,j,k)*Qtt.diff(d100,i,j,k)*L2*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*Qr2(i,j,k))/
   (L1*pow(1 + pow(R0,2),0.25)*
  ...
  (2*Qt1.diff(d010,i,j,k)*ar(i,j,k)*(1 - rgrid[i])*
   ...
   (L1*pow(1 + pow(R0,2),0.25)*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (8*a0.diff(d010,i,j,k)*Qtt.diff(d010,i,j,k)*pow(rh,2)*
  ...
  (Qt1.diff(d001,i,j,k)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
   ...
   (L2*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qrr.diff(d010,i,j,k)*((4*a0.diff(d001,i,j,k)*L2*
  ...
  Qtr.diff(d010,i,j,k)*((L2*ar(i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ...
     (a0.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
      ...
      (pow(L1,2)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qr2.diff(d010,i,j,k)*((2*L2*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
...
- Qtr(i,j,k)))/(4.*pow(rh,6))))/
     ...
     (4*L2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      (L1*pow(1 + pow(R0,2),0.25)) - 
     (8*a0.diff(d001,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  (4*a0(i,j,k)*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     ...
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   pow(1 + pow(R0,2),0.25) + 
  (4*Qr2.diff(d001,i,j,k)*a0(i,j,k)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   pow(1 + pow(R0,2),0.25) - 
  (4*B.diff(d001,i,j,k)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k)*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   pow(1 + pow(R0,2),0.25) + 
  ...
  Qt2.diff(d100,i,j,k)*((a0.diff(d010,i,j,k)*
     ...
     (a0.diff(d100,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
      ...
      (4.*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qr1.diff(d010,i,j,k)*((L2*ar(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     (4*a0(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(1 + pow(R0,2),0.25)) + 
  a0.diff(d100,i,j,k)*((-2*Qrr.diff(d010,i,j,k)*L2*
     ...
     (2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*R(i,j,k))/
      (pow(1 + pow(R0,2),0.25)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     ...
     (2*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(1 + pow(R0,2),0.25) + 
     (2*Qr1.diff(d010,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(1 + pow(R0,2),0.25) - 
  ...
  B.diff(d100,i,j,k)*((2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*a0.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (L1*pow(1 + pow(R0,2),0.25)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))))) + 
  B.diff(d010,i,j,k)*((-16*a0.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L1*L2*pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
  ...
  a0.diff(d010,i,j,k)*(-((L2*(1 - pow(1 - rgrid[i],2))*
          ...
          pow(1 - rgrid[i],2)*Qr2(i,j,k))/(L1*pow(1 + pow(R0,2),0.25))\
