...
elem[198]+=
(8*a2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k) + 
    2*a2.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
    ...
    (pow(1 + pow(R0,2),0.25)*(1 - rgrid[i])*
       (L2*(1 - rgrid[i])*((-8*a2(i,j,k))/pow(1 + pow(R0,2),0.25) + 
            (8*pow(rh,4)*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*
               (1 - rgrid[i])*
