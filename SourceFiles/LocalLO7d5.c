     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (16*pow(H,2)*L1*L2*pow(q,2)*pow(rh,2)*
   ...
   (L2*pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  Qrr.diff(d001,i,j,k)*((16*pow(rh,2)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
- (16*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        ((-32*pow(rh,2)*(1 - rgrid[i]))/
           (pow(-1 + rgrid[i],2)*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
          (8*L1*L2*R0*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
             Qr1(i,j,k)*Qr2(i,j,k))/
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
  ...
  ((1 - rgrid[i])*Qr2(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   ...
   (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qr1.diff(d010,i,j,k)*((-16*Q.diff(d001,i,j,k)*pow(rh,2)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
  ...
  B.diff(d100,i,j,k)*((-8*Qrr.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (pow(L2,2)*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     ((1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
      ...
      (2.*pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qrr.diff(d010,i,j,k)*((16*Qr1.diff(d010,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     (4*pow(1 - rgrid[i],2))/
      ((L1*L2*pow(-1 + rgrid[i],2)*
         ...
         (4.*pow(rh,2))) + (16*Q.diff(d010,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  (2*(1 - rgrid[i])*Q(i,j,k)*Qr2(i,j,k)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qtt.diff(d001,i,j,k)*((8*pow(rh,2)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
...
+ (8*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     (-(((L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
       ...
       Qt2(i,j,k)*((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (1 + 2*pow(R0,2) + 
             4*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             2*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
          B(i,j,k)*((L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*
                pow(-1 + rgrid[i],2)*
                (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                  pow(rh,2)*
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (pow(rh,4)*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
                  ...
                  (pow(L1,2)*(1 + pow(R0,2))*pow(Qr1(i,j,k),2))/
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))) + 
                  (3*pow(L2,2)*(1 + pow(R0,2))*pow(Qr2(i,j,k),2))/
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                       pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (2.*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  R.diff(d100,i,j,k)*(Qrr.diff(d001,i,j,k)*
      ((8*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         (pow(L2,2)*pow(-1 + rgrid[i],2)*
     ...
     ((1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
      ...
      (2.*pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ a0.diff(d100,i,j,k)*((32*a0.diff(d010,i,j,k)*pow(rh,4)*
     ...
     Qtt.diff(d001,i,j,k)*((8*pow(rh,2)*
        ...
        (8*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
         ...
         (L1*pow(L2,2)*pow(-1 + rgrid[i],2)*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)\
))) + Q.diff(d100,i,j,k)*((-8*Qrr.diff(d010,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     ((1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
      ...
      (2.*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Q.diff(d010,i,j,k)*((-16*pow(rh,4)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
...
- (4*pow(rh,2)*(1 - rgrid[i])*
  ...
  a0.diff(d010,i,j,k)*((-64*pow(rh,4)*a0(i,j,k)*
     ...
     (4*q*pow(rh,2)*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        ...
        (4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (-(pow(1 + pow(R0,2),0.25)*ar(i,j,k)) + 
             2*L2*a2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr2(i,j,k)\
)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
          4*a1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
           sqrt(1 + pow(R0,2))*
           (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
              (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
             L2*Qr2(i,j,k)*sqrt(1 + pow(R0,2) + 
  ...
  h2.diff(d001,i,j,k)*((16*pow(rh,2)*h2(i,j,k)*
     ...
     (4*q*pow(rh,2)*h1(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        ...
        sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) + 
  R.diff(d010,i,j,k)*(Qrr.diff(d001,i,j,k)*
      ((-16*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
         ...
         (pow(L2,2)*pow(-1 + rgrid[i],2)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     Qr2.diff(d010,i,j,k)*((-16*pow(rh,2)*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
         ...
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     Qr1.diff(d001,i,j,k)*((16*pow(rh,2)*
           (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
              ...
              ((1 + 2*pow(R0,2))*Qtr(i,j,k) - 
                (1 - pow(1 - rgrid[i],2))*
                 (L2*(1 + 2*pow(R0,2))*Qr2(i,j,k)*Qt2(i,j,k) - 
                   ...
                   2*L1*Qr1(i,j,k)*
                    ((1 + 2*pow(R0,2))*Qt1(i,j,k) - 
                      R0*Qt2(i,j,k)*
                       sqrt(1 + pow(R0,2) + 
                         2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                         pow(1 - pow(1 - rgrid[i],2),2)*
                         pow(R(i,j,k),2)))) - 
                2*pow(1 - pow(1 - rgrid[i],2),3)*R(i,j,k)*
...
+ 4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*pow(1 - rgrid[i],2)*
      ...
      (L1*L2*pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  H*((8*h2.diff(d100,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
...
+ 4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*pow(1 - rgrid[i],2)*
      ...
      (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
  (2*Qr2.diff(d001,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     (pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       4*(1 - rgrid[i])*(L2*(1 + pow(R0,2))*Qr2(i,j,k)*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
          L1*R0*Qr1(i,j,k)*sqrt((1 + pow(R0,2))*
             (1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))))/
   (L2*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
...
+ (16*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (4*pow(rh,2)*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (-(pow(L1,2)*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),5)*
              (1 - rgrid[i])*pow(-1 + rgrid[i],4)*
              pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                 pow(rgrid[i],3) + 
                pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              ...
              (pow(Qt1(i,j,k),2) + 
                ...
                (2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                 ...
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))\
))/(4.*pow(rh,6)) + (pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
             pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
...
- (pow(rh,4)*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
   ...
   (2.*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) + 
  (pow(rh,2)*(-32*L1*pow(L2,2)*pow(rh,2)*(1 - rgrid[i])*Qr2(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
       ...
       L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (-((L1*L2*(-6*(1 - pow(1 - rgrid[i],2)) - 
          ...
          4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (64*L1*L2*R0*pow(rh,2)*(1 - rgrid[i])*
              ((pow(-1 + rgrid[i],2)*
                   (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],2) + 
                     3*pow(H,2)*pow(-2 + rgrid[i],2)*
                   ...
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
                     ...
                     pow(rh,2)*
                      (pow(mu,2)*pow(-2 + rgrid[i],3)*
                        ...
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                 (2.*pow(rh,4)))*Qr2(i,j,k) + 
             (L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*Qr2(i,j,k)*
                (-16*pow(q,2)*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*
                   (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
                   pow(1 - rgrid[i],2)*
                   (-4*a2(i,j,k) + 
                     4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
                     ...
                     pow(1 + pow(R0,2),0.25)*
                      (64*pow(q,2)*pow(a0(i,j,k),2)*
                       ...
                       4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                        (2.*pow(rh,4)),2))*Qt2(i,j,k))))/
              pow(1 + pow(R0,2),0.25) + 
             4*pow(q,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
              (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
              (-4*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
                4*L1*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*
                 pow(1 - rgrid[i],2)*Qt1(i,j,k))*
...
+ 4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
                ((2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                  ...
                  2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                   ...
                   sqrt(1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
))))/pow(rh,2) + (L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
             (1 - rgrid[i])*pow(-1 + rgrid[i],4)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
   ...
   (16.*L1*pow(L2,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
- (pow(rh,2)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     (-2*L1*pow(L2,2)*pow(rh,2)*(1 - rgrid[i])*Qr2(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  B.diff(d010,i,j,k)*((16*pow(rh,2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  (8*Qt1.diff(d001,i,j,k)*pow(rh,2)*(1 - rgrid[i])*
     (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  pow(rgrid[i],3) + 
        ...
        ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),3)*
             ...
             pow(Qr2(i,j,k),2)*
             (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/(2.*pow(rh,2)) \
+ 2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
          ...
          pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           (1 - pow(1 - rgrid[i],2))*
           pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)*Qt2(i,j,k)*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) - 
          ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
