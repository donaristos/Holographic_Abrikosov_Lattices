...
- (1 - pow(1 - rgrid[i],2))*
        ...
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],6)*Qr2(i,j,k)\
          ...
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))) + 
  (Qr1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  (Qr2.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     (-(pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       4*(1 - rgrid[i])*(L1*R0*Qr1(i,j,k) + 
          L2*Qr2(i,j,k)*sqrt(1 + pow(R0,2)))))/(2.*L1*pow(rh,2)) + 
  ...
  (Qt1.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
   ...
   (2.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (2*Qt2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
