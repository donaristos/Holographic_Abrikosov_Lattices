...
(ar.diff(d001,i,j,k)*pow(-1 + rgrid[i],2)*
  ...
  (a2.diff(d100,i,j,k)*pow(-1 + rgrid[i],2)*
   ...
   (2.*pow(1 + pow(R0,2),0.25)*pow(rh,4)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  (H*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  Qtr.diff(d001,i,j,k)*((a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
...
+ Qt1.diff(d100,i,j,k)*(-(a0.diff(d100,i,j,k)*
     ...
     (a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (2.*L2*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qtr.diff(d010,i,j,k)*(-((a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  a0.diff(d001,i,j,k)*(-((pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     ((1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      ...
      (L2*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt1.diff(d001,i,j,k)*(-((a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
     ...
     (4*a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (pow(L2,2)*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d010,i,j,k)*(-((a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ (a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
  ...
  (a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
   ...
   (pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  a0.diff(d100,i,j,k)*(-(Qtr.diff(d001,i,j,k)*
