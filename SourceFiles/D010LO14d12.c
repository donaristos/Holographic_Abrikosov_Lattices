...
(4*Qr1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
    ...
    (8*R.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
    ...
    (8*B.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
       pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
       (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
    ...
    (pow(1 + pow(R0,2),0.25)*(1 - pow(1 - rgrid[i],2))*
       (4*pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         2*pow(L1,2)*(1 - pow(1 - rgrid[i],2))*
          ...
          pow(Qr1(i,j,k),2) + 
         8*pow(L1,2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
          pow(Qr1(i,j,k),2) + 
         (8*pow(L1,2)*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
