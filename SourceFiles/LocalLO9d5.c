...
elem[132]+=
(-32*Qt2.diff(d011,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
  ...
  (64*a0.diff(d001,i,j,k)*a2.diff(d010,i,j,k)*pow(rh,4)*
  ...
  (64*a0.diff(d001,i,j,k)*a1.diff(d001,i,j,k)*
   ...
   (pow(L2,2)*pow(-1 + rgrid[i],4)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  (16*Qt1.diff(d001,i,j,k)*Qtt.diff(d001,i,j,k)*pow(rh,2)*
  ...
  (64*pow(a0.diff(d001,i,j,k),2)*pow(rh,4)*
   ...
   (pow(L2,2)*pow(-1 + rgrid[i],4)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
  (8*Qtr.diff(d001,i,j,k)*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
   (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))) + 
  (8*B(i,j,k)*pow(1 - rgrid[i],2)*Qt2(i,j,k)*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
   (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) + 
  (16*Qt2.diff(d002,i,j,k)*pow(rh,2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (4*pow(1 - rgrid[i],2)*Qt1(i,j,k)*R(i,j,k)*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (16*Qt2.diff(d020,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
   (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (4*B(i,j,k)*pow(1 - rgrid[i],2)*Qt1(i,j,k)*
     pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
   (pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  R.diff(d100,i,j,k)*((Qt1.diff(d100,i,j,k)*
...
+ (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qt1(i,j,k)*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qt2.diff(d001,i,j,k)*((-2*L1*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (Qt1(i,j,k) - ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           sqrt(1 + pow(R0,2) + 
             ...
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
      (L2*pow(rh,4)*(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  ...
  Qt1.diff(d010,i,j,k)*((-16*Q.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
     ...
     R.diff(d001,i,j,k)*((-16*pow(rh,2)*
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  R.diff(d010,i,j,k)*((4*Qtr.diff(d010,i,j,k)*
...
+ (4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qr2(i,j,k))/
     ...
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qr2.diff(d010,i,j,k)*((-8*Qtr.diff(d010,i,j,k)*L2*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) + 
     (8*L2*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qt1(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
...
- (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     Qt1.diff(d001,i,j,k)*((-16*pow(rh,4)*
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) + (16*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           ((pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           pow(rh + rh*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  H*((64*a0.diff(d001,i,j,k)*pow(rh,4)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (L2*pow(-1 + rgrid[i],4)*
        pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     a0.diff(d010,i,j,k)*((64*pow(rh,4)*
         ...
         (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) - (64*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],4)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           ((pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  Qtt.diff(d010,i,j,k)*(Qt2.diff(d010,i,j,k)*
      ((-16*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           ((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
...
- (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  (2*pow(rh,4)*Qt2(i,j,k)*(-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  pow(rgrid[i],3) + 
                 4*pow(rh,2)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - pow(1 - rgrid[i],2))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  R.diff(d001,i,j,k)*((4*Qt1.diff(d001,i,j,k)*
     ...
     (4*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
+ Qt2.diff(d001,i,j,k)*((-16*pow(rh,2)*
           (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
     ...
     ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      (pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qt2.diff(d010,i,j,k)*((32*Q.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
- (4*L2*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qr2(i,j,k))/
     ...
     Qr2.diff(d001,i,j,k)*((4*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (4*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
         ...
         (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  Qr1.diff(d010,i,j,k)*((8*Qtr.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/L2 - 
     8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qt2(i,j,k)*
      (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
     ...
     Qt1.diff(d001,i,j,k)*((4*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (4*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
         ...
         (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  Q.diff(d001,i,j,k)*((-16*Qt2.diff(d001,i,j,k)*pow(rh,2)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
     ...
     ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      ((L2 + L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qr2.diff(d001,i,j,k)*((-8*Qtr.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/L2 + 
     8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qt2(i,j,k)*
      (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
     ...
     Qt1.diff(d001,i,j,k)*((-4*pow(1 - pow(1 - rgrid[i],2),3)*
         ...
         (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  a0.diff(d010,i,j,k)*(a2.diff(d010,i,j,k)*
      ((64*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (pow(L1,2)*pow(1 + pow(R0,2),0.25)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     a1.diff(d001,i,j,k)*((-64*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           ((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
              (1 + pow(R0,2) + 
         ...
         (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) + (64*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           ((pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (4*B(i,j,k)*pow(1 - rgrid[i],2)*Qt1(i,j,k)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  B.diff(d001,i,j,k)*((8*Qtr.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
     ...
     Qt1.diff(d001,i,j,k)*((-4*pow(1 - pow(1 - rgrid[i],2),4)*
        ...
        (4*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
         ...
         (L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2))) + 
     (4*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k)*Qt1(i,j,k)*sqrt(1 + 
          pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) + 
  B.diff(d100,i,j,k)*((2*Qt2.diff(d100,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
     (4*Qtr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        (1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))) + 
     (4*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qt2(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qt1(i,j,k)*
        pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
     ...
     Qtr.diff(d010,i,j,k)*((2*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)))) + 
  Qt2.diff(d100,i,j,k)*((4*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
     ...
     Qtr.diff(d010,i,j,k)*((-4*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (4*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
           Qr1(i,j,k)*sqrt(1 + 
             pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)))) + 
  Qt1.diff(d100,i,j,k)*((-4*Qr1.diff(d001,i,j,k)*L1*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/L2 + 
...
- (2*(1 - rgrid[i]))/
     ...
     B.diff(d001,i,j,k)*((2*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (2*pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*Qr2(i,j,k)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2))) + 
  Qtr.diff(d010,i,j,k)*((8*Qr1.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/L2 + 
