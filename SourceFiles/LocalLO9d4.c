...
elem[131]+=
(-4*B(i,j,k)*pow(1 - rgrid[i],2)*Qt2(i,j,k)*
...
+ (4*pow(1 - rgrid[i],2)*Qt1(i,j,k)*R(i,j,k))/
  ...
  Qtr.diff(d001,i,j,k)*((-4*pow(1 - rgrid[i],2)*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
  ...
  R.diff(d010,i,j,k)*((4*Qtr.diff(d010,i,j,k)*
     ...
     (16*Qt1.diff(d001,i,j,k)*pow(rh,2)*
      ...
      (L1*L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  (16*Qt2.diff(d002,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
  ...
  Qt2.diff(d001,i,j,k)*((2*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
        ...
        Qt2(i,j,k)*Qtr(i,j,k)*sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      (L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  a0.diff(d010,i,j,k)*H*((-16*L1*pow(rh,2)*
  ...
  pow(a0.diff(d010,i,j,k),2)*
   ((16*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),5)*
        pow(1 - rgrid[i],6)*pow(Qr1(i,j,k),2)*Qt2(i,j,k))/
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
     ...
     Qt1.diff(d001,i,j,k)*((4*L1*pow(1 - pow(1 - rgrid[i],2),4)*
        ...
        (16*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (L1*L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  Qtt.diff(d010,i,j,k)*(Qt1.diff(d001,i,j,k)*
  ...
  R.diff(d001,i,j,k)*((4*Qt1.diff(d001,i,j,k)*
     ...
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qr1.diff(d010,i,j,k)*((4*Qtr.diff(d010,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
      ...
      ((-16*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),4)*
        ...
        (64*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (pow(L1,2)*pow(1 + pow(R0,2),0.25)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     a1.diff(d001,i,j,k)*((16*L1*pow(1 + pow(R0,2),0.25)*
             ...
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                ...
                4*pow(rh,2)*
                 (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                   4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
        (64*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
     ...
     a0.diff(d001,i,j,k)*((-64*pow(rh,4)*
        ...
        (64*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),3)*
         ...
         (L1*L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  (2*pow(rh,4)*Qt2(i,j,k)*(-(((1 + 
              B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - rgrid[i])*
            pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  pow(rgrid[i],3) + 
...
+ Qtr(i,j,k),2)*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     ...
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (8*B(i,j,k)*pow(1 - rgrid[i],2)*Qt1(i,j,k)*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
  ...
  (4*pow(1 - rgrid[i],2)*Qt1(i,j,k)*
   ...
   (pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     (1 - pow(1 - rgrid[i],2))) + 
  Q.diff(d001,i,j,k)*((2*pow(L1,2)*(1 - pow(1 - rgrid[i],2))*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  Qt1.diff(d010,i,j,k)*((-16*R.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L1*L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qt1.diff(d100,i,j,k)*((-4*Qr2.diff(d010,i,j,k)*L2*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
     ...
     (4*B.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)) + 
  Qtr.diff(d010,i,j,k)*((4*R.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k))/
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     ...
     (4*Qr2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (4*pow(1 - rgrid[i],2)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) - 
     ...
     (8*B.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3))) + 
  Qr1.diff(d001,i,j,k)*((4*Qt1.diff(d001,i,j,k)*pow(L1,2)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      pow(L2,2) - (4*Qtr.diff(d001,i,j,k)*L1*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(L2,2) + (4*L1*(1 - pow(1 - rgrid[i],2))*
  ...
  Qt1.diff(d001,i,j,k)*((-4*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (4*L1*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) + 
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (4*L1*(1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
...
- Qtr(i,j,k))*Qtr(i,j,k))/(4.*pow(rh,6)) + 
  ...
  B.diff(d100,i,j,k)*(-((Qt2.diff(d100,i,j,k)*
          pow(1 - pow(1 - rgrid[i],2),2)*
          (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
        pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) + 
     (2*Qtr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        (1 - rgrid[i])*(1 + pow(R0,2) + 
          ...
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      (L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) - 
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qt2(i,j,k)*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
     ...
     (4*Qtr.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)) + 
     (4*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qt1(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3) + 
     Qt2.diff(d010,i,j,k)*((-2*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (4*pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
           ...
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3))) + 
     Qt1.diff(d001,i,j,k)*((2*L1*pow(1 - pow(1 - rgrid[i],2),3)*
           (1 - rgrid[i])*Qr1(i,j,k)*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         (L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) - 
        (4*pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
           ...
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         (L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)))) + 
  Qt2.diff(d010,i,j,k)*((-4*R.diff(d001,i,j,k)*L2*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        pow(Qr2(i,j,k),2))/
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
           ...
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                ...
                4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                   4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))) + 
  Qt2.diff(d100,i,j,k)*((2*(1 - rgrid[i])*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
