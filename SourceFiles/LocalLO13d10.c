...
elem[201]+=
-(Qt2.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*ar(i,j,k)*
  ...
  (a0.diff(d001,i,j,k)*Qrr.diff(d100,i,j,k)*
     ...
     pow(1 - rgrid[i],3))/
   (L2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
  Qrr.diff(d001,i,j,k)*((-2*a0.diff(d001,i,j,k)*
  ...
  (2*a0.diff(d001,i,j,k)*Qtt.diff(d001,i,j,k)*
     ...
     pow(1 - rgrid[i],4)*Qr2(i,j,k))/
   (L2*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
  (2*a0.diff(d010,i,j,k)*R.diff(d100,i,j,k)*
     pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],3))/
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*a0.diff(d010,i,j,k)*R.diff(d010,i,j,k)*
     pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],4)*Qr1(i,j,k))/
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qr2.diff(d001,i,j,k)*((pow(1 + pow(R0,2),0.25)*ar(i,j,k)*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
...
+ a0.diff(d001,i,j,k)*((pow(1 + pow(R0,2),0.25)*
     ...
     (4*pow(1 + pow(R0,2),0.25)*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],4)*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
  ...
  Qr1.diff(d001,i,j,k)*((L1*pow(1 + pow(R0,2),0.25)*ar(i,j,k)*
...
) + Qt1.diff(d100,i,j,k)*((a0.diff(d010,i,j,k)*
        pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],3)*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     (a0.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
      ...
      (2.*L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qtr.diff(d010,i,j,k)*(-((a0.diff(d010,i,j,k)*
          pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),3)*
          pow(1 - rgrid[i],4)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  Qt1.diff(d001,i,j,k)*((L1*pow(1 + pow(R0,2),0.25)*ar(i,j,k)*
     ...
     (a0.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
      ...
      (pow(L2,2)*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d010,i,j,k)*((a0.diff(d010,i,j,k)*
