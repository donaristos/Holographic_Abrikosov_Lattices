...
(32*R.diff(d011,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
  ...
  (8*Qrr.diff(d001,i,j,k)*Qrr.diff(d010,i,j,k)*pow(rh,2)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  Qt2.diff(d001,i,j,k)*(-(L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
+ pow(B(i,j,k),2)*pow(Qt2(i,j,k),2)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - pow(1 - rgrid[i],2))*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  R.diff(d010,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*
  ...
  R.diff(d001,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*
     ...
     ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      (L1*L2*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  R.diff(d100,i,j,k)*((pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
...
+ 4*(1 - rgrid[i])*(2*L1*L2*R0*Qr1(i,j,k)*Qr2(i,j,k)*
  ...
  (2*pow(ar.diff(d001,i,j,k),2)*
   ...
   (pow(L2,2)*pow(rh,2)*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),
      2)) + (4*pow(Qrr.diff(d010,i,j,k),2)*pow(rh,2)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (32*pow(a0.diff(d001,i,j,k),2)*pow(rh,4)*
     ...
     ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),4)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/(16.*pow(rh,6)) \
+ pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (-1 - (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k) + 
             ...
             4*(1 - rgrid[i])*
              sqrt((1 + pow(R0,2))*
                (1 + pow(R0,2) + 
                  ...
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L1*L2*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),3))) + 
  Q.diff(d010,i,j,k)*((-32*R.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L1*L2*pow(-1 + rgrid[i],2)*
...
+ ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
  ...
  Qt2.diff(d010,i,j,k)*(-(pow(L2,2)*
         ...
         ((1 - pow(1 - rgrid[i],2))*
           ...
           Qtr(i,j,k))*sqrt(1 + 
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*L1*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
     (pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
        ...
        pow(1 - rgrid[i],3)*(-(L1*
             ...
             ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
               ...
               Qt1(i,j,k)*sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) \
+ L2*Qr2(i,j,k)*(Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
             (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
              sqrt(1 + pow(R0,2) + 
                2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))*
