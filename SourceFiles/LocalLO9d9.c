...
+ (4*Q.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*Qr2(i,j,k)*Qtr(i,j,k))/(2.*pow(rh,2)) + 
  (8*Qrr.diff(d001,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     (1 - rgrid[i])*Qr2(i,j,k)*
     (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (2*Qtt.diff(d100,i,j,k)*(1 - rgrid[i]))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  (16*pow(rh,2)*pow(a0(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],2))/
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  (64*pow(q,2)*pow(rh,6)*pow(a0(i,j,k),2)*
  ...
  a0.diff(d100,i,j,k)*((-16*pow(rh,2)*a0(i,j,k)*
...
- (4*B.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
  ...
  2*Qr2.diff(d001,i,j,k)*(1 - rgrid[i])*
   ((-4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     ...
     2*(1 - rgrid[i])*pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) - 
  ...
  (2*R.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     Qtr(i,j,k)*((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
  ...
  (2*(1 - rgrid[i])*Qt2(i,j,k)*
   ...
   ((1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  a0.diff(d010,i,j,k)*((32*pow(rh,2)*a0(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*
        Qr1(i,j,k))/
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  Qt2.diff(d001,i,j,k)*((L2*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
        pow(Qr2(i,j,k),2)*Qtr(i,j,k))/(2.*pow(rh,6)) - 
        ...
        (-(pow(L2,2)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
          ...
          (4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - rgrid[i])*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))/(2.*L2*pow(rh,4))) \
+ (2*pow(rh,4)*(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (2*B.diff(d001,i,j,k)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*
                (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
          Qr2(i,j,k)*Qt1(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,6)) - 
       (L2*pow(1 - pow(1 - rgrid[i],2),4)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               4*pow(rh,2)*
  ...
  (2*Q.diff(d001,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
