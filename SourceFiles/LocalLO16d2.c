...
elem[241]+=
(32*pow(rh,4)*h2(i,j,k)*(1 + 
       12*S*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
  ...
  h2.diff(d001,i,j,k)*((-2*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (64*pow(q,2)*pow(rh,6)*pow(a0(i,j,k),2)*h2(i,j,k)*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],6))/
  ...
  (32*pow(q,2)*pow(rh,2)*a0(i,j,k)*a2(i,j,k)*h2(i,j,k)*
     ...
     R(i,j,k))/(pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
  ...
  (32*pow(q,2)*pow(rh,2)*pow(a0(i,j,k),2)*h2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],6)*Qt1(i,j,k)*
     Qt2(i,j,k)*R(i,j,k))/
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  (16*pow(q,2)*pow(rh,2)*pow(a0(i,j,k),2)*h2(i,j,k)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
  h2.diff(d010,i,j,k)*((-16*R.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  (16*Qt1.diff(d010,i,j,k)*q*pow(rh,2)*a0(i,j,k)*h1(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
     (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
  ...
  (16*pow(H,2)*pow(L2,2)*pow(q,2)*pow(rh,2)*h2(i,j,k)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (q*h1(i,j,k)*pow(1 - rgrid[i],2)*Qrr(i,j,k)*
  ...
  Qrr.diff(d100,i,j,k)*((h2.diff(d100,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2))/
      (2.*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) + 
     (h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) - 
     (h2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        (1 - rgrid[i])*Qr1(i,j,k))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) - 
     (h2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        (1 - rgrid[i])*Qr2(i,j,k))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) + 
  ...
  (32*pow(q,2)*pow(rh,2)*a0(i,j,k)*a2(i,j,k)*h2(i,j,k)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*Qt2(i,j,k)*
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (16*pow(q,2)*pow(rh,2)*pow(a1(i,j,k),2)*h2(i,j,k)*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
   ...
   (L2*pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (16*a0.diff(d010,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
   ...
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (8*pow(q,2)*pow(rh,2)*a1(i,j,k)*h2(i,j,k)*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (8*h1.diff(d001,i,j,k)*q*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (8*h1.diff(d010,i,j,k)*q*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*(-4*a1(i,j,k)*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))*
        sqrt(1 + pow(R0,2)) + 
  ...
  R.diff(d001,i,j,k)*((16*h2.diff(d001,i,j,k)*pow(rh,2)*
     ...
     (4*q*pow(rh,2)*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L2*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qrr.diff(d001,i,j,k)*((-2*h2(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k))/pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) + 
     (2*h2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qtt.diff(d001,i,j,k)*((2*q*pow(rh,2)*h1(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     ...
     (8*h2.diff(d001,i,j,k)*pow(rh,2)*
      ...
      (pow(L2,2)*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))) + 
  H*((16*R.diff(d001,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
          ...
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
     (Qrr.diff(d100,i,j,k)*L1*L2*q*h1(i,j,k)*
     ...
     (2*Qrr.diff(d001,i,j,k)*L1*L2*q*h1(i,j,k)*
        ...
        Qr1(i,j,k)*Qr2(i,j,k))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) + 
     (2*L1*L2*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(1 - rgrid[i],2)*ygrid[k]*Qr1(i,j,k)*Qrr(i,j,k))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) - 
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
          ...
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
     (8*Qtt.diff(d001,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*ygrid[k]*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
     ...
     (16*R.diff(d010,i,j,k)*L2*q*pow(rh,2)*h1(i,j,k)*
      ...
      (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (32*h1.diff(d010,i,j,k)*L2*q*pow(rh,2)*
      ...
      (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (8*Qtt.diff(d010,i,j,k)*L2*q*pow(rh,2)*h1(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*ygrid[k]*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
     Qrr.diff(d010,i,j,k)*((-8*L2*q*pow(rh,4)*h1(i,j,k)*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
...
+ (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
         ...
         (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           pow(rh + rh*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
        (8*L2*q*pow(rh,2)*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*ygrid[k]*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
         (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(-1 + rgrid[i],2)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))))) + 
  Qrr.diff(d010,i,j,k)*((-2*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(1 - rgrid[i],2)*Qr1(i,j,k))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2) + 
     (2*h2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
