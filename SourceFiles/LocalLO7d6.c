...
elem[101]+=
-4*Qr2.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*Qr2.diff(d020,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (Qt2.diff(d100,i,j,k)*L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*pow(Qr2(i,j,k),2)*Qt1(i,j,k))/
   (4.*pow(rh,2)) + (L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*pow(Qr2(i,j,k),2)*Qt1(i,j,k)*Qt2(i,j,k))/
   (2.*pow(rh,2)) + (L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (pow(L1,2)*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
     ...
     Qr2(i,j,k)*((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
   ...
   (8.*pow(rh,2)*(1 - rgrid[i])) - 
  (Qr1.diff(d100,i,j,k)*pow(L1,2)*(1 - pow(1 - rgrid[i],2))*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  Qrr.diff(d100,i,j,k)*((2*Qr2.diff(d010,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  ...
  Qr1.diff(d010,i,j,k)*((2*L1*(1 - rgrid[i])*
        ((L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
             pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  Qr2.diff(d010,i,j,k)*(-2*(-2*(1 - pow(1 - rgrid[i],2)) + 
        4*pow(1 - rgrid[i],2)) - 
     ...
     (4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qrr(i,j,k))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     (4*pow(rh,4)*((2*(-1 + pow(R0,2))*pow(1 - rgrid[i],2)*
             pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           pow(rh,4) + (L2*pow(1 - pow(1 - rgrid[i],2),6)*
                    ...
                    pow(rh,2)*
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                (2.*pow(rh,4)))*Q(i,j,k)*Qr2(i,j,k)*Qt2(i,j,k)*
             (2*L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)))/
           (8.*pow(rh,6)) + (pow(1 - pow(1 - rgrid[i],2),5)*
             (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
             Qt2(i,j,k)*(-(L2*(1 - rgrid[i])*pow(-1 + rgrid[i],4)*
                   pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],3) + 
                     pow(rh,2)*
                      (pow(mu,2)*pow(-2 + rgrid[i],3)*
                   ...
                   (2*L1*Qr1(i,j,k)*Qt1(i,j,k) + 
                     L2*Qr2(i,j,k)*Qt2(i,j,k)))/(4.*pow(rh,6)) + 
               (L2*pow(-1 + rgrid[i],2)*
                  (pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],3) + 
                    pow(rh,2)*
                  ...
                  ((pow(-1 + rgrid[i],2)*
                    ...
                    ((-1 + rgrid[i])*
                     ...
                     (2.*pow(rh,4)))*Qr2(i,j,k)*
                  (2*L1*Qr1(i,j,k)*Qt1(i,j,k) + 
                    L2*Qr2(i,j,k)*Qt2(i,j,k) - Q(i,j,k)*Qtr(i,j,k)))/
                (4.*pow(rh,2)) + 
               ((pow(-1 + rgrid[i],2)*
                     (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                        pow(rgrid[i],2) + 
                  ...
                  ((-1 + rgrid[i])*
                     (pow(H,2)*pow(-2 + rgrid[i],3)*
                       ...
                       pow(rh,2)*
                        ...
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                   (2.*pow(rh,4)))*Qrr(i,j,k)*Qt1(i,j,k)*R(i,j,k)))/
                  ...
                  pow(rh,2)*
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                     ...
                     4*pow(rh,2)*
                      (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                (-2 - 4*pow(1 - rgrid[i],2)*Q(i,j,k) + 
                  4*pow(R0,2)*pow(1 - rgrid[i],2)*Qrr(i,j,k) + 
                  4*R0*pow(1 - rgrid[i],2)*R(i,j,k)))/(2.*pow(rh,4))) \
+ (pow(1 - pow(1 - rgrid[i],2),4)*(1 - rgrid[i])*
               ...
               (L2*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                  ...
                  ((pow(-1 + rgrid[i],2)*
                       ...
                       pow(rgrid[i],3) + 
                        ...
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                       Qt2(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,4)) + 
                    Q(i,j,k)*
                     (2*L1*R0*Qr1(i,j,k) + 
                     ...
                     (pow(H,2)*pow(-2 + rgrid[i],3)*
                       ...
                       pow(rh,2)*
                        ...
                        pow(rgrid[i],3) + 
                         ...
                         (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                         4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                     (2*L1*L2*R0*pow(rh,2)*Qr1(i,j,k)*Qr2(i,j,k) - 
                       R0*Qt1(i,j,k)*Qt2(i,j,k) + 
                       pow(L2,2)*pow(rh,2)*pow(Qr2(i,j,k),2)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
          ...
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  (4*h2.diff(d001,i,j,k)*L1*q*pow(rh,2)*h1(i,j,k)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (4*h1.diff(d001,i,j,k)*L1*q*pow(rh,2)*h2(i,j,k)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
  ...
  (2*Qr2.diff(d001,i,j,k)*L1*(1 - rgrid[i])*
     ...
     ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
   (L2*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (2*Qt1.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  pow(rgrid[i],3) + 
   ...
   (pow(L2,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qt1.diff(d010,i,j,k)*((2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                 pow(rh,2)*
                  (pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (L1*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
   ...
   (8.*pow(rh,2)*(1 - rgrid[i])*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (2*Qrr.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
  ...
  (pow(rh,2)*((8*L1*pow(q,2)*
       ...
       L2*((L1*L2*(1 - pow(1 - rgrid[i],2))*
           ...
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
          16*L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
           pow(-1 + rgrid[i],2)*
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                 pow(rgrid[i],3) + 
...
+ L1*Qr1(i,j,k)*sqrt((1 + pow(R0,2))*
             ...
             (-(L1*pow(1 - pow(1 - rgrid[i],2),3)*
               ...
               4*pow(L1,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                Qr1(i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
                   (1 - rgrid[i])*
                   ((pow(-1 + rgrid[i],2)*
                        (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                       pow(rgrid[i],2) + 
   ...
   (8.*pow(L2,2)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
  ...
  Qrr.diff(d010,i,j,k)*((-16*R.diff(d010,i,j,k)*pow(rh,2)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
     (8*Qr2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*Qr1(i,j,k))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     ((1 - pow(1 - rgrid[i],2))*
        (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
     ...
     (8*Qrr.diff(d001,i,j,k)*pow(rh,2)*
      ...
      (pow(L2,2)*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))) + 
  (2*Qtr.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
- (1 - pow(1 - rgrid[i],2))*
     ...
     ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))/
   (pow(L2,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (2*Qr1.diff(d001,i,j,k)*pow(L1,2)*(1 - rgrid[i])*
     (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
            pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  H*((-32*h2.diff(d010,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  B.diff(d010,i,j,k)*((16*Qrr.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (pow(L2,2)*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
