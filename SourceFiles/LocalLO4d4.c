...
-2/(1 - pow(1 - rgrid[i],2)) + 
  ...
  (12*pow(Qr1.diff(d001,i,j,k),2)*pow(L1,2)*
     pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2))/pow(L2,2) - 
  (8*B(i,j,k)*pow(1 - rgrid[i],2))/
   (1 + B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2) - pow(1 - rgrid[i],2)) \
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (32*pow(R.diff(d001,i,j,k),2)*pow(rh,2)*
  ...
  (pow(a0.diff(d100,i,j,k),2)*
   ...
   (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (4*pow(a0.diff(d010,i,j,k),2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),6)*pow(1 - rgrid[i],6)*
  ...
  (pow(q,2)*pow(rh,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
     ...
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     pow(-4*a2(i,j,k) + 4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
        (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qt2(i,j,k),2))/
  ...
  (pow(Qt2.diff(d010,i,j,k),2)*
     ...
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     pow(Qr1(i,j,k),2)*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))/
   (pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (pow(Qt1.diff(d001,i,j,k),2)*pow(L1,2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
  ...
  a1.diff(d001,i,j,k)*((8*ar.diff(d001,i,j,k)*L1*
        pow(1 + pow(R0,2),0.25)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k))/
     ...
     (8*L1*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a2.diff(d100,i,j,k)*((4*ar.diff(d001,i,j,k)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]))/
     ...
     (4*a0.diff(d001,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d100,i,j,k)*((2*a2.diff(d100,i,j,k)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (4*a0.diff(d001,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        Qt2(i,j,k)*(L1*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*Qt1(i,j,k) - 
          Qtr(i,j,k)))/
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d010,i,j,k)*((8*ar.diff(d001,i,j,k)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*
        Qr1(i,j,k)*Qt2(i,j,k))/
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*a2.diff(d010,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (8*a1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (8*a0(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),5)*pow(1 - rgrid[i],4)*
        Qr1(i,j,k)*pow(Qt2(i,j,k),2))/
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*a0.diff(d001,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),5)*pow(1 - rgrid[i],6)*
        Qr1(i,j,k)*Qt2(i,j,k)*(L1*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*
           Qt1(i,j,k) - Qtr(i,j,k)))/
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d001,i,j,k)*((8*a1.diff(d001,i,j,k)*L1*
        pow(1 + pow(R0,2),0.25)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],4)*
     ...
     (8*a0(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*ar.diff(d001,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
        (-(L1*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*Qt1(i,j,k)) + 
          Qtr(i,j,k)))/
      (pow(L2,2)*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  H*((4*a2.diff(d100,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*Qr1(i,j,k))/
      (pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (8*ar.diff(d001,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k))/
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (8*a2.diff(d010,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        pow(Qr1(i,j,k),2))/
      (pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*a1.diff(d001,i,j,k)*pow(L1,2)*pow(1 + pow(R0,2),0.25)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        pow(Qr1(i,j,k),2))/
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*L1*a0(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k)*Qt2(i,j,k))/
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (4*a0.diff(d100,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],3)*
        Qr1(i,j,k)*Qt2(i,j,k))/
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*a0.diff(d010,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),5)*pow(1 - rgrid[i],4)*
        pow(Qr1(i,j,k),2)*Qt2(i,j,k))/
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*a0.diff(d001,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],4)*
        Qr1(i,j,k)*(-(L1*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*
             Qt1(i,j,k)) + Qtr(i,j,k)))/
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a2.diff(d010,i,j,k)*((-8*ar.diff(d001,i,j,k)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k))/
      (L2*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
  ...
  Qr1.diff(d100,i,j,k)*((-2*Qrr.diff(d010,i,j,k)*
     ...
     (4*Qrr.diff(d001,i,j,k)*L1*
      ...
      (L2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
  (4*pow(a1.diff(d001,i,j,k),2)*pow(L1,2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))) + 
  (16*B.diff(d002,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  Qtt.diff(d001,i,j,k)*((4*L1*pow(rh,4)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
+ L2*Qr2(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*
      ...
      (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt1.diff(d001,i,j,k)*((-2*Qtr.diff(d001,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     (2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      ...
      ((L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d010,i,j,k)*((2*Qtr.diff(d001,i,j,k)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     (2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      ...
      ((L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d001,i,j,k)*((2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                 pow(rh,2)*
...
+ L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
        ...
        (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  R.diff(d001,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*Qr2(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
              ...
              ((pow(1 - pow(1 - rgrid[i],2),2)*
                ...
                sqrt((1 + pow(R0,2))*
                  (1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))\
) - 3*L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*Qr1(i,j,k)*
              pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)*
              ((pow(1 - pow(1 - rgrid[i],2),2)*
                   pow(-1 + rgrid[i],2)*
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
...
+ (B(i,j,k)*(1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        ...
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
       4*B(i,j,k)*(2 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
- (pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
  ...
  B.diff(d010,i,j,k)*((8*(1 - pow(1 - rgrid[i],2))*
     ...
     (8*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k))/pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) - 
        ...
        (16*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           ...
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5))) + (pow(L2,2)*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i])*(pow(L1,2)*Qr1(i,j,k)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))*
             ...
             pow(1 - pow(1 - rgrid[i],2),3)*
              ((pow(-1 + rgrid[i],2)*
                ...
                ((-1 + rgrid[i])*
                 ...
                 (2.*pow(rh,4)))*pow(Qt1(i,j,k),2) + 
             4*(1 - rgrid[i])*sqrt(1 + pow(R0,2))) - 
          3*pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))*
              ...
              ((pow(1 - pow(1 - rgrid[i],2),2)*
                ...
                sqrt((1 + pow(R0,2))*
                  (1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))\
))))/(pow(L1,2)*pow(L2 + L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
...
+ Qr2.diff(d010,i,j,k)*((-4*Qrr.diff(d001,i,j,k)*
  ...
  B.diff(d001,i,j,k)*((8*(1 - pow(1 - rgrid[i],2))*
      ...
      (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
     (8*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k))/pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
              ...
              ((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                 (1 + pow(R0,2) + 
                   ...
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
                      ...
                      sqrt(1 + pow(R0,2))) + 
                   pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
...
+ pow(L1,3)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
        ...
        (L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     ((1 - rgrid[i])*(-(L1*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),4)*
             ((pow(-1 + rgrid[i],2)*
                  (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],2) + 
                    3*pow(H,2)*pow(-2 + rgrid[i],2)*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
          2*pow(L2,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
              ...
              Qr2(i,j,k)*((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                ...
                (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) \
+ L1*pow(L2,2)*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*
              (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
              (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
              ((pow(1 - pow(1 - rgrid[i],2),2)*
                   pow(-1 + rgrid[i],2)*
                ...
                (-1 + pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2))*
                 sqrt((1 + pow(R0,2))*
                   (1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))\
)) - 2*L1*pow(L2 + L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*Qr1(i,j,k)*
              (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
              (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
              ((pow(1 - pow(1 - rgrid[i],2),3)*
                   pow(-1 + rgrid[i],2)*
                 ...
                 sqrt((1 + pow(R0,2))*
                   (1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))\
))))/(pow(L2,3)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qr1.diff(d001,i,j,k)*((16*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
+ 4*(1 - rgrid[i])*(L2*R0*Qr2(i,j,k)*
     ...
     (2*L1*(1 - rgrid[i])*(4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
                   ...
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))))))/(4.*pow(rh,2))))/
      (L2*(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qr1.diff(d010,i,j,k)*((8*R.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
     (8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*R(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
     (16*Qr1.diff(d001,i,j,k)*L1*
             ...
             4*(1 - rgrid[i])*(-(L2*R0*Qr2(i,j,k)) - 
                (L1*Qr1(i,j,k)*
                 ...
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))/
         (4.*pow(rh,2)))) + Qr2.diff(d001,i,j,k)*
   ((8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*R(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
          ...
          4*L2*(1 - rgrid[i])*Qr2(i,j,k)*
           sqrt((1 + pow(R0,2))*
             (1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))/
      (2.*pow(rh,2)*(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
           2))) + (2*(1 - rgrid[i])*
                ...
                ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
                  ...
                  Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                   sqrt(1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
))) + 4*(1 - rgrid[i])*(2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                (-2*L1*Qr1(i,j,k)*
                   (R0 - (pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(-1 + rgrid[i],2)*
                        (pow(H,2)*pow(-2 + rgrid[i],3)*
                ...
                ((pow(1 - pow(1 - rgrid[i],2),2)*
                  ...
                  sqrt((1 + pow(R0,2))*
                    (1 + pow(R0,2) + 
                      ...
                      pow(1 - pow(1 - rgrid[i],2),2)*
                       pow(R(i,j,k),2)))) + 
               L1*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                (-2*L2*Qr2(i,j,k)*
                   (R0 - (pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(-1 + rgrid[i],2)*
                        (pow(H,2)*pow(-2 + rgrid[i],3)*
