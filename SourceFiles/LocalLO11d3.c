...
elem[162]+=
(4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) - 
  (4*a0(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  Q.diff(d100,i,j,k)*(-((a0.diff(d100,i,j,k)*
          pow(1 - pow(1 - rgrid[i],2),2))/
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) + 
     (2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2))/
      ((1 - rgrid[i])*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) + 
     ...
     a0.diff(d010,i,j,k)*((-2*pow(1 - pow(1 - rgrid[i],2),4)*
        ...
        (8*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  a0.diff(d010,i,j,k)*((4*pow(1 - pow(1 - rgrid[i],2),2)*
...
- (pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
  ...
  (8*a0.diff(d001,i,j,k)*Qtt.diff(d001,i,j,k)*pow(rh,2)*
   ...
   (pow(L2,2)*pow(-1 + rgrid[i],2)*
     ...
     pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  Qrr.diff(d010,i,j,k)*((8*a0.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
+ L2*Qr2(i,j,k)*(Qt1(i,j,k)*(1 + pow(R0,2) + 
     ...
     a1.diff(d001,i,j,k)*((pow(1 + pow(R0,2),0.25)*
         ...
         (pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
        (8*pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           ((pow(L1,2)*pow(1 + 
     ...
     (a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*pow(-1 + rgrid[i],2)*
        ...
        (-(R0*Qt1(i,j,k)) - (1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
           ...
           Qt2(i,j,k)*sqrt(1 + 
             pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))/
      (L2*pow(rh,4)*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  a0.diff(d100,i,j,k)*((-2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
