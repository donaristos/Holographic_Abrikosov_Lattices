...
(16*ar.diff(d001,i,j,k)*pow(rh,2)*a0(i,j,k)*
     ...
     pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
          ...
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
     pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) - 
  (4*pow(1 - rgrid[i],2)*Qt2(i,j,k)*Qtt(i,j,k))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) - 
  ...
  a2.diff(d100,i,j,k)*((-8*pow(rh,2)*a0(i,j,k)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2))) + 
  Qtt.diff(d100,i,j,k)*(-((Qt2.diff(d100,i,j,k)*
     ...
     (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qt2(i,j,k))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) + 
  a0.diff(d100,i,j,k)*((4*a2.diff(d100,i,j,k)*pow(rh,2)*
  ...
  H*((16*L1*pow(rh,2)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  a0.diff(d010,i,j,k)*((16*ar.diff(d001,i,j,k)*pow(rh,2)*
     ...
     (64*a2.diff(d010,i,j,k)*pow(rh,4)*
      ...
      (pow(L1,2)*pow(1 + pow(R0,2),0.25)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],4)*
        pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  (2*pow(rh,4)*Qt2(i,j,k)*(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - pow(1 - rgrid[i],2))*
     ...
     pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qt2.diff(d100,i,j,k)*((2*Qtt.diff(d010,i,j,k)*
