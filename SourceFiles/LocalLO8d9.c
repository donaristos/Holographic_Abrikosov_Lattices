...
(Qtr.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*Qr2(i,j,k)*Qtr(i,j,k))/(2.*L1*pow(rh,2)) + 
  (8*Qrr.diff(d010,i,j,k)*L2*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     (1 - rgrid[i])*Qr2(i,j,k)*
     (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (8*a0.diff(d010,i,j,k)*a0.diff(d100,i,j,k)*L2*pow(rh,2)*
...
+ Qtr(i,j,k)))/(4.*pow(rh,2)) - 
  ...
  (2*(1 - rgrid[i])*Qt1(i,j,k)*
   ...
   ((1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  a0.diff(d010,i,j,k)*((-16*L2*pow(rh,2)*a0(i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*
        Qr2(i,j,k))/
      (L1*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
