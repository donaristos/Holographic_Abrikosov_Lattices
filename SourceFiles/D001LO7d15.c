...
elem[110]+=
((16*h1.diff(d010,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    (4*pow(rh,2)*pow(1 - rgrid[i],2)*
       (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
       (4*h1(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) + 
         q*h2(i,j,k)*(-4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             ...
             (L2*Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
               L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
                sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
                   2))) + 4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
             pow(1 - rgrid[i],2)*
             ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
