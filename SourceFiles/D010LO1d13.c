...
((-4*ar.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
    ...
    (4*ar.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ...
     (pow(L1,2)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (16*a1.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     ...
     (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
    (16*H*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     ...
     (L1*pow(1 + pow(R0,2),0.25)*
       ...
       pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
    (16*a2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
       ((pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
            pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     (sqrt(1 + pow(R0,2))*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
    (16*a0.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
