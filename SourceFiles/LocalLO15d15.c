   ...
   (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (2*Q.diff(d100,i,j,k)*(1 - rgrid[i]))/
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (4*pow(1 - rgrid[i],2)*Q(i,j,k))/
   (1 - pow(1 - rgrid[i],2) + pow(1 - pow(1 - rgrid[i],2),2)*Q(i,j,k)) \
- (4*Q.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
  (4*Q.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
  (4*pow(L2,2)*pow(q,2)*pow(a2(i,j,k),2)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     pow(Qr2(i,j,k),2))/sqrt(1 + pow(R0,2)) - 
  (Qrr.diff(d100,i,j,k)*(1 - rgrid[i]))/
  ...
  (2*Qrr.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  (768*pow(rh,4)*S*pow(h1(i,j,k),2)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (32*pow(rh,4)*(1 + 12*S*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
        pow(1 - pow(1 - rgrid[i],2),2))*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  4*pow(L1,2)*pow(q,2)*pow(a0(i,j,k),2)*
   pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],6)*
   pow(Qr1(i,j,k),2)*pow(Qt1(i,j,k),2) + 
  (8*pow(L2,2)*pow(q,2)*a0(i,j,k)*a2(i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*
     pow(Qr2(i,j,k),2)*Qt2(i,j,k))/pow(1 + pow(R0,2),0.25) - 
  8*L1*L2*pow(q,2)*pow(a0(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),4)*
   pow(1 - rgrid[i],6)*Qr1(i,j,k)*Qr2(i,j,k)*Qt1(i,j,k)*Qt2(i,j,k) + 
  (32*pow(q,2)*R0*pow(rh,2)*pow(a0(i,j,k),2)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  4*pow(L2,2)*pow(q,2)*pow(a0(i,j,k),2)*
   pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],6)*
   pow(Qr2(i,j,k),2)*pow(Qt2(i,j,k),2) - 
  (8*L2*pow(q,2)*a0(i,j,k)*a2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],4)*Qr2(i,j,k)*Qtr(i,j,k))/
   pow(1 + pow(R0,2),0.25) + 
  8*L1*pow(q,2)*pow(a0(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],6)*Qr1(i,j,k)*Qt1(i,j,k)*Qtr(i,j,k) + 
  8*L2*pow(q,2)*pow(a0(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],6)*Qr2(i,j,k)*Qt2(i,j,k)*Qtr(i,j,k) - 
  4*pow(q,2)*pow(a0(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],6)*pow(Qtr(i,j,k),2) + 
  (Qtt.diff(d100,i,j,k)*(1 - rgrid[i]))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) - 
  (2*Qtt.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) - 
  (2*Qtt.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  (64*pow(q,2)*pow(rh,6)*pow(a0(i,j,k),2)*pow(1 - rgrid[i],6)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (pow(-1 + rgrid[i],4)*pow(pow(H,2)*pow(-2 + rgrid[i],3)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  (4*pow(1 - rgrid[i],2)*Qtt(i,j,k))/
   (2*(1 - pow(1 - rgrid[i],2)) + 
     2*pow(1 - pow(1 - rgrid[i],2),2)*Qtt(i,j,k)) - 
  (32*pow(q,2)*pow(rh,2)*a0(i,j,k)*a2(i,j,k)*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (32*pow(q,2)*pow(rh,2)*pow(a0(i,j,k),2)*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (16*pow(q,2)*pow(rh,2)*pow(a2(i,j,k),2)*
  ...
  (16*pow(q,2)*pow(R0,2)*pow(rh,2)*pow(a2(i,j,k),2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (sqrt(1 + pow(R0,2))*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
  (16*pow(q,2)*pow(rh,2)*pow(a0(i,j,k),2)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],6)*
   ...
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
  (16*pow(q,2)*pow(R0,2)*pow(rh,2)*pow(a0(i,j,k),2)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],6)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*pow(Qt1(i,j,k),2))/
   ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  (32*pow(q,2)*pow(rh,2)*a0(i,j,k)*a2(i,j,k)*
   ...
   (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
  (32*pow(q,2)*pow(R0,2)*pow(rh,2)*a0(i,j,k)*a2(i,j,k)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],4)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt2(i,j,k))/
   (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
  ...
  (16*pow(q,2)*pow(R0,2)*pow(rh,2)*pow(a0(i,j,k),2)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
  (32*pow(q,2)*R0*pow(rh,2)*pow(a2(i,j,k),2)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (32*pow(q,2)*R0*pow(rh,2)*pow(a0(i,j,k),2)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
  (64*pow(q,2)*R0*pow(rh,2)*a0(i,j,k)*a2(i,j,k)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],4)*
  ...
  (16*pow(q,2)*pow(rh,2)*pow(a0(i,j,k),2)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
  (2*pow(q,2)*ar(i,j,k)*pow(1 - rgrid[i],2)*
   ...
   pow(1 + pow(R0,2),0.25) - 
  (16*pow(H,2)*pow(L2,2)*pow(q,2)*pow(rh,2)*pow(1 - rgrid[i],2)*
  ...
  4*pow(L1,2)*pow(q,2)*pow(a1(i,j,k),2)*pow(1 - rgrid[i],2)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  2*H*L2*pow(q,2)*pow(1 - rgrid[i],2)*ygrid[k]*
   (-4*L1*ar(i,j,k)*Qr1(i,j,k) + 
     (4*L1*L2*a2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k)*
        Qr2(i,j,k))/pow(1 + pow(R0,2),0.25) - 
     (16*R0*pow(rh,2)*a2(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
     4*pow(L1,2)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*pow(Qr1(i,j,k),2)*Qt1(i,j,k) - 
     4*L1*L2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr1(i,j,k)*Qr2(i,j,k)*Qt2(i,j,k) + 
     (16*R0*pow(rh,2)*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt2(i,j,k))/
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
     ...
     (16*pow(rh,2)*a2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*R(i,j,k))/
      (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     (16*pow(rh,2)*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
     (16*pow(R0,2)*pow(rh,2)*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k))/
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
        ...
        sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) - 
     (32*R0*pow(rh,2)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*R(i,j,k))/
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
           ...
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                ...
                4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                   4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))) + 
  (8*pow(q,2)*pow(rh,2)*a1(i,j,k)*pow(1 - rgrid[i],2)*
