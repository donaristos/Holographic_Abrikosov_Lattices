...
(-32*B.diff(d011,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
  ...
  (16*pow(B.diff(d001,i,j,k),2)*pow(rh,2)*
   ...
   (pow(L2,2)*pow(-1 + rgrid[i],2)*
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
  (48*pow(R.diff(d010,i,j,k),2)*pow(rh,2)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
  ...
  (48*pow(R.diff(d001,i,j,k),2)*pow(rh,2)*
...
+ pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k) - 
          (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],4)*
             ...
             (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))/
           (16.*pow(rh,6))))*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
...
+ (2*a0.diff(d010,i,j,k)*pow(1 + 
      ...
      (pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
- (2*a0.diff(d001,i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
...
- (4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],4)*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
- (4*ar.diff(d001,i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
...
- (2*a1.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
+ (2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],3)*
        (pow(Qt1(i,j,k),2) - 
          pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
           pow(Qt2(i,j,k),2))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
...
- (16*h1.diff(d010,i,j,k)*L2*q*pow(rh,2)*h2(i,j,k)*
      ...
      (L1*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
- (4*L2*pow(q,2)*pow(rh,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*ygrid[k]*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
...
+ Qt2.diff(d100,i,j,k)*((Qtr.diff(d001,i,j,k)*
      ...
      (2.*L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
+ (Qt2.diff(d010,i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
...
- (pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
      ...
      (2.*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qr2.diff(d100,i,j,k)*Qrr.diff(d010,i,j,k)*
...
- (2*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      ((L1 + L1*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qr1.diff(d100,i,j,k)*Qrr.diff(d001,i,j,k)*
...
+ (2*L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
      ...
      ((L2 + L2*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  R.diff(d100,i,j,k)*((-8*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ...
     (4*Qr2.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L1*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
         1.5)) - (4*Qr1.diff(d001,i,j,k)*L1*
        pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
     ...
     Qr2.diff(d001,i,j,k)*((-8*
        ...
        (4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
         ...
         (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
           pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
     B.diff(d010,i,j,k)*((8*pow(1 - pow(1 - rgrid[i],2),3)*
           (1 - rgrid[i])*Qr1(i,j,k)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         pow(1 + pow(R0,2) + 
           2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        ...
        (4*pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*Qr1(i,j,k))/
         (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
           pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
     B.diff(d001,i,j,k)*((8*pow(1 - pow(1 - rgrid[i],2),3)*
           (1 - rgrid[i])*Qr2(i,j,k)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         pow(1 + pow(R0,2) + 
           2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
  ...
  (B(i,j,k)*(1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (8*R0*(1 - rgrid[i]) - (2*pow(1 - pow(1 - rgrid[i],2),2)*
          (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ B.diff(d100,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     (4*(1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
     R.diff(d100,i,j,k)*((-4*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         pow(1 + pow(R0,2) + 
           2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
           pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2),2) + 
...
+ (pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
  ...
  Qtt.diff(d010,i,j,k)*((4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
      ...
      (L1*pow(-1 + rgrid[i],2)*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
- (4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                 pow(rh,2)*
                  (pow(mu,2)*pow(-2 + rgrid[i],3)*
        ...
        ((1 - pow(1 - rgrid[i],2))*
          ...
          2*L2*Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
      (2.*L2*pow(rh,2)*pow(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2),1.5))) + 
  Qrr.diff(d001,i,j,k)*(-((L1*
          pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
          (1 - pow(1 - rgrid[i],2))*
...
- Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))\
))/(L1*(L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) \
+ (2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
           ...
           (L2*Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
              ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
                ...
                Qt1(i,j,k)*sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) \
+ L2*Qr2(i,j,k)*((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
                 (1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) \
- Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        ...
        (32*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (L1*L2*pow(-1 + rgrid[i],2)*
           ...
           pow(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2),2))) + 
     R.diff(d010,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
         pow(1 - rgrid[i],2)*
         ...
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            2.5)) + (32*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)*
           ((pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),2))\
) + (pow(L2,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
             ...
             (4*(1 + pow(R0,2))*(1 - rgrid[i]))/
              sqrt((1 + pow(R0,2))*
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) \
+ 2*pow(L1,3)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                  pow(-1 + rgrid[i],2)*
          ...
          2*pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*
           Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                  pow(-1 + rgrid[i],2)*
             ...
             4*(1 - rgrid[i])*
              sqrt((1 + pow(R0,2))*
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))\
)/(pow(L1,3)*pow(L2 + L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (pow(L2,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
      ...
      (pow(L1,3)*pow(L2 + L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ B.diff(d001,i,j,k)*((16*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     R.diff(d001,i,j,k)*((-48*pow(rh,2)*
         ...
         (pow(L2,2)*pow(-1 + rgrid[i],2)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            2.5)) + (16*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*
           ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
              (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
              (1 + pow(R0,2) + 
         ...
         (pow(L2,2)*pow(-1 + rgrid[i],2)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) + (32*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)*
           ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
                pow(-1 + rgrid[i],2)*
             ...
             (4*(1 + pow(R0,2))*(1 - rgrid[i]))/
              sqrt((1 + pow(R0,2))*
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) \
+ 2*pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*Qr1(i,j,k)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                  pow(-1 + rgrid[i],2)*
                  (pow(H,2)*pow(-2 + rgrid[i],3)*
...
+ pow(L1,2)*L2*Qr2(i,j,k)*(-((pow(1 - pow(1 - rgrid[i],2),2)*
                  (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                  (pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],3) + 
                    pow(rh,2)*
...
- pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
               ...
               pow(1 - pow(1 - rgrid[i],2),3)*
                ...
                sqrt((1 + pow(R0,2))*
                  (1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))\
) + 4*(1 - rgrid[i])*(L2*(1 + pow(R0,2))*Qr2(i,j,k)*
                   sqrt(1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
) - 2*L1*R0*Qr1(i,j,k)*sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))))))/
      ...
      (pow(L1,3)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qr1.diff(d010,i,j,k)*((16*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (8*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
      ...
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
     (8*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
     R.diff(d001,i,j,k)*((-16*
           (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
           Qr2(i,j,k)*pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         pow(1 + pow(R0,2) + 
...
+ Qrr.diff(d001,i,j,k)*((4*L1*
         ...
         ((L2 + L2*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     (2*(1 - rgrid[i])*((-4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
...
+ L2*Qr2(i,j,k)*sqrt(1 + pow(R0,2) + 
          ...
          (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
           ...
           (4.*pow(rh,2))))/
      sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) - 
     (2*(1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                ...
                (L2*Qr2(i,j,k)*
                  ...
                  L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                   ...
                   sqrt(1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
)) + 4*(1 - rgrid[i])*(pow(L2,2)*R0*pow(Qr2(i,j,k),2)*
                   (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
                  L1*L2*Qr1(i,j,k)*Qr2(i,j,k)*
                   ((1 - pow(1 - rgrid[i],2))*R(i,j,k)*
                      sqrt(1 + pow(R0,2)) + 
  ...
  Qr1.diff(d001,i,j,k)*((-8*L1*
        ...
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L2*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
         1.5)) + (8*L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        pow(1 - rgrid[i],2))/
      (L2*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
          ...
          (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
             ...
             ((pow(1 - pow(1 - rgrid[i],2),2)*
                ...
                sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) \
+ 4*(1 - rgrid[i])*(2*pow(L2,2)*R0*pow(Qr2(i,j,k),2)*
                   (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
                  (pow(L1,2)*(1 + pow(R0,2))*
                     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                     pow(Qr1(i,j,k),2)*
                     pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)\
)/sqrt((1 + pow(R0,2))*(1 + pow(R0,2) + 
                       2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))) + 
                  (L1*L2*Qr1(i,j,k)*Qr2(i,j,k)*
                     (R0 + 2*pow(R0,3) + 
                       2*R0*pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2) + 
                       R0*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
                        (1 + 2*pow(R0,2) + 
                        4*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                        2*pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2)) + 
                       2*R0*sqrt(1 + pow(R0,2))*
                        sqrt(1 + pow(R0,2) + 
                        2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                        pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2)) + 
                       2*(1 - pow(1 - rgrid[i],2))*R(i,j,k)*
                        (2*pow(R0,2) + 
                        sqrt(1 + pow(R0,2))*
                        sqrt(1 + pow(R0,2) + 
                        2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  ...
                  pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                   ...
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))))))/(4.*pow(rh,2))))/
      (L2*(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (4*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - rgrid[i])*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        (4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - rgrid[i])*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           sqrt(1 + pow(R0,2) + 
                  ...
                  pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                   ...
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))))))/(4.*pow(rh,2))))/
      (L2*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),2))) \
+ Q.diff(d001,i,j,k)*((-16*B.diff(d001,i,j,k)*pow(rh,2)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
...
+ pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*pow(Qt2(i,j,k),2)*
                 sqrt(1 + pow(R0,2) + 
                  ...
                  L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*Qr1(i,j,k)*
                pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)*
                ((pow(1 - pow(1 - rgrid[i],2),2)*
                     pow(-1 + rgrid[i],2)*
                     (pow(H,2)*pow(-2 + rgrid[i],3)*
...
+ L1*Qr1(i,j,k)*(-(pow(1 - pow(1 - rgrid[i],2),2)*
                   ...
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))))))))/
      (L2*pow(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
...
+ 4*(1 - rgrid[i])*(pow(L1,2)*L2*Qr2(i,j,k)*
        ...
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ R.diff(d001,i,j,k)*((16*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(1 - rgrid[i],2)*Qr2(i,j,k)*
        pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
      pow(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2),2) - 
                   ...
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))))) - 
             pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*
              Qr1(i,j,k)*pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
               2)*((pow(1 - pow(1 - rgrid[i],2),2)*
                   pow(-1 + rgrid[i],2)*
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
                      pow(rgrid[i],3) + 
                ...
                sqrt((1 + pow(R0,2))*
                  (1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))\
))))/(pow(L1,2)*(L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),2.5)) \
+ ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),3)*
...
+ pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*pow(Qt2(i,j,k),2)*
                 ...
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))) \
+ 4*(1 - rgrid[i])*(-(pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
                 3)*Qr1(i,j,k)*
...
+ R.diff(d010,i,j,k)*((-32*Q.diff(d001,i,j,k)*pow(rh,2)*
      ...
      (L1*L2*pow(-1 + rgrid[i],2)*
        ...
        pow(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2),2)) + 
     (16*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
...
+ pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*Qr1(i,j,k)*
          ...
          pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
             ...
             4*(1 - rgrid[i])*
              (-2*L2*R0*Qr2(i,j,k) + L1*Qr1(i,j,k)*sqrt(1 + pow(R0,2)))) \
+ 2*pow(L1,2)*L2*Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                  pow(-1 + rgrid[i],2)*
                  (pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],3) + 
...
+ pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qr2.diff(d010,i,j,k)*((-8*R.diff(d001,i,j,k)*L2*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L1*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
         1.5)) + (8*L2*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
        R(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (L1*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
         1.5)) - (8*L2*pow(1 - rgrid[i],2))/
      (L1*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     Qr2.diff(d001,i,j,k)*((8*L2*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         (L1*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) - (8*L2*pow(1 - pow(1 - rgrid[i],2),2)*
           pow(1 - rgrid[i],2))/
         (L1*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) \
+ (2*L2*(1 - rgrid[i])*(-4*(1 - rgrid[i]) + 
          (pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
             pow(-1 + rgrid[i],4)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ (pow(1 - pow(1 - rgrid[i],2),2)*
                ...
                (L2*Qr2(i,j,k)*
                  ...
                  L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                   ...
                   sqrt(1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
)) + 4*(1 - rgrid[i])*(pow(L2,2)*pow(Qr2(i,j,k),2)*
                   (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                   sqrt(1 + pow(R0,2)) + 
                  pow(L1,2)*R0*
                   (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                     ...
                     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                      sqrt((1 + pow(R0,2))*
                        (1 + pow(R0,2) + 
                         ...
                         pow(1 - pow(1 - rgrid[i],2),2)*
                         pow(R(i,j,k),2)))))))/(4.*pow(rh,2))))/
      (L1*pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))\
) + Qr2.diff(d001,i,j,k)*((-16*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*R(i,j,k)*
        pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
      pow(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     ...
     (2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*(1 - rgrid[i])*
        (8*(1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
          (pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
             pow(-1 + rgrid[i],4)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
  ...
  Qrr.diff(d010,i,j,k)*((L2*(1 - pow(1 - rgrid[i],2))*
     ...
     Qr2.diff(d010,i,j,k)*((-4*L2*pow(1 - pow(1 - rgrid[i],2),3)*
         ...
         ((L1 + L1*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
     Qr2.diff(d001,i,j,k)*((-4*L2*pow(1 - pow(1 - rgrid[i],2),3)*
           pow(1 - rgrid[i],2)*Qr2(i,j,k)*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         ((L1 + L1*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
