...
((2*h2.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    2*H*q*h1(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     ygrid[k]*((L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k)*
    ...
    2*h2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
