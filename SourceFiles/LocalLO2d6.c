...
elem[21]+=
-4*Qrr.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*Qrr.diff(d020,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*Qrr.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) - 
  (12*pow(Qrr.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  (4*Q.diff(d010,i,j,k)*Q.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) + 
  8*pow(h1.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  8*pow(h2.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  (8*pow(Q.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2) + 
  (Qtr.diff(d100,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
...
- (1 - pow(1 - rgrid[i],2))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k))/pow(rh,2) - 
  2*h2.diff(d001,i,j,k)*L1*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
     4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      Qt1(i,j,k)) + 2*h1.diff(d001,i,j,k)*L1*q*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
     4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      Qt1(i,j,k)) + h2.diff(d100,i,j,k)*
   (-4*h2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      (1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     L1*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt1(i,j,k))) + h1.diff(d100,i,j,k)*
   (-4*h1.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     L1*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
      ...
      (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt1(i,j,k))) + (L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
...
- (1 - pow(1 - rgrid[i],2))*
   ...
   pow(rh,2) - (Qr2.diff(d100,i,j,k)*L1*L2*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)))*Qt1(i,j,k)*Qt2(i,j,k)))/(2.*pow(rh,2)) - 
  ...
  (Qr2.diff(d001,i,j,k)*L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)))*Qt1(i,j,k)*Qt2(i,j,k)))/pow(rh,2) + 
...
- (1 - pow(1 - rgrid[i],2))*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     Qt1(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,2)*(1 - rgrid[i])) - 
  (2*Qtt.diff(d010,i,j,k)*Qtt.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  (4*pow(Qtt.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  Qtt.diff(d010,i,j,k)*((4*Qtt.diff(d001,i,j,k)*
     ...
     (4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      ...
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) - 
  (4*R.diff(d010,i,j,k)*R.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
  (8*pow(R.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
  (4*B.diff(d010,i,j,k)*B.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  (8*pow(B.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr1(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  a2.diff(d100,i,j,k)*((2*a1.diff(d001,i,j,k)*L1*
     ...
     (2*a2.diff(d010,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
     ...
     (2*a0.diff(d010,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
      ...
      (pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
  (Qr1.diff(d100,i,j,k)*pow(L1,2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  (pow(L1,2)*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
   ...
   (4.*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) + 
  (Qr1.diff(d001,i,j,k)*pow(L1,2)*(1 - pow(1 - rgrid[i],2))*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  (Qrr.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
     ...
     (-4*L2*R0*(1 - rgrid[i])*Qr2(i,j,k) + 
       ...
       pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        ((1 - pow(1 - rgrid[i],2))*
           (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - 
          Qtr(i,j,k)) - 4*L1*(1 - rgrid[i])*Qr1(i,j,k)*
        sqrt(1 + pow(R0,2))))/pow(rh,2) - 
  (L1*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
   ...
   (4.*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) + 
  (Qr1.diff(d010,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
        ...
        (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
           ...
           pow(rh,4) + ((pow(-1 + rgrid[i],2)*
             ...
             ((-1 + rgrid[i])*
              ...
              (2.*pow(rh,4)))*Qtr(i,j,k)) + 
       4*(1 - rgrid[i])*(L2*R0*Qr2(i,j,k) + 
          2*L1*Qr1(i,j,k)*sqrt(1 + pow(R0,2)))))/pow(rh,2) + 
  (Qr2.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                   ...
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                     ...
                     4*pow(rh,2)*
                      (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
              (2.*pow(rh,4)))*Qtr(i,j,k)) + 
       4*(1 - rgrid[i])*(2*L1*R0*Qr1(i,j,k) + 
          L2*Qr2(i,j,k)*sqrt(1 + pow(R0,2)))))/pow(rh,2) + 
  h1.diff(d010,i,j,k)*(-8*h1(i,j,k)*(1 - pow(1 - rgrid[i],2))*
      pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     8*h1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr2(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     2*L1*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr1(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt1(i,j,k)) + (2*q*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
  ...
  h2.diff(d010,i,j,k)*(-8*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
      pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     8*h2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr2(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
     2*L1*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*Qr1(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt1(i,j,k)) + (2*q*h1(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (-4*pow(1 + pow(R0,2),0.25)*ar(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*
           (4*L2*a2(i,j,k)*Qr2(i,j,k) + 
...
+ Qtr(i,j,k)) + 4*L1*a1(i,j,k)*Qr1(i,j,k)*sqrt(1 + pow(R0,2)))))/
      pow(1 + pow(R0,2),0.25)) + 
  Qrr.diff(d010,i,j,k)*(-8*pow(1 - rgrid[i],2) - 
     (12*Qrr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*Qr2(i,j,k))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
   ...
   (L1*sqrt(1 + pow(R0,2))*pow(rh,2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (2*pow(Qt2.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (L1*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (2*pow(Qt1.diff(d001,i,j,k),2)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
   ...
   (pow(L2,2)*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*pow(a1.diff(d001,i,j,k),2)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     sqrt(1 + pow(R0,2))*(L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
   ...
   (pow(L2,2)*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*pow(a0.diff(d001,i,j,k),2)*L1*pow(1 - pow(1 - rgrid[i],2),4)*
   ...
   (pow(L2,2)*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*pow(H,2)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
       L2*(2*L1*L2*pow(q,2)*pow(rh,2)*pow(h1(i,j,k),2)*
           pow(ygrid[k],2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           Qr1(i,j,k) + 2*L1*L2*pow(q,2)*pow(rh,2)*
           pow(h2(i,j,k),2)*pow(ygrid[k],2)*
  ...
  (16*pow(a0.diff(d010,i,j,k),2)*pow(rh,2)*
   ...
   (L1*pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qt2.diff(d100,i,j,k)*((Qt2.diff(d010,i,j,k)*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  ar.diff(d010,i,j,k)*((4*a1.diff(d001,i,j,k)*
     ...
     (4*a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt1.diff(d100,i,j,k)*((L1*(1 - pow(1 - rgrid[i],2))*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
     ...
     (Qt2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (Qt1.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
        (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
  ...
  Qtr.diff(d010,i,j,k)*(((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     (2*Qt1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a1.diff(d100,i,j,k)*((2*a2.diff(d010,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0,2) + 
      ...
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (2*a0.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0,2) + 
  ...
  a2.diff(d010,i,j,k)*((4*ar.diff(d001,i,j,k)*
     ...
     (4*ar.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
      ...
      (L1*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (8*a1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
           (1 + pow(R0,2) + 
  ...
  H*(4*h2.diff(d100,i,j,k)*L1*L2*q*h1(i,j,k)*
     ...
     8*h1.diff(d001,i,j,k)*L1*L2*q*h2(i,j,k)*
      pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*ygrid[k]*
      Qr2(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     2*pow(L1,2)*L2*pow(q,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
      pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*ygrid[k]*
      Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      (-4*pow(1 + pow(R0,2),0.25)*a1(i,j,k) + 
        4*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
         Qt1(i,j,k)) - (2*a2.diff(d100,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     ...
     (4*ar.diff(d001,i,j,k)*L1*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (2*L1*L2*pow(q,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
     ...
     (4*ar.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
      ...
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (8*a2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
           (1 + pow(R0,2) + 
     ...
     (8*a1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
      ...
      (L2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (4*L1*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
           (1 + pow(R0,2) + 
      ...
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (2*a0.diff(d100,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],3)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
           (1 + pow(R0,2) + 
      ...
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (4*a0.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],4)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*Qt1(i,j,k)*
     ...
     (4*a0.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt1.diff(d010,i,j,k)*((L1*pow(1 - pow(1 - rgrid[i],2),2)*
        (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
  ...
  a0.diff(d010,i,j,k)*((-4*ar.diff(d001,i,j,k)*
                  ...
                  pow(rh,2)*
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                     ...
                     4*pow(rh,2)*
                      (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                Qt1(i,j,k)*(2*L2*(1 - pow(1 - rgrid[i],2))*
     ...
     (16*pow(rh,2)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d100,i,j,k)*((2*a2.diff(d010,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
           (1 + pow(R0,2) + 
     ...
     (8*a0.diff(d010,i,j,k)*pow(rh,2)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Q.diff(d010,i,j,k)*((-8*(1 - pow(1 - rgrid[i],2))*
  ...
  (L1*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*Qrr(i,j,k)*
     (pow(1 - pow(1 - rgrid[i],2),3)*
        ((pow(-1 + rgrid[i],2)*
             (3*pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],2) + 
               3*pow(H,2)*pow(-2 + rgrid[i],2)*pow(rgrid[i],3) + 
   ...
   (2.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (L1*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (128*pow(q,2)*pow(1 + pow(R0,2),0.25)*pow(a0(i,j,k),2)*
        (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
        pow(1 - pow(1 - rgrid[i],2),5)*pow(1 - rgrid[i],7)*
        Qt1(i,j,k)*(L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
       4*pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),2)*
        Qt1(i,j,k)*(2*(1 - rgrid[i])*
        ...
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
       32*pow(1 + pow(R0,2),0.25)*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i])*(4*pow(q,2)*pow(1 + pow(R0,2),0.25)*
           a1(i,j,k)*ar(i,j,k)*
           (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
           pow(1 - rgrid[i],2) + 
          (pow(-1 + rgrid[i],4)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
             Qt1(i,j,k)*Qtr(i,j,k))/(2.*pow(rh,6)) + 
                    ...
                    pow(rh,2)*
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                (2.*pow(rh,4)))*Qt1(i,j,k)*Qtr(i,j,k))/pow(rh,2))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
       32*pow(q,2)*a0(i,j,k)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],5)*
        (Qt1(i,j,k)*(4*L2*a2(i,j,k)*Qr2(i,j,k) + 
             4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
              pow(1 - rgrid[i],2)*Qtr(i,j,k)) + 
          4*a1(i,j,k)*(2*L1*Qr1(i,j,k)*Qt1(i,j,k) + 
             L2*Qr2(i,j,k)*Qt2(i,j,k))*sqrt(1 + pow(R0,2)))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
       4*pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),3)*
        (2*L2*Qr2(i,j,k)*(16*pow(q,2)*a1(i,j,k)*a2(i,j,k)*
              (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
              pow(1 - rgrid[i],3) + 
          ...
          32*pow(q,2)*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*a1(i,j,k)*
           (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
           pow(1 - rgrid[i],5)*Qtr(i,j,k) + 
          2*L1*Qr1(i,j,k)*(pow(rh,2)*
              (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                     (pow(H,2)*pow(-2 + rgrid[i],3)*
                       pow(rgrid[i],3) + 
                       pow(rh,2)*
             ...
             16*pow(q,2)*pow(a1(i,j,k),2)*
              (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
              pow(1 - rgrid[i],3)*sqrt(1 + pow(R0,2))))*
        sqrt(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
       32*pow(1 + pow(R0,2),0.25)*pow(rh,2)*(1 - rgrid[i])*
        ((2*pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
                   ...
                   (pow(mu,2)*pow(-2 + rgrid[i],3)*
                     ...
                     4*pow(rh,2)*
                      (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
              (2.*pow(rh,4))))*
        (L2*R0*Qr2(i,j,k)*sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
          L1*Qr1(i,j,k)*sqrt((1 + pow(R0,2))*
             (1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))))/
   (16.*pow(1 + pow(R0,2),0.25)*(1 - rgrid[i])*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qrr.diff(d100,i,j,k)*((6*Qrr.diff(d010,i,j,k)*
     ...
     (L1*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
      ...
      (4.*pow(rh,2)*sqrt(1 + 
          pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d010,i,j,k)*(-((L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*
          (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
- Qtr(i,j,k))*sqrt(1 + pow(R0,2) + 
  ...
  Qt1.diff(d001,i,j,k)*((L1*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (pow(rh,4)*(L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  B.diff(d010,i,j,k)*((-8*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
