...
elem[138]+=
((-4*a2.diff(d100,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2))/
    ...
    (8*H*L1*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
       ...
       (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (8*ar.diff(d001,i,j,k)*pow(1 - rgrid[i],3))/
     ((L2*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ (L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        ...
        pow(rh,2)) - (8*a1.diff(d001,i,j,k)*L1*
