...
- (1 - pow(1 - rgrid[i],2))*
  ...
  ((1 - rgrid[i])*Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   ...
   (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  B.diff(d100,i,j,k)*((8*Qrr.diff(d010,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
     ...
     ((1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*
      ...
      (2.*pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qrr.diff(d001,i,j,k)*((16*Qr2.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     (4*pow(1 - rgrid[i],2))/
      ((L1*L2*pow(-1 + rgrid[i],2)*
         ...
         (4.*pow(rh,2))) + (16*Q.diff(d001,i,j,k)*pow(rh,2)*
...
- Qtr(i,j,k)))/(4.*pow(rh,2)) + 
  ...
  pow(H,2)*((-16*pow(1 - pow(1 - rgrid[i],2),3)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        (2*pow(L2,2)*pow(q,2)*pow(rh,2)*pow(h1(i,j,k),2)*
           pow(ygrid[k],2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
          2*pow(L2,2)*pow(q,2)*pow(rh,2)*pow(h2(i,j,k),2)*
           pow(ygrid[k],2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))/
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
     ...
     (16*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
      ...
      ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Qtr.diff(d010,i,j,k)*((-2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
...
- (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
  ...
  Qr2.diff(d010,i,j,k)*((-16*Qrr.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(-1 + rgrid[i],2)*
        ...
        ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),
             ...
             sqrt(1 + pow(R0,2) + 
               ...
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
           (4.*pow(rh,2)) - 
          3*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)*
             ...
             (pow(1 - pow(1 - rgrid[i],2),2)*
                (3*pow(L1,2)*pow(Qr1(i,j,k),2)*
                  ...
                  4*L1*L2*Qr1(i,j,k)*Qr2(i,j,k)*Qt1(i,j,k)*
                   Qt2(i,j,k) + 
                  pow(L2,2)*pow(Qr2(i,j,k),2)*pow(Qt2(i,j,k),2)) \
- 2*(1 - pow(1 - rgrid[i],2))*
               ...
               4*pow(rh,2)*(1 - rgrid[i])*
                ...
                ((4*L1*L2*R0*Qr1(i,j,k)*Qr2(i,j,k))/
                   sqrt(1 + pow(R0,2) + 
                     ...
                     pow(1 - pow(1 - rgrid[i],2),2)*
                      pow(R(i,j,k),2)) + 
                  (3*pow(L1,2)*(1 + pow(R0,2))*pow(Qr1(i,j,k),2))/
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                       pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (2.*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  R.diff(d100,i,j,k)*(Qrr.diff(d010,i,j,k)*
      ((8*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(-1 + rgrid[i],2)*
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     a0.diff(d010,i,j,k)*((32*pow(rh,4)*
        ...
        (32*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)\
))) + Qtt.diff(d010,i,j,k)*((8*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qtt(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
+ (16*pow(rh,6)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ...
     Qtt.diff(d001,i,j,k)*((8*pow(rh,2)*
         ...
         (pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) + (8*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
           pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
              (1 + 2*pow(R0,2) + 
     ...
     (2*q*pow(rh,2)*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (-4*a2(i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 + 2*pow(R0,2) + 
             4*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             2*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
          8*a1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           sqrt(1 + pow(R0,2))*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
...
+ h1.diff(d100,i,j,k)*((-8*h1.diff(d001,i,j,k)*pow(rh,2)*
     ...
     (2*q*pow(rh,2)*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Q.diff(d100,i,j,k)*((-8*Qrr.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
     ...
     ((1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*
      ...
      (2.*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Q.diff(d001,i,j,k)*((-16*pow(rh,4)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
...
- (4*pow(rh,2)*(1 - rgrid[i])*
      ...
      (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
        ...
        pow(L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),3)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  R.diff(d001,i,j,k)*(Qr1.diff(d001,i,j,k)*
...
- L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) + (64*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),3)*
           pow(1 - rgrid[i],6)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                (1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
           ...
           (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
             ...
             2*L2*Qr2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
              sqrt(1 + pow(R0,2) + 
                ...
                pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) + 
          pow(1 + pow(R0,2),0.25)*
           (-8*ar(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
              sqrt(1 + pow(R0,2) + 
                2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
             pow(1 - pow(1 - rgrid[i],2),2)*
              (16*L1*pow(1 + pow(R0,2),0.25)*a1(i,j,k)*Qr1(i,j,k)*
                 (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
                4*a0(i,j,k)*pow(1 - rgrid[i],2)*
                 (2*L1*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
                    Qr1(i,j,k)*Qt2(i,j,k)*pow(R(i,j,k),2) + 
                   2*L1*pow(1 - pow(1 - rgrid[i],2),3)*Qr1(i,j,k)*
                    Qt2(i,j,k)*R(i,j,k)*(2*R0*B(i,j,k) + R(i,j,k)) + 
                   2*R0*Qtr(i,j,k)*
                    sqrt(1 + pow(R0,2) + 
                      2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                      pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
) + (1 - pow(1 - rgrid[i],2))*
                    (2*(-(L2*R0*Qr2(i,j,k)*Qt2(i,j,k)) + 
                         Qtr(i,j,k)*R(i,j,k))*
                       sqrt(1 + pow(R0,2) + 
                         2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                         pow(1 - pow(1 - rgrid[i],2),2)*
                      ...
                      L1*Qr1(i,j,k)*
                       ((1 + 2*pow(R0,2))*Qt2(i,j,k) - 
                         ...
                         pow(R(i,j,k),2)))) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*
                    (L1*(1 + 2*pow(R0,2))*B(i,j,k)*Qr1(i,j,k)*
                       Qt2(i,j,k) + 
                      2*R(i,j,k)*
...
+ (4*q*pow(rh,2)*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
      ...
      (pow(L1,2)*pow(1 + pow(R0,2),0.25)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  H*((-8*h2.diff(d100,i,j,k)*L2*q*pow(rh,2)*h1(i,j,k)*
...
+ (4*L2*pow(q,2)*pow(rh,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
      ...
      (L1*pow(1 + pow(R0,2),0.25)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  B.diff(d010,i,j,k)*((-16*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
...
- pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     ...
     (4*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        (8*(1 + pow(R0,2))*B(i,j,k)*(1 - rgrid[i])*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
      ...
      (pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),3)*
        ...
        sqrt((1 + pow(R0,2))*
          (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))) + 
  R.diff(d010,i,j,k)*((-16*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],2)*Q(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
+ (16*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
      ...
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     Qr1.diff(d010,i,j,k)*((16*pow(rh,2)*
           pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
+ (4*(1 + pow(R0,2))*(1 - rgrid[i]))/
             ...
             (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
               ...
               4*(1 - rgrid[i])*sqrt(1 + pow(R0,2))))/(4.*pow(rh,2)) \
+ pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (-(pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),5)*
                 (1 - rgrid[i])*pow(-1 + rgrid[i],4)*
                 pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                    pow(rgrid[i],3) + 
                   pow(rh,2)*
...
- pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
        pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5))) \
+ Q.diff(d010,i,j,k)*((16*Qrr.diff(d001,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
        Qr1(i,j,k))/
      (L1*L2*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
+ (16*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     ...
     R.diff(d010,i,j,k)*((32*pow(rh,2)*
         ...
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
           pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),
            1.5)) - (32*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
           pow(1 - rgrid[i],2)*Qr1(i,j,k)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
         (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(-1 + rgrid[i],2)*
             ...
             (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
                ...
                (pow(L1,2)*pow(rh,2)*
                  ...
                  4*pow(L1,2)*pow(rh,2)*(1 - rgrid[i])*
                   ...
                   pow(Qr1(i,j,k),2)*sqrt(1 + pow(R0,2))))/
              (4.*pow(rh,4))) + 
          2*pow(L1,2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
           (-((pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                  pow(-1 + rgrid[i],2)*
                  (pow(H,2)*pow(-2 + rgrid[i],3)*
...
+ (4*(1 + pow(R0,2))*(1 - rgrid[i]))/
                 sqrt((1 + pow(R0,2))*
                   (1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
))) - (pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),4)*(1 - rgrid[i])*
                pow(-1 + rgrid[i],4)*
                pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],3) + 
                  pow(rh,2)*
...
- (pow(rh,4)*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
   ...
   (2.*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) + 
  (pow(rh,2)*(-32*pow(L1,2)*L2*pow(rh,2)*
        pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*(1 - rgrid[i])*
        Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
       ...
       16*L2*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                   ...
                   (pow(H,2)*pow(-2 + rgrid[i],3)*
                     ...
                     pow(rh,2)*
                      (pow(mu,2)*pow(-2 + rgrid[i],3)*
                        ...
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                 (2.*pow(rh,4)))*Qr1(i,j,k) + 
             (L1*L2*pow(1 - pow(1 - rgrid[i],2),3)*Qr1(i,j,k)*
...
+ 4*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
   ...
   (16.*pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                    ...
                    pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                      ...
                      pow(rh,2)*
                       ...
                       pow(rgrid[i],3) + 
                        ...
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                        4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
                    ((8*L1*L2*R0*(1 - rgrid[i])*Qr1(i,j,k)*
                       Qr2(i,j,k))/
                       sqrt(1 + 
                        pow(R0 + 
                        (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) + 
                      ...
                      (4*pow(L1,2)*(1 + pow(R0,2))*
                       ...
                       sqrt((1 + pow(R0,2))*
                        ...
                        pow(R0 + 
                        (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
                      (4*pow(L2,2)*(1 + pow(R0,2))*(1 - rgrid[i])*
                        pow(Qr2(i,j,k),2))/
                       sqrt((1 + pow(R0,2))*
                        (1 + 
                        pow(R0 + 
...
+ L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
         ...
         (pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
     (2*pow(rh,2)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
...
- 16*pow(rh,2)*pow(1 - rgrid[i],3)*
   ...
   (2.*pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     pow(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2),1.5)) + 
  B.diff(d001,i,j,k)*((-16*pow(rh,2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
      (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
))/(2.*pow(rh,4)) + L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*Qr1(i,j,k)*
           (((-2*(1 - pow(1 - rgrid[i],2)) - 4*pow(1 - rgrid[i],2))*
                pow(-1 + rgrid[i],2)*
                (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                    ...
                    pow(rh,2)*
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                         4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
                  Qr1(i,j,k)*(4*L2*R0*(1 - rgrid[i])*Qr2(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),3)*
                     ((pow(-1 + rgrid[i],2)*
                        (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                        pow(rgrid[i],2) + 
