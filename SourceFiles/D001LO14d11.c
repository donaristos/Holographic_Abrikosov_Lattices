...
(4*Qtr.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
    ...
    2*Qt2.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],3)*(-(L2*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(Qr2(i,j,k),2)) - 
       (pow(1 - pow(1 - rgrid[i],2),3)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
    4*Qr2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
    ...
    (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     (-2*L1*pow(1 - pow(1 - rgrid[i],2),2)*
       ...
       (4*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
          Q(i,j,k)*Qr2(i,j,k)*Qtr(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
       (4*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
          Qr2(i,j,k)*Qtr(i,j,k)*Qtt(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
       ...
       (4*L2*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
          pow(Qr2(i,j,k),2)*Qt1(i,j,k)*R(i,j,k))/
        ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
