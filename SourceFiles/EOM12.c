...
elem[11]=
a1.diff(d100,i-1,j,k)-a1.diff(d100,i,j,k)
;
}
else if(k==0){
elem[11]=
a1(i,j,0)-a1(i,j,ygrid.TotalLength()-1)
;
}
else if(k==ygrid.TotalLength()-1){
elem[11]=
a1.diff(d001,i,j,ygrid.TotalLength()-1)-a1.diff(d001,i,j,0)
;
}
else{
{elem[11]=
a1.diff(d200,i,j,k) + a1.diff(d100,i,j,k)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
          ...
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4)))))) - 
  4*a1.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
   Qr1(i,j,k) - 8*a1.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*Qr1(i,j,k) - 
  4*a1.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
   Qr2(i,j,k) + 2*a1.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
  ...
  (2*a2.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))))*Qr2(i,j,k))/
   (L1*sqrt(1 + pow(R0,2))) - 
  (16*h2.diff(d010,i,j,k)*q*pow(rh,4)*h1(i,j,k)*pow(1 - rgrid[i],2)*
   ...
   (L1*pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (16*h1.diff(d010,i,j,k)*q*pow(rh,4)*h2(i,j,k)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (L1*pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
   ...
   (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
  (2*pow(rh,4)*(-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
   ...
   (pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
  (a0.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     (2*Qr1.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i]) + (-2*(1 - pow(1 - rgrid[i],2)) + 
          4*pow(1 - rgrid[i],2))*Qr1(i,j,k))*Qt1(i,j,k))/
   pow(1 + pow(R0,2),0.25) + 
  (8*a0.diff(d001,i,j,k)*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  ((Q.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     ...
     ((L1*(-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
       ...
       (2*a0.diff(d010,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(1 - rgrid[i],3)*Qr1(i,j,k)*Qt1(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
       (2*a0.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  ((2*Qr2.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
       (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
        Qr2(i,j,k))*((a2.diff(d010,i,j,k)*L2)/
        pow(1 + pow(R0,2),0.25) - 
  ...
  ((Qtt.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     ...
     ((a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25))/
       ...
       (a0.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*
        ...
        (2.*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  a1.diff(d011,i,j,k)*(8*pow(1 - pow(1 - rgrid[i],2),2)*
...
+ (2*ar.diff(d001,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (L2*(1 - pow(1 - rgrid[i],2))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
       (2*a2.diff(d010,i,j,k)*L1*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k))/
        (pow(1 + pow(R0,2),0.25)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
       (2*a1.diff(d001,i,j,k)*pow(L1,2)*pow(1 + pow(R0,2),0.25)*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k))/
...
- (2*a0.diff(d010,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
          Qr1(i,j,k)*Qt2(i,j,k))/
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) + 
       (a0.diff(d001,i,j,k)*L1*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - rgrid[i],2)*
          (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
             Qr1(i,j,k)*Qt1(i,j,k) - 
        ...
        (L2*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (R.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ((2*a2.diff(d100,i,j,k)*L1*
       ...
       (4*ar.diff(d001,i,j,k)*L1*
        ...
        (L2*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) \
- (4*a2.diff(d010,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
          Qr1(i,j,k)*Qr2(i,j,k))/
        (pow(1 + pow(R0,2),0.25)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
...
- (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       (4*a0.diff(d001,i,j,k)*pow(rh,2)*
        ...
        (pow(L2,2)*pow(-1 + rgrid[i],2)*
          ...
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
       (a0.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*
          ((-16*L1*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
               pow(1 - rgrid[i],2)*
               (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k))/
             (pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  (Qrr.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     (-((ar(i,j,k)*(-2*(1 - pow(1 - rgrid[i],2)) - 
          ...
          (pow(1 - pow(1 - rgrid[i],2),2)*
            (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))) + 
       (3*a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
       (2*a0.diff(d010,i,j,k)*pow(rh,2)*pow(1 - rgrid[i],2)*
        ...
        (pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (Qtt.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
...
- (a2.diff(d010,i,j,k)*((16*pow(rh,2)*pow(1 - rgrid[i],2)*
               (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
             (pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                 pow(rh,2)*
...
+ 4*(1 - rgrid[i])*(pow(L2,2)*
  ...
  (ar.diff(d010,i,j,k)*pow(rh,4)*
   ...
   (pow(L1,3)*pow(L2,2)*pow(1 + pow(R0,2),0.25)*
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (Q.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     (-((L1*(-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
            pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
            Qr1(i,j,k)*Qt1(i,j,k))/
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
       ...
       (4*a0.diff(d010,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],2)*Qt1(i,j,k)*
          (4*pow(1 - rgrid[i],2)*
             (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
             (1 + pow(R0,2) + 
...
+ 4*(1 - rgrid[i])*(pow(L2,2)*
       ...
       (16*a2.diff(d001,i,j,k)*pow(rh,2)*
        ...
        (L2*pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],2)*
          ...
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  a1.diff(d020,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2)*pow(Qr1(i,j,k),2) + 
     (16*pow(rh,2)*pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  a1.diff(d002,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2) + 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  (a0.diff(d010,i,j,k)*Qt2.diff(d001,i,j,k)*L2*
...
+ (L1*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
       ...
       (ar.diff(d010,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        ...
        (2.*L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (2*Qr2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     ((4*a2.diff(d001,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       ...
       (a2.diff(d010,i,j,k)*L2*
        ...
        (L1*pow(1 + pow(R0,2),0.25)*
          ...
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
       ((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
          (1 - rgrid[i])*(L2*(1 - pow(1 - rgrid[i],2))*Qt2(i,j,k)*
             (1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
            (L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
               (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
               sqrt(1 + pow(R0,2) + 
                 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                 pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
             (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))))/2. - 
       (a0.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
          (2*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
             (1 - rgrid[i])*Qr2(i,j,k)*Qt2(i,j,k)*
          ...
          (2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
            ...
            2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
             ...
             sqrt(1 + pow(R0,2) + 
               ...
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
        (L2*pow(1 + pow(R0,2),0.25)) + 
       (a1.diff(d001,i,j,k)*pow(L1,2)*pow(1 + pow(R0,2),0.25)*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             (1 + pow(R0,2) + 
          ...
          (1 - rgrid[i])*(L1*L2*
            ...
            L1*L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
        (2.*pow(L2,2)) - (a0.diff(d001,i,j,k)*L1*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - rgrid[i],2)*
          (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
            ...
            2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
        pow(L2,2) + (a0.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*
          (2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
             (L1*L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k) + 
               L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                (1 - pow(1 - rgrid[i],2))*Qt2(i,j,k)*
...
- 2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k)*
                ...
                sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))\
)/pow(L2,2) - (a1.diff(d100,i,j,k)*pow(L1,2)*
          pow(1 + pow(R0,2),0.25)*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/L2 \
+ (2*ar.diff(d010,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
        (L2*(1 - pow(1 - rgrid[i],2)))))/(L1*pow(1 + pow(R0,2),0.25)) \
+ ((B.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     ...
     (-((a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
       ...
       (a2.diff(d100,i,j,k)*L1*
        ...
        (pow(1 + pow(R0,2),0.25)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
       (2*ar.diff(d001,i,j,k)*L1*(1 - rgrid[i])*
          (R0 + pow(R0,3) + 
            (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            3*R0*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2) + 
            pow(1 - pow(1 - rgrid[i],2),3)*pow(R(i,j,k),3)))/
  ...
  (Qrr.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ((a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
       (2*ar.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*Qr2(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
       a0.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*
        (-(((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
               (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     ...
     (-(a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
       ...
       (ar.diff(d010,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        ...
        (2.*L1*L2*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
       (a2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
          ((pow(L1,2)*pow(1 + 
                 B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
               pow(1 - pow(1 - rgrid[i],2),2)*
       ...
       (a2.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          ...
          (2*L2*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
            ...
            2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))\
))/(4.*L2*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
       (ar.diff(d001,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
...
+ (L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
   ...
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (Qt1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
        ...
        (-4*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
          ...
          (16*pow(rh,2)*pow(1 - rgrid[i],2)*
           ...
           (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             ...
             (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))))/
   pow(1 + pow(R0,2),0.25) + 
  (H*(L1*L2*(2*Qr2.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
           (1 - rgrid[i]) + (-2*(1 - pow(1 - rgrid[i],2)) + 
             4*pow(1 - rgrid[i],2))*Qr2(i,j,k)) - 
       (L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
          (Qrr.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
            2*(1 - rgrid[i])*Qrr(i,j,k)))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
       (2*L1*L2*pow(rh,4)*(2*(1 - pow(1 - rgrid[i],2))*
             (1 - rgrid[i])*((pow(-1 + rgrid[i],2)*
                  (pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],3) + 
                    pow(rh,2)*
            ...
            (8*pow(q,2)*(pow(h1(i,j,k),2)*
                  pow(1 - pow(1 - rgrid[i],2),2) + 
                 pow(h2(i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2))*
               pow(1 - rgrid[i],3)*ygrid[k]*
               (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
             pow(1 - pow(1 - rgrid[i],2),2)))/
        ((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          ...
          (-4*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
            ...
            (16*pow(rh,2)*pow(1 - rgrid[i],2)*
             ...
             (pow(-1 + rgrid[i],2)*
               ...
               (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
        (2.*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
       (4*R.diff(d010,i,j,k)*pow(L1,2)*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
          pow(Qr1(i,j,k),2))/
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) - 
       (4*R.diff(d001,i,j,k)*pow(L1,2)*
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
          Qr1(i,j,k)*Qr2(i,j,k))/
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) + 
       ...
       (L1*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        ...
        (4.*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
       2*Qr2.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i])*(2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
           Qr2(i,j,k)*(2 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
          2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
...
+ (2*Qr2.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       ...
       (L1*(B.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
          ...
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) + 
       (2*B.diff(d010,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
          (1 - rgrid[i])*Qr1(i,j,k)*
          (2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
       ...
       Qrr.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
        ((2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
             pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2))/
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
          (8*L1*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             pow(1 - rgrid[i],2)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))\
       ...
       2*Qr1.diff(d010,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i])*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        (2*L2*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k) + 
          ...
          2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
           sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
       (Qtt.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
          (-4*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
             pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2) - 
            (16*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
               pow(1 - rgrid[i],2)*
                 ...
                 pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                    ...
                    4*pow(rh,2)*
                     (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                       4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
               (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
        (2.*L2*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
       ...
       (a1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
          ...
          (2*L2*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
            ...
            2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))\
))/(4.*pow(L2,2)*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) \
+ ((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
+ ((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
   ...
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (Q.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     (-((L1*(-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
            pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
            Qr2(i,j,k)*Qt1(i,j,k))/
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
     ...
     ((2*a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
       ...
       (4*ar.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*Qr1(i,j,k)*
          (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
       (2*a2.diff(d100,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
          (1 - rgrid[i])*Qr1(i,j,k)*
          (R0 + pow(R0,3) + 
            (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            3*R0*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2) + 
        ...
        (pow(1 + pow(R0,2),0.25)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
       (4*ar.diff(d001,i,j,k)*L1*pow(1 - rgrid[i],2)*Qr1(i,j,k)*
          (R0 + pow(R0,3) + 
            (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            3*R0*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2) + 
            pow(1 - pow(1 - rgrid[i],2),3)*pow(R(i,j,k),3)))/
...
+ 4*(1 - rgrid[i])*(pow(L2,2)*
       ...
       (2*a0.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          ...
          (2*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             ...
             Qr1(i,j,k)*Qt2(i,j,k)*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
            L2*(2*L2*pow(1 - pow(1 - rgrid[i],2),2)*
                (1 - rgrid[i])*Qr2(i,j,k)*Qt2(i,j,k) - 
               2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k))*
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
...
+ (L1*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
           ...
           (pow(L2,2)*pow(-1 + rgrid[i],2)*
             ...
             (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))))/
   (L1*pow(1 + pow(R0,2),0.25)) + 
  (B.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     ((2*a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
          (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
          (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
       ...
       (2*a2.diff(d100,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
        ...
        (pow(1 + pow(R0,2),0.25)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
       (4*ar.diff(d001,i,j,k)*L1*pow(1 - rgrid[i],2)*Qr2(i,j,k)*
          (R0 + pow(R0,3) + 
            (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            3*R0*pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2) + 
            pow(1 - pow(1 - rgrid[i],2),3)*pow(R(i,j,k),3)))/
