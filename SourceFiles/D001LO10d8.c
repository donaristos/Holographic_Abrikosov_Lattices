...
(4*Qr1.diff(d100,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    2*L1*(1 - pow(1 - rgrid[i],2))*
     ...
     (2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*Qr1(i,j,k)*
     Qr2(i,j,k) + (8*L1*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
...
)/L2 + (4*Qr1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
...
- 2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k)*Qr2(i,j,k)*
          (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))/L2 + 
...
+ 2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k)*Qr2(i,j,k)*
    ...
    (16*Q.diff(d010,i,j,k)*pow(rh,4)*
     ...
     (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       pow(rh + rh*(1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (16*Qr2.diff(d010,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
