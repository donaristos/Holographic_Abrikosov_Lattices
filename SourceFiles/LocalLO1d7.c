...
elem[6]+=
-4*Qtt.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*Qtt.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*Qtt.diff(d002,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) - 
  (8*Qtt.diff(d001,i,j,k)*Qtt.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) - 
  (8*pow(Qtt.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  Qtt.diff(d001,i,j,k)*(-16*pow(1 - rgrid[i],2) + 
     (8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qtt(i,j,k))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  a2.diff(d100,i,j,k)*((-2*a1.diff(d001,i,j,k)*
     ...
     (2*a0.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (L1*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qt2.diff(d100,i,j,k)*((Qt1.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        pow(-1 + rgrid[i],2)*
  ...
  a1.diff(d100,i,j,k)*((-2*a2.diff(d010,i,j,k)*L2*
     ...
     (2*a1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) - 
  (4*pow(H,2)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (4*pow(a2.diff(d010,i,j,k),2)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     (L2*Qr2(i,j,k)*(1 + pow(R0,2) + 
          2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) + 
   ...
   (pow(L1,2)*sqrt(1 + pow(R0,2))*pow(rh,2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (2*pow(Qt1.diff(d001,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (L2*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (2*pow(Qt2.diff(d010,i,j,k),2)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  a1.diff(d001,i,j,k)*((4*ar.diff(d001,i,j,k)*
     ...
     (4*pow(1 + pow(R0,2),0.25)*a0(i,j,k)*
      ...
      (pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  H*((2*a2.diff(d100,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
        (1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
      (pow(1 + pow(R0,2),0.25)*pow(rh,2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
     ...
     (4*ar.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
      ...
      (L1*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
     (8*a2.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (L2*Qr2(i,j,k)*(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
  ...
  (L2*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
   ...
   ((1 - pow(1 - rgrid[i],2))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  Qtt.diff(d100,i,j,k)*((4*Qtt.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
