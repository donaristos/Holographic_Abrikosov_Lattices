...
elem[203]+=
((2*Qr1.diff(d100,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
       sqrt(1 + pow(R0,2)))/L2 - 
    ...
    (2*Qrr.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
    ...
    (2*Qtt.diff(d001,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(-(pow(1 - pow(1 - rgrid[i],2),2)*
            Qr1(i,j,k)*Qr2(i,j,k)) + 
    ...
    (4*R.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       sqrt(1 + pow(R0,2))*(L2*Qr2(i,j,k)*
         ...
         L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
          sqrt(1 + pow(R0,2) + 
            2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
     pow(L2,2) + (8*Qtt.diff(d010,i,j,k)*pow(rh,2)*
    ...
    (4*B.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     (L2*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)) + 
    (2*Qrr.diff(d010,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*sqrt(1 + pow(R0,2))*
