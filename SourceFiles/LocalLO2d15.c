...
elem[30]+=
4*h1.diff(d100,i,j,k)*(1 - rgrid[i])*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  (8*h1(i,j,k)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
   (1 - pow(1 - rgrid[i],2)) - 
  8*h1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
   Qr1(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  8*h1.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
   Qr2(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  H*(4*h2.diff(d100,i,j,k)*L1*L2*q*pow(1 - pow(1 - rgrid[i],2),2)*
      (1 - rgrid[i])*ygrid[k]*Qr1(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
     8*h2.diff(d010,i,j,k)*L1*L2*q*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*ygrid[k]*pow(Qr1(i,j,k),2)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
     8*h2.diff(d001,i,j,k)*L1*L2*q*pow(1 - pow(1 - rgrid[i],2),3)*
      pow(1 - rgrid[i],2)*ygrid[k]*Qr1(i,j,k)*Qr2(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
     8*L1*L2*pow(q,2)*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      (1 - rgrid[i])*ygrid[k]*Qr1(i,j,k)*
      (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
      ((2*ar(i,j,k)*(1 - rgrid[i]))/(1 - pow(1 - rgrid[i],2)) - 
        ...
        2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
         ((1 - pow(1 - rgrid[i],2))*
           ...
           Qtr(i,j,k)))) + 2*h2.diff(d100,i,j,k)*q*
...
) + 4*h2.diff(d010,i,j,k)*q*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   ((-2*ar(i,j,k)*(1 - rgrid[i]))/(1 - pow(1 - rgrid[i],2)) + 
     ...
     2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
      (-((1 - pow(1 - rgrid[i],2))*
           (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))) + 
        Qtr(i,j,k))) + 4*h2.diff(d001,i,j,k)*q*
   ...
   ((-2*ar(i,j,k)*(1 - rgrid[i]))/(1 - pow(1 - rgrid[i],2)) + 
     ...
     2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
      (-((1 - pow(1 - rgrid[i],2))*
           (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))) + 
        Qtr(i,j,k))) + (2*pow(rh,4)*h1(i,j,k)*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (-16*sqrt(1 + pow(R0,2)) - 
