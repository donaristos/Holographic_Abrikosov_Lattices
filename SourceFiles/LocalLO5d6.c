...
elem[69]+=
-4*R.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  8*R.diff(d020,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr1(i,j,k) + 
  8*R.diff(d011,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (4*B.diff(d010,i,j,k)*B.diff(d100,i,j,k)*
     ...
     (R0 + pow(R0,3) + (1 + 3*pow(R0,2))*(1 - pow(1 - rgrid[i],2))*
        ...
        pow(R(i,j,k),3)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
  R.diff(d010,i,j,k)*(-16*pow(1 - rgrid[i],2) - 
  ...
  Qt2.diff(d001,i,j,k)*(-(pow(L1,2)*
         ...
         sqrt(1 + pow(R0,2) + 
           ...
           pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
      (2.*pow(rh,2)) - (2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
  ...
  (L1*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*R(i,j,k)*
  ...
  (Qr2.diff(d010,i,j,k)*pow(L2,2)*(1 - pow(1 - rgrid[i],2))*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  (Qt1.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (4*pow(a2.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(L1*
   ...
   (L1*sqrt(1 + pow(R0,2))*pow(rh,2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (pow(Qt2.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  (pow(Qt1.diff(d001,i,j,k),2)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
  ...
  (4*pow(a0.diff(d001,i,j,k),2)*L1*pow(1 - pow(1 - rgrid[i],2),4)*
     ...
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (pow(L2,2)*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
  (4*pow(a0.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  Qtr.diff(d001,i,j,k)*((pow(L1,2)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*L2*pow(rh,2)) + (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
        ...
        ((1 - pow(1 - rgrid[i],2))*
          ...
          Qtr(i,j,k))*sqrt(1 + 
          pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*L2*pow(rh,2))) + a2.diff(d100,i,j,k)*
  ...
  Qt2.diff(d100,i,j,k)*(-(Qt2.diff(d010,i,j,k)*
     ...
     (Qt1.diff(d001,i,j,k)*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qr1.diff(d010,i,j,k)*((4*Qrr.diff(d001,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
           ...
           pow(1 - pow(1 - rgrid[i],2),3)*
            ((pow(-1 + rgrid[i],2)*
              ...
              ((-1 + rgrid[i])*
               ...
               (2.*pow(rh,4)))*Qt1(i,j,k)*Qt2(i,j,k))*
         sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*pow(rh,2)) - (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
        ...
        (pow(1 - pow(1 - rgrid[i],2),3)*
          ...
          4*(1 - rgrid[i])*(L1*R0*Qr1(i,j,k) + 
             L2*Qr2(i,j,k)*sqrt(1 + pow(R0,2))))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*pow(rh,2))) + Qrr.diff(d001,i,j,k)*
   (-((L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*pow(rh,2)*(L2 + L2*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
  ...
  a1.diff(d100,i,j,k)*((-2*a2.diff(d010,i,j,k)*
     ...
     (2*a0.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qt2.diff(d010,i,j,k)*(-((Qtr.diff(d010,i,j,k)*
          pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
...
+ Qt1.diff(d001,i,j,k)*(-((L1*(1 - pow(1 - rgrid[i],2))*
     ...
     (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        ((1 - pow(1 - rgrid[i],2))*
          ...
          Qtr(i,j,k))*sqrt(1 + 
          pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (2.*L2*pow(rh,2)) - (Qtr.diff(d001,i,j,k)*L1*
        (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
+ (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (2*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  H*((-2*a1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
        pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
        (1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
      (pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  ...
  a0.diff(d010,i,j,k)*((4*ar.diff(d001,i,j,k)*
     ...
     (4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],4)*
        Qt2(i,j,k)*((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           Qt2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
          Qt1(i,j,k)*sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))*
     ...
     (4*a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
        pow(1 - rgrid[i],6)*(L1*
           (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           (1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*Qt1(i,j,k)*Qt2(i,j,k)*
           (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
           (L1*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k)*Qt1(i,j,k) - 
             Qtr(i,j,k))*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
          Qt1(i,j,k)*(2*L2*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
              Qt2(i,j,k) - Qtr(i,j,k))*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))*
