...
elem[10]=
a0.diff(d100,i-1,j,k)-a0.diff(d100,i,j,k)
;
}
else if(k==0){
elem[10]=
a0(i,j,0)-a0(i,j,ygrid.TotalLength()-1)
;
}
else if(k==ygrid.TotalLength()-1){
elem[10]=
a0.diff(d001,i,j,ygrid.TotalLength()-1)-a0.diff(d001,i,j,0)
;
}
else{
{elem[10]=
(-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))/
   (2.*pow(1 - rgrid[i],2)) + 
  (8*a0(i,j,k) + 2*(-8*a0.diff(d100,i,j,k) + 
        2*a0.diff(d200,i,j,k)*(1 - rgrid[i]))*(1 - rgrid[i]))/
   (4.*pow(1 - rgrid[i],2)) - 
  2*a0.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k) - 
  2*(-4*a0.diff(d010,i,j,k) + 2*a0.diff(d110,i,j,k)*(1 - rgrid[i]))*
   (1 - pow(1 - rgrid[i],2))*Qr1(i,j,k) + 
  4*a0.diff(d001,i,j,k)*Qr2.diff(d010,i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*Qr1(i,j,k) - 
  a0.diff(d010,i,j,k)*(2*Qr1.diff(d100,i,j,k)*
      (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
     (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*Qr1(i,j,k)) \
- 2*a0.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k) - 
  2*(-4*a0.diff(d001,i,j,k) + 2*a0.diff(d101,i,j,k)*(1 - rgrid[i]))*
   (1 - pow(1 - rgrid[i],2))*Qr2(i,j,k) + 
  4*a0.diff(d010,i,j,k)*Qr1.diff(d001,i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*Qr2(i,j,k) - 
  a0.diff(d001,i,j,k)*(2*Qr2.diff(d100,i,j,k)*
      (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
...
+ (2*Qr1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     (-((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
       ...
       2*a0.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],3)*Qr2(i,j,k)))/(1 - rgrid[i]) + 
  ...
  ((Q.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
       2*(1 - rgrid[i])*Q(i,j,k))*
     (((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
          (1 - rgrid[i]))/(2.*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) \
- (2*a0.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],3)*Qr1(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
       (2*a0.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],3)*Qr2(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))/pow(1 - rgrid[i],2) + 
  ...
  ((Qrr.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     ...
     (-((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
       ...
       (a0.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],3)*Qr2(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))))/pow(1 - rgrid[i],2) \
+ ((Qtt.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     ...
     (-((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
       ...
       (a0.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],3)*Qr2(i,j,k))/
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))))/pow(1 - rgrid[i],2) \
+ a0.diff(d011,i,j,k)*(8*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (R.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
   ...
   pow(1 - rgrid[i],2) + (R.diff(d001,i,j,k)*
     (1 - pow(1 - rgrid[i],2))*
     ((-16*a0.diff(d010,i,j,k)*pow(rh,2)*pow(1 - rgrid[i],4)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
        (L1*L2*pow(-1 + rgrid[i],2)*
       ...
       (16*a0.diff(d001,i,j,k)*pow(rh,2)*
        ...
        (pow(L2,2)*pow(-1 + rgrid[i],2)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   pow(1 - rgrid[i],2) + (Qtt.diff(d010,i,j,k)*
     (1 - pow(1 - rgrid[i],2))*
     (((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qr1(i,j,k))/
       ...
       (2*a0.diff(d010,i,j,k)*pow(rh,2)*pow(1 - rgrid[i],2)*
        ...
        (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   pow(1 - rgrid[i],2) + (16*a0.diff(d001,i,j,k)*B.diff(d001,i,j,k)*
     pow(rh,2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   (pow(L2,2)*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  a0.diff(d020,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  a0.diff(d002,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (L1*(Qt1.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
     ...
     (-(a2.diff(d100,i,j,k)*pow(-1 + rgrid[i],2)*
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                 pow(rgrid[i],3) + 
                4*pow(rh,2)*
       ...
       (ar.diff(d001,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
        (2.*L1*L2*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
       (a2.diff(d010,i,j,k)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               4*pow(rh,2)*
       ...
       (ar.diff(d010,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        ...
        (2.*pow(L1,2)*pow(rh,4)*
          ...
          (1 - pow(1 - rgrid[i],2))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   pow(1 - rgrid[i],2) + (2*Qtr.diff(d010,i,j,k)*
     (1 - pow(1 - rgrid[i],2))*
     ((a2.diff(d100,i,j,k)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (Qrr.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
   ...
   pow(1 - rgrid[i],2) + (Qrr.diff(d001,i,j,k)*
     (1 - pow(1 - rgrid[i],2))*
     (((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qr2(i,j,k))/
        (2.*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) + 
                 ...
                 pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                    ...
                    4*pow(rh,2)*
                     (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                       4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
               (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/2.))/
   pow(1 - rgrid[i],2) + (Qt1.diff(d001,i,j,k)*L1*
     (1 - pow(1 - rgrid[i],2))*
     (-(a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
           pow(-1 + rgrid[i],2)*
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       ...
       (a2.diff(d100,i,j,k)*pow(-1 + rgrid[i],2)*
          ...
          (2*L2*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
            ...
            2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))\
))/(4.*L1*L2*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
       (ar.diff(d001,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
          ...
          (2*L2*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
            ...
            2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))\
)/(2.*L1*pow(L2,2)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   pow(1 - rgrid[i],2) + (Qt2.diff(d010,i,j,k)*L2*
     (1 - pow(1 - rgrid[i],2))*
     ((a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
...
- L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       ...
       (ar.diff(d001,i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   pow(1 - rgrid[i],2) + (H*(-(Qtr.diff(d010,i,j,k)*
           (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
           pow(-1 + rgrid[i],2)*
           (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
   ...
   pow(1 - rgrid[i],2) + (Qtt.diff(d001,i,j,k)*
     (1 - pow(1 - rgrid[i],2))*
     (((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qr2(i,j,k))/
        (2.*(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
...
+ ((-4*a0(i,j,k) + 2*a0.diff(d100,i,j,k)*(1 - rgrid[i]))*(1 - rgrid[i])*
          ...
          (L1*L2*R0*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k) + 
            L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*Qt1(i,j,k)*
             ...
             (1 - pow(1 - rgrid[i],2))*Qt2(i,j,k)*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))\
)/(8.*L1*pow(L2,2)*pow(rh,4)*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   pow(1 - rgrid[i],2) + (2*Qtr.diff(d001,i,j,k)*
     (1 - pow(1 - rgrid[i],2))*
     ((a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
