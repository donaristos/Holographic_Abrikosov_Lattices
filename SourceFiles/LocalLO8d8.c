...
+ (4*Q.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*Qr1(i,j,k)*Qtr(i,j,k))/(2.*pow(rh,2)) + 
  (8*Qrr.diff(d010,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     (1 - rgrid[i])*Qr1(i,j,k)*
     (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (4*Qtt.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  (32*a0.diff(d001,i,j,k)*pow(rh,2)*a0(i,j,k)*
  ...
  a0.diff(d010,i,j,k)*((16*pow(rh,2)*a0(i,j,k)*
     ...
     (64*a0.diff(d001,i,j,k)*pow(rh,4)*
      ...
      (L1*L2*pow(-1 + rgrid[i],4)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))) + 
  (2*Qr2.diff(d010,i,j,k)*L2*(1 - rgrid[i])*
          ...
          pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*
                (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
          Qr1(i,j,k)*Qt2(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,6)) - 
...
- Qtr(i,j,k)))/(4.*pow(rh,2)) + 
  ...
  (64*pow(a0.diff(d001,i,j,k),2)*pow(rh,4)*
   ...
   (pow(L2,2)*pow(-1 + rgrid[i],4)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  (2*B.diff(d010,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
  ...
  (2*Q.diff(d010,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
