...
elem[188]+=
((2*Qr2.diff(d100,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]))/
     (L1*sqrt(1 + pow(R0,2))) - 
    ...
    (2*Qrr.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
                 ...
                 pow(rh,2)*
                  (pow(mu,2)*pow(-2 + rgrid[i],3)*
                    ...
                    4*pow(rh,2)*
                     (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                       4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
               Q(i,j,k))/(4.*pow(rh,2)))))/(L1*sqrt(1 + pow(R0,2))) + 
    (2*Qtt.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(-(pow(1 - pow(1 - rgrid[i],2),2)*
            Qr1(i,j,k)*Qr2(i,j,k)) + 
...
+ (4*B.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     (sqrt(1 + pow(R0,2))*(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)))) \
+ (2*Qrr.diff(d001,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*((pow(1 - pow(1 - rgrid[i],2),2)*
            pow(Qr2(i,j,k),2))/
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
         (4*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          (pow(L2,2)*pow(-1 + rgrid[i],2)*
            ...
            (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
     (L1*sqrt(1 + pow(R0,2))) - 
    (2*Qtt.diff(d001,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(pow(1 - pow(1 - rgrid[i],2),2)*
          pow(Qr2(i,j,k),2) + 
         (4*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
            (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
    ...
    ((2*L2*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
       ...
       (2*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))/
     (2.*sqrt(1 + pow(R0,2))))*D[-1 + d010](i,j,k,i1,j1,k1)
;
