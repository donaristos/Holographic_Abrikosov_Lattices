...
((-2*a2.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    (2*a1.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (16*a2.diff(d001,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
    ...
    (16*a1.diff(d010,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
    ...
    (pow(1 + pow(R0,2),0.25)*(1 - rgrid[i])*
              ...
              4*(1 - rgrid[i])*
               (pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
                 ...
                 pow(L1,2)*(-(pow(1 - pow(1 - rgrid[i],2),2)*
                    ...
                    sqrt(1 + pow(R0,2))))))/
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
         4*pow(L1,2)*L2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
          (1 - rgrid[i])*Qr2(i,j,k)*
     ...
     (L2*pow(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
       (1 - pow(1 - rgrid[i],2))))*D[-1 + d001](i,j,k,i1,j1,k1)
;
