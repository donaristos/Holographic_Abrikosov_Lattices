...
elem[57]+=
-(B.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
...
))/(4.*pow(rh,2)) - (B(i,j,k)*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (4*pow(a0.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],6)*(-(L2*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
          Qt2(i,j,k)) + Qtr(i,j,k)))/
   (pow(L1,2)*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  H*((4*a0.diff(d001,i,j,k)*L1*
        pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
  ...
  a0.diff(d001,i,j,k)*((4*ar.diff(d001,i,j,k)*
     ...
     (4*a0(i,j,k)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d100,i,j,k)*((-2*a0.diff(d010,i,j,k)*
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (Qr1.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (Qtr.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
   ...
   (2.*L1*pow(rh,2)*sqrt(1 + 
       pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (Qrr.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
