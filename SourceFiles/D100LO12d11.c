...
elem[186]+=
((4*Qt1.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
       pow(1 - rgrid[i],3)*Qr1(i,j,k))/pow(1 + pow(R0,2),0.25) + 
    (4*Q.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    (4*Qtt.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
       pow(1 - rgrid[i],2)*Qt1(i,j,k))/
     (pow(1 + pow(R0,2),0.25)*
       (4 + 4*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (8*Qtt.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
       pow(1 - rgrid[i],3)*Qr1(i,j,k)*Qt1(i,j,k))/
     (pow(1 + pow(R0,2),0.25)*
       (4 + 4*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (8*Qtt.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (pow(1 + pow(R0,2),0.25)*
       (4 + 4*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (R.diff(d100,i,j,k)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
    ...
    (2*B.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     (pow(1 + pow(R0,2),0.25)*
       (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))) + 
    (pow(1 - rgrid[i],2)*((-4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
            ((pow(-1 + rgrid[i],2)*
