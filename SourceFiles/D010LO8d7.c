...
elem[118]+=
((8*Qt2.diff(d001,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
       pow(1 - rgrid[i],2)*Qr2(i,j,k))/L1 + 
    ...
    (2*Qt2.diff(d100,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       (1 - rgrid[i])*(1 + pow(R0,2) + 
         2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
         pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/L1 + 
    (2*Qt1.diff(d100,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
    ...
    (4*Qtr.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
     ...
     (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (2*L2*(1 - rgrid[i])*((-4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
            ((pow(-1 + rgrid[i],2)*
