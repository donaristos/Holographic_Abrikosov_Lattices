...
4*Qr1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2)) + 
  ...
  (4*Q(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (4*Q.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (4*Q.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (Qrr.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2)))/
   ((1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))) - 
  (2*Qrr.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  (2*Qrr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  (2*Qrr(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  ...
  (2*Qtt.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) - 
  (2*Qtt.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*Qr2(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  (2*Qtt(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
