...
elem[6]=
Qr2(i,j,k)-Qr2(i+1,j,k)
;
}
else if(rgrid.IsLeftBoundary(i)){
elem[6]=
Qr2.diff(d100,i-1,j,k)-Qr2.diff(d100,i,j,k)
;
}
else if(k==0){
elem[6]=
Qr2(i,j,0)-Qr2(i,j,ygrid.TotalLength()-1)
;
}
else if(k==ygrid.TotalLength()-1){
elem[6]=
Qr2.diff(d001,i,j,ygrid.TotalLength()-1)-Qr2.diff(d001,i,j,0)
;
}
else{
{elem[6]=
Qr2.diff(d200,i,j,k) + (Qr2.diff(d100,i,j,k)*
     (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2)))/
   ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) - 
  2*(Qr2.diff(d010,i,j,k)*(-2*(1 - pow(1 - rgrid[i],2)) + 
        4*pow(1 - rgrid[i],2)) + 
     2*Qr2.diff(d110,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]))*
   Qr1(i,j,k) - 2*(Qr2.diff(d001,i,j,k)*
      (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2)) + 
     2*Qr2.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]))*
   Qr2(i,j,k) - (6*Qr2(i,j,k))/(1 - pow(1 - rgrid[i],2)) + 
  (16*a2.diff(d010,i,j,k)*ar.diff(d010,i,j,k)*pow(1 - rgrid[i],2)*
  ...
  (a0.diff(d001,i,j,k)*(1 - rgrid[i])*
     ((-16*a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) + 
       (32*ar.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(1 - rgrid[i],3)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k))/
        (L1*pow(L2,2)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
  ...
  (4*pow(Qt2.diff(d010,i,j,k),2)*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (pow(L2,2)*pow(rh,2)*pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),
      2)) - (8*pow(Qrr.diff(d010,i,j,k),2)*pow(rh,2)*
...
- (1 - pow(1 - rgrid[i],2))*
   ...
   (4.*L1*L2*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  Qr2.diff(d011,i,j,k)*(8*pow(1 - pow(1 - rgrid[i],2),2)*
  ...
  (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
   ...
   (16.*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)) + 
  (Qr1.diff(d010,i,j,k)*((L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  (Qr2.diff(d010,i,j,k)*pow(rh,4)*
     (-8*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
        ...
        Qr1(i,j,k) - (L1*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),3)*
...
- 16*L2*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
             ...
             (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
               ...
               2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k))*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) + 
            16*L1*pow(L2,2)*pow(rh,2)*
             pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
             (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*Qr1(i,j,k)*
             Qr2(i,j,k)*(2*L1*R0*(1 - pow(1 - rgrid[i],2))*
                (1 - rgrid[i])*Qr1(i,j,k) + 
               2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                Qr2(i,j,k)*sqrt(1 + pow(R0,2)))))/(16.*pow(rh,8)) + 
       (pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
             ...
             (-2*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
               ...
               (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                ...
                (2*L1*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                   Qr1(i,j,k) + 
                  2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                   Qr2(i,j,k)*sqrt(1 + pow(R0,2))))))/(4.*pow(rh,4))))/
  ...
  (64*pow(a0.diff(d001,i,j,k),2)*pow(rh,4)*
     pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],6)*Qr2(i,j,k)*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     ...
     ((16*a2.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       (64*a0.diff(d001,i,j,k)*pow(rh,4)*
        ...
        (pow(L1,2)*pow(L2,2)*pow(-1 + rgrid[i],4)*
          ...
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (4.*(1 - pow(1 - rgrid[i],2))) + 
  (Qtt.diff(d010,i,j,k)*((8*pow(rh,6)*
          (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                 (pow(H,2)*pow(-2 + rgrid[i],3)*
                    pow(rgrid[i],3) + 
                   pow(rh,2)*
          ...
          ((L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
            ...
            4*pow(1 - rgrid[i],2)*
             ((1 - pow(1 - rgrid[i],2))*Qrr(i,j,k) - 
               (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))))/
        (L1*L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],4)*
          pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               4*pow(rh,2)*
        ...
        ((pow(-1 + rgrid[i],2)*
          ...
          (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
            ...
            2*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
             Qr2(i,j,k)*Qt2(i,j,k) - 
            2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k)))/
        (2.*pow(rh,4)) - (2*pow(L2,2)*(1 - pow(1 - rgrid[i],2))*
          ...
          (2*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
            ...
            L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
        pow(rh,2) - 16*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        pow(1 - rgrid[i],4)*pow(1 + 
        ...
        (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          L1*L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
           ...
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
             pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))/
   (2.*L1*pow(L2,3)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
     ...
     ((-4*Qt1.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*
       ...
       ((-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        ...
        (2.*pow(L1,2)*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          ...
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (2.*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) + 
  (Qt1.diff(d001,i,j,k)*L1*((8*Qtr.diff(d010,i,j,k)*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))/
       ...
       (pow(rh,2)*(-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
                     ...
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                         4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                (2.*pow(rh,4))))*
          ((4*L1*pow(L2,3)*pow(1 - pow(1 - rgrid[i],2),3)*
            ...
            L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (-(pow(L1,2)*pow(L2,2)*
               ...
               (4*L1*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),3)*
                  ...
                  (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
                pow(rh,2) + 
               16*L1*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],4)*
        ...
        (pow(L1,2)*pow(L2,3)*
          ...
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (2.*(1 - rgrid[i])) + (8*h2.diff(d001,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
     (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (Qt2.diff(d010,i,j,k)*L2*((-8*Qtr.diff(d010,i,j,k)*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))/
        (pow(L1,2)*pow(L2,2)*pow(rh,2)*
             ...
             (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
               ...
               L1*L2*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
                ...
                sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))/
        (pow(L1,2)*pow(L2,3)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
   ...
   (2.*(1 - rgrid[i])) + (R.diff(d010,i,j,k)*
     ((64*Qr1.diff(d010,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],3)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
        (L1*L2*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
     ...
     ((-32*Qr1.diff(d010,i,j,k)*pow(rh,2)*
       ...
       (2*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                   ...
                   (-((1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
                     ...
                     R0*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                      (1 + pow(R0,2) + 
                        ...
                        pow(1 - pow(1 - rgrid[i],2),2)*
                         pow(R(i,j,k),2)))) + 
               pow(L2,2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        ...
        (pow(L1,2)*pow(L2,4)*
          ...
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (2.*(1 - rgrid[i])) - (Qr2.diff(d001,i,j,k)*pow(rh,4)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)))*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        Qr2(i,j,k) + (pow(L2,3)*pow(1 - pow(1 - rgrid[i],2),3)*
          pow(1 - rgrid[i],3)*pow(-1 + rgrid[i],6)*
          pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
          ...
          pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*
                (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))),2)*
          (4*pow(L2,3)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),4)*
             pow(1 - rgrid[i],2)*
             ((pow(-1 + rgrid[i],2)*
                  (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],2) + 
             ...
             (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
               ...
               2*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                Qr2(i,j,k)*Qt2(i,j,k) - 
               2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k)) \
+ 16*pow(L2,3)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
             pow(1 - rgrid[i],3)*
             (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
             pow(Qr2(i,j,k),2)*
             (2*L1*R0*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
            ...
            16*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
             (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt2(i,j,k)*
             (2*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                Qr1(i,j,k)*Qt1(i,j,k) + 
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
        (16.*pow(rh,8)) + ((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          (4*pow(L2,2)*(1 - pow(1 - rgrid[i],2))*
             (2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
             (1 - rgrid[i])*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
             Qr2(i,j,k) + 2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (pow(rh,4)*(2*Qr2.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
        (1 - rgrid[i]) + (-2*(1 - pow(1 - rgrid[i],2)) + 
       ...
       L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ((L1*L2*(1 - rgrid[i])*pow(-1 + rgrid[i],6)*
             ...
             (4*pow(L1,2)*pow(1 - pow(1 - rgrid[i],2),4)*
                ...
                pow(Qt1(i,j,k),2) + 
               12*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),4)*
...
+ 4*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
                ...
                (16*L1*L2*R0*pow(1 - pow(1 - rgrid[i],2),2)*
                   ...
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       ...
                       pow(1 - pow(1 - rgrid[i],2),2)*
                        pow(R(i,j,k),2))) + 
                  12*pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
                   pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2)*
                   sqrt((1 + pow(R0,2))*
                     (1 + pow(R0,2) + 
                       2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
   ...
   (4.*pow(L1,2)*pow(L2,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (pow(rh,2)*(-8*pow(L2,2)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
        pow(1 - rgrid[i],3)*Qr2(i,j,k)*
        (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       ...
       4*pow(L1,2)*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
        ...
        (pow(1 - pow(1 - rgrid[i],2),2)*
           (2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
              ((16*pow(L2,2)*pow(q,2)*pow(a2(i,j,k),2)*
                   (pow(h1(i,j,k),2)*
                      pow(1 - pow(1 - rgrid[i],2),2) + 
                     pow(h2(i,j,k),2)*
                      pow(1 - pow(1 - rgrid[i],2),2))*
                   pow(1 - rgrid[i],3))/sqrt(1 + pow(R0,2)) - 
                (32*pow(L2,2)*pow(q,2)*a0(i,j,k)*a2(i,j,k)*
                   (pow(h1(i,j,k),2)*
                      pow(1 - pow(1 - rgrid[i],2),2) + 
                     pow(h2(i,j,k),2)*
                      pow(1 - pow(1 - rgrid[i],2),2))*
...
+ 4*(1 - rgrid[i])*(pow(L2,2)*
       ...
       (16*B.diff(d001,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
        ...
        (pow(L2,2)*pow(-1 + rgrid[i],2)*
          ...
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))))/
   (2.*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) + 
  Qr2.diff(d020,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2)*pow(Qr1(i,j,k),2) + 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qr2.diff(d002,i,j,k)*(4*pow(1 - pow(1 - rgrid[i],2),2)*
      pow(1 - rgrid[i],2)*pow(Qr2(i,j,k),2) + 
...
+ 4*(1 - rgrid[i])*(pow(L2,2)*
               ...
               2*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                ...
                sqrt(1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))\
)/(pow(L1,3)*pow(L2,3)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
   ...
   (2.*(1 - rgrid[i])) + (Q.diff(d001,i,j,k)*
     ((-64*Qr2.diff(d010,i,j,k)*pow(rh,2)*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],3)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
        (L1*L2*pow(-1 + rgrid[i],2)*
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))))/
   (2.*(1 - rgrid[i])) + ((Qtt.diff(d100,i,j,k)*
        (1 - pow(1 - rgrid[i],2)) + 2*(1 - rgrid[i])*Qtt(i,j,k))*
...
+ 4*(1 - rgrid[i])*(pow(L2,2)*
        ...
        (pow(L1,2)*pow(L2,2)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   (2.*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) + 
  (B.diff(d010,i,j,k)*((-32*R.diff(d001,i,j,k)*pow(rh,2)*
          pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
          Qr2(i,j,k)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
        (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          pow(-1 + rgrid[i],2)*
   ...
   (2.*(1 - rgrid[i])) + (Qrr.diff(d001,i,j,k)*
     ((2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
          (2*Qr2.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
            ...
            (-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
             Qr2(i,j,k)))/(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
       2*Qr2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
       ...
       (pow(rh,2)*(16*pow(L2,2)*pow(rh,2)*
            ...
            128*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
             pow(1 - rgrid[i],5)*
             (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
        ...
        (2.*pow(L2,2)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
...
+ 8*pow(1 - rgrid[i],2)*(4*L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
       ...
       (8*Qrr.diff(d001,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))))/
   (2.*(1 - rgrid[i])) + (h1.diff(d010,i,j,k)*
     ((16*q*pow(rh,2)*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*
          pow(1 - rgrid[i],2)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (L2*((2*ar(i,j,k)*(1 - rgrid[i]))/
                (1 - pow(1 - rgrid[i],2)) - 
            ...
            (L2*a2(i,j,k)*(2*L1*
                 ...
                 2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                  ...
                  sqrt(1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),2)*
                     pow(R(i,j,k),2))))/pow(1 + pow(R0,2),0.25) - 
            a0(i,j,k)*pow(1 - rgrid[i],2)*
             (2*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                Qr1(i,j,k)*Qt2(i,j,k)*
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) \
- L2*(4*L1*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
                   Qr1(i,j,k)*Qt1(i,j,k) + 
                  2*L2*pow(1 - pow(1 - rgrid[i],2),2)*
                   (1 - rgrid[i])*Qr2(i,j,k)*Qt2(i,j,k) - 
                  2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
...
+ (h2.diff(d010,i,j,k)*((16*q*pow(rh,2)*h1(i,j,k)*
          (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (-(L2*((2*ar(i,j,k)*(1 - rgrid[i]))/
                  (1 - pow(1 - rgrid[i],2)) - 
               ...
               sqrt(1 + pow(R0,2) + 
                 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                 pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))) \
- (L2*a2(i,j,k)*(2*L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                  (1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                  Qr1(i,j,k)*
                  (1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)) + 
       (16*a0.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(1 - rgrid[i],4)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (4*L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
             Qr2(i,j,k)*Qt2(i,j,k) - 
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
       (64*h2.diff(d010,i,j,k)*q*pow(rh,2)*h1(i,j,k)*
          pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*
          ygrid[k]*Qr1(i,j,k)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
       (64*h1.diff(d010,i,j,k)*q*pow(rh,2)*h2(i,j,k)*
          pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],3)*
          ygrid[k]*Qr1(i,j,k)*
          (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
          (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
            ...
            a0(i,j,k)*pow(1 - rgrid[i],2)*
             (2*L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                ...
                (1 + pow(R0,2) + 
                  2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                  pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)) - 
               L2*(4*L1*pow(1 - pow(1 - rgrid[i],2),2)*
                   (1 - rgrid[i])*Qr1(i,j,k)*Qt1(i,j,k) + 
                  2*L2*pow(1 - pow(1 - rgrid[i],2),2)*
                   (1 - rgrid[i])*Qr2(i,j,k)*Qt2(i,j,k) - 
                  2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qtr(i,j,k)\
