...
elem[26]+=
4*h2.diff(d100,i,j,k)*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],3)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   ((1 - pow(1 - rgrid[i],2))*
      (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - Qtr(i,j,k)) - 
  4*h1.diff(d100,i,j,k)*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],3)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   ((1 - pow(1 - rgrid[i],2))*
      (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - Qtr(i,j,k)) + 
  8*h1.diff(d010,i,j,k)*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],4)*Qr1(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   ((1 - pow(1 - rgrid[i],2))*
      (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - Qtr(i,j,k)) + 
  8*h1.diff(d001,i,j,k)*q*h2(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],4)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   ((1 - pow(1 - rgrid[i],2))*
      (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - Qtr(i,j,k)) + 
  8*h2.diff(d010,i,j,k)*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],4)*Qr1(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   (-((1 - pow(1 - rgrid[i],2))*
        (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))) + Qtr(i,j,k)) \
+ 8*h2.diff(d001,i,j,k)*q*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],4)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   (-((1 - pow(1 - rgrid[i],2))*
        (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k))) + Qtr(i,j,k)) \
+ (2*pow(q,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
  ...
  (16*a0.diff(d010,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  2*H*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
   (4*L1*L2*pow(q,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
