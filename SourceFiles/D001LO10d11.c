...
((128*a0.diff(d010,i,j,k)*pow(rh,4)*
    ...
    (32*a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
     ...
     (L2*pow(-1 + rgrid[i],4)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (64*ar.diff(d010,i,j,k)*pow(rh,4)*pow(1 - rgrid[i],4)*
       (-(L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
             pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
    ...
    (64*pow(rh,4)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (L2*pow(-1 + rgrid[i],4)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
    (32*a0.diff(d100,i,j,k)*pow(rh,4)*
     ...
     (L2*pow(-1 + rgrid[i],4)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (32*a2.diff(d100,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     ...
     (L2*pow(1 + pow(R0,2),0.25)*pow(-1 + rgrid[i],4)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
    (64*ar.diff(d001,i,j,k)*pow(rh,4)*pow(1 - rgrid[i],4)*
