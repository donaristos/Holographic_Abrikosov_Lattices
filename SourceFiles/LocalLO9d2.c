...
elem[129]+=
(2*Qrr.diff(d001,i,j,k)*Qtr.diff(d100,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i]))/
   (L2*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) - 
  (2*Qrr.diff(d001,i,j,k)*Qt1.diff(d100,i,j,k)*L1*
  ...
  (64*pow(a0.diff(d001,i,j,k),2)*pow(rh,4)*
   ...
   (pow(L2,2)*pow(-1 + rgrid[i],4)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  Qtt.diff(d001,i,j,k)*((4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     ...
     (16*Qt1.diff(d001,i,j,k)*pow(rh,2)*
      ...
      (pow(L2,2)*pow(-1 + rgrid[i],2)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)))) + 
  Qt2.diff(d010,i,j,k)*((4*Qrr.diff(d001,i,j,k)*
  ...
  Qrr.diff(d001,i,j,k)*((-4*Qtr.diff(d001,i,j,k)*
     ...
     (4*Qt1.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),4)*
      ...
      (L2*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) + 
     (4*Qt2.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  (2*Qt1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   ...
   (L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
  (4*pow(rh,4)*(1 - rgrid[i])*Qt2(i,j,k)*
     (((1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  a0.diff(d010,i,j,k)*((-64*a2.diff(d010,i,j,k)*pow(rh,4)*
     ...
     (64*a0.diff(d001,i,j,k)*pow(rh,4)*
      ...
      (L1*L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  Qt2.diff(d100,i,j,k)*((-2*Qrr.diff(d001,i,j,k)*
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2))) + 
  Qt1.diff(d010,i,j,k)*((4*Qrr.diff(d001,i,j,k)*L1*
        pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
        pow(Qr1(i,j,k),2))/
      (L2*pow(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k),2)) + 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  B.diff(d010,i,j,k)*((16*Qt2.diff(d010,i,j,k)*pow(rh,2)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
