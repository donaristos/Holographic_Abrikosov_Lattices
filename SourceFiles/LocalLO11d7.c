...
elem[166]+=
-4*a0.diff(d101,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i]) + 
  4*a0.diff(d001,i,j,k)*Qr1.diff(d010,i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2) + 
  8*a0.diff(d001,i,j,k)*Qr2.diff(d001,i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2) - 
  ...
  (4*a0.diff(d001,i,j,k)*Q.diff(d010,i,j,k)*
   ...
   (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  8*a0.diff(d002,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
   pow(1 - rgrid[i],2)*Qr2(i,j,k) + 
  Q.diff(d001,i,j,k)*((4*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2))/
      (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  ...
  (2*a0.diff(d001,i,j,k)*Qrr.diff(d010,i,j,k)*
     pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*Qr1(i,j,k))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  Qrr.diff(d001,i,j,k)*((-2*a0(i,j,k)*
  ...
  Qtt.diff(d001,i,j,k)*((-2*a0(i,j,k)*
     ...
     (4*a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(1 - rgrid[i],2)*Qr2(i,j,k))/
      (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
  a2.diff(d100,i,j,k)*((Qt1.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
  ...
  a1.diff(d100,i,j,k)*(-(Qt1.diff(d001,i,j,k)*
         pow(1 + pow(R0,2),0.25)*pow(1 - pow(1 - rgrid[i],2),2)*
         pow(-1 + rgrid[i],2)*
         (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
           pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  Qt2.diff(d010,i,j,k)*((ar.diff(d001,i,j,k)*
     ...
     (ar.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
     ...
     (2*a1.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
      ...
      (L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     (L2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
  ...
  Qt1.diff(d001,i,j,k)*(-((ar.diff(d001,i,j,k)*
     ...
     (a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (L2*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  H*((Qtr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
     ...
     (L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
      ...
      (pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  a2.diff(d010,i,j,k)*((Qtr.diff(d001,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
  ...
  a1.diff(d001,i,j,k)*((pow(1 + pow(R0,2),0.25)*
     ...
     (pow(1 + pow(R0,2),0.25)*(1 - pow(1 - rgrid[i],2))*
      ...
      (pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  a0.diff(d001,i,j,k)*(8*(1 - pow(1 - rgrid[i],2)) - 
     4*pow(1 - rgrid[i],2) - 
     ...
     (pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*
      ...
      (pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  a0.diff(d010,i,j,k)*(4*Qr1.diff(d001,i,j,k)*
      pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2) + 
