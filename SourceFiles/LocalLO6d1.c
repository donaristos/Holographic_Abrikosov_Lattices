...
- (1 - pow(1 - rgrid[i],2))*
  ...
  (16*pow(Qtt.diff(d001,i,j,k),2)*pow(rh,2)*
   ...
   (L1*L2*pow(-1 + rgrid[i],2)*
     ...
     pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3)) + 
  a0.diff(d001,i,j,k)*((16*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
        pow(1 - rgrid[i],4)*
      ...
      ((-8*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],5)*
        ...
        (32*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
         ...
         (L1*L2*pow(-1 + rgrid[i],4)*
           ...
           pow(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k),2)*
           pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2))) + 
     a0.diff(d010,i,j,k)*((8*pow(1 - pow(1 - rgrid[i],2),4)*
           pow(1 - rgrid[i],5)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           pow(Qt2(i,j,k),2))/
         (pow(-1 + rgrid[i],2)*
  ...
  a0.diff(d010,i,j,k)*((-16*a0(i,j,k)*
     ...
     (64*pow(rh,4)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
     a0.diff(d001,i,j,k)*((16*pow(1 - pow(1 - rgrid[i],2),4)*
           pow(1 - rgrid[i],6)*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt2(i,j,k)*
              ...
              (L2*Qr2(i,j,k)*(1 + pow(R0,2) + 
                ...
                L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qr1(i,j,k)*
                 ...
                 sqrt(1 + pow(R0,2) + 
                   2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                   pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))))/
         (pow(L1,2)*(L2 + L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           pow(-1 + rgrid[i],4)*
           pow(pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
             pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                 pow(rgrid[i],3) + 
        ...
        ((L1*L2*pow(1 - pow(1 - rgrid[i],2),2)*
           ...
           (1 - rgrid[i])*(16*L1*L2*R0*pow(rh,2)*
             ...
             (pow(q,2)*(pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
                ...
                (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
              sqrt(1 + pow(R0,2)) + 
             Qr1(i,j,k)*(L1*L2*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
                 (2*(1 - rgrid[i])*
                    ((pow(-1 + rgrid[i],2)*
                       (6*pow(H,2)*pow(-2 + rgrid[i],3)*
                       rgrid[i] + 
  ...
  Qtt.diff(d100,i,j,k)*((-4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     ...
     (8*Qtt.diff(d010,i,j,k)*pow(rh,2)*
      ...
      (pow(L1,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),3))) + 
  Qtt.diff(d010,i,j,k)*((-32*pow(rh,6)*(1 - pow(1 - rgrid[i],2))*
