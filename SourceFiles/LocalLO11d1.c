...
elem[160]+=
(-2*a0(i,j,k)*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  (2*a0(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  Qtt.diff(d100,i,j,k)*((a0.diff(d100,i,j,k)*
        pow(1 - pow(1 - rgrid[i],2),2))/
      (2.*pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) - 
     (a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2))/
      ((1 - rgrid[i])*pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) \
- (a0.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  Qtt.diff(d010,i,j,k)*((2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
...
+ Qt2.diff(d010,i,j,k)*(-((ar.diff(d010,i,j,k)*
  ...
  a2.diff(d100,i,j,k)*((Qtr.diff(d010,i,j,k)*
     ...
     (Qt1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (2.*L2*pow(1 + pow(R0,2),0.25)*pow(rh,4)*(1 - rgrid[i])*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  Qtt.diff(d001,i,j,k)*((2*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
...
- (a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*pow(-1 + rgrid[i],2)*
        ...
        (-(R0*Qt1(i,j,k)) - (1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
           ...
           Qt2(i,j,k)*sqrt(1 + 
             pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))/
      (L2*pow(rh,4)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) + 
  a0.diff(d100,i,j,k)*(-((Qtt.diff(d010,i,j,k)*
