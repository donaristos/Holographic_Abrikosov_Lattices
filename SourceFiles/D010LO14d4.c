...
elem[211]+=
((-2*a2.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
       (1 - rgrid[i])*Qr1(i,j,k)*
       ...
       pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
         ...
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
    (8*a1.diff(d100,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
       ...
       pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
         ...
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
    (16*ar.diff(d010,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*(1 + 
    ...
    (4*a2.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       ((4*pow(rh,2)*Qr2(i,j,k)*
         ...
         (2*pow(1 - pow(1 - rgrid[i],2),2)*pow(Qr1(i,j,k),2)*
          ...
          (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))))/
     pow(1 + pow(R0,2),0.25) + 
    (4*H*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))*
       (pow(L1,3)*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(Qr1(i,j,k),3)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) \
+ (4*L2*pow(rh,4)*Qr2(i,j,k)*
            (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k) + 
              ...
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                 ...
                 4*pow(rh,2)*
                  (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                    4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
            (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
         (2*pow(L1,2)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
            pow(Qr1(i,j,k),2)*Qr2(i,j,k)*
            sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
