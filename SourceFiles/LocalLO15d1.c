...
(-64*pow(q,2)*pow(rh,6)*pow(a0(i,j,k),2)*h1(i,j,k)*
  ...
  (2*h1(i,j,k)*pow(1 - rgrid[i],2)*Qtt(i,j,k))/
   pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2) + 
  (4*h1(i,j,k)*pow(1 - rgrid[i],2))/
   (2*(1 - pow(1 - rgrid[i],2)) + 
     2*pow(1 - pow(1 - rgrid[i],2),2)*Qtt(i,j,k)) + 
  h1.diff(d100,i,j,k)*((Qtt.diff(d010,i,j,k)*
  ...
  h1.diff(d010,i,j,k)*((2*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (2*Qtt.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
      ...
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) + 
  (q*h2(i,j,k)*pow(1 - rgrid[i],2)*Qtt(i,j,k)*
  ...
  Qtt.diff(d100,i,j,k)*(-(h1.diff(d100,i,j,k)*
         pow(1 - pow(1 - rgrid[i],2),2))/
     ...
     (q*h2(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
      ...
      (4.*pow(1 + pow(R0,2),0.25)*
        pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2))) + 
  H*((Qtt.diff(d100,i,j,k)*L1*L2*q*h2(i,j,k)*
  ...
  Qtt.diff(d001,i,j,k)*((2*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
        ...
        pow(1 - rgrid[i],2)*(pow(1 - pow(1 - rgrid[i],2),2)*
          ...
          (4*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
           ...
           (pow(L2,2)*pow(-1 + rgrid[i],2)*
             ...
             (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
      pow(1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k),2)) + 
  Qtt.diff(d010,i,j,k)*((2*h1(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
