...
elem[218]+=
(Qtr.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (4 - (8*pow(1 - rgrid[i],2))/(1 - pow(1 - rgrid[i],2)) + 
  ...
  (2*Qr1.diff(d100,i,j,k)*L1*pow(rh,4)*
...
+ (1 - pow(1 - rgrid[i],2))*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (2*Qr2.diff(d100,i,j,k)*L2*pow(rh,4)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     ((2*pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (2*pow(rh,4)*(1 - rgrid[i])*
     ...
     ((1 - pow(1 - rgrid[i],2))*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
  (2*Qrr.diff(d100,i,j,k)*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*((2*pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
               4*pow(rh,2)*
...
+ (1 - pow(1 - rgrid[i],2))*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
  (2*Q.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     (1 - rgrid[i])*Qtr(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
  (8*pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],2)*Q(i,j,k)*
     Qtr(i,j,k))/(2 + 2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
  (4*Q.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  (4*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
          ...
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
               ...
               4*pow(rh,2)*
                (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                  4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
          (16*L1*pow(1 - rgrid[i],2)*Qr1(i,j,k)*Qt1(i,j,k) + 
            16*L2*pow(1 - rgrid[i],2)*Qr2(i,j,k)*Qt2(i,j,k) - 
            2*Qtr(i,j,k)))/(4.*pow(rh,4)) + 
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (Qtt.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  (2*R.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  (Qtr.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
   ...
   (L1*pow(rh,4)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (4*Qr2.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),4)*
   ...
   (L1*pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (8*Qtt.diff(d010,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (8*Qrr.diff(d010,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(-((1 + 
...
- Qtr(i,j,k)))/(4.*pow(rh,2)) + 
   ...
   (L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*pow(-1 + rgrid[i],2)*
     ...
     (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  (16*R.diff(d001,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  2*Qrr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   pow(1 - rgrid[i],2)*(-(((1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
          ((1 - pow(1 - rgrid[i],2))*
             (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - 
        ...
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
             ...
             4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
        (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))) - 
  (16*R.diff(d010,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  (2*Qtt.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*((1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
        ...
        (L2*pow(-1 + rgrid[i],2)*
          ...
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
  (2*Qt2.diff(d100,i,j,k)*L2*pow(rh,4)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
          ...
          (Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
            (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))))/
        (4.*pow(rh,8)*(L2 + L2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)))))/
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
  ...
  (4*L2*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
   ...
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
  (4*Qr1.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),4)*
  ...
  (4*Qr1.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*(-(L2*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k)*
          (1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
            pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))*
          (Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
            (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
...
- L2*Qr2(i,j,k)*(Qt1(i,j,k)*(1 + pow(R0,2) + 
  ...
  (4*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],2)*
     ...
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
   pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) - 
  (16*B.diff(d001,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
...
- L2*Qr2(i,j,k)*(Qt1(i,j,k)*(R0 + 
     ...
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (16*B.diff(d010,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),3)*
     pow(1 - rgrid[i],2)*((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
        Qt1(i,j,k) + (L1*pow(1 - pow(1 - rgrid[i],2),2)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  (2*Qt1.diff(d100,i,j,k)*L1*pow(rh,4)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
     (2*(1 - rgrid[i])*(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
             (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
       ...
       (pow(1 - pow(1 - rgrid[i],2),2)*pow(-1 + rgrid[i],4)*
          ...
          (Qt1(i,j,k)*(1 + pow(R0 + 
            ...
            (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
             (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
             sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))\
)/(4.*L1*pow(rh,8)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
          (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
          sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))))/
   (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
             4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
  (4*L1*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*
