...
elem[182]+=
((8*a2.diff(d001,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
       pow(1 - rgrid[i],2)*Qr2(i,j,k))/(L1*sqrt(1 + pow(R0,2))) + 
    (4*ar.diff(d001,i,j,k)*pow(1 - rgrid[i],2)*
    ...
    (2*a0.diff(d100,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    (4*a0.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     ...
     (pow(1 + pow(R0,2),0.25)*
       (L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    ((1 - rgrid[i])*((L2*ar(i,j,k)*pow(-1 + rgrid[i],2)*
...
- ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
...
)/(2.*pow(rh,2)) + L2*(1 - rgrid[i])*
          ((-8*a2(i,j,k))/pow(1 + pow(R0,2),0.25) + 
                    ...
                    pow(rh,2)*
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                         4*pow(rgrid[i],3) + pow(rgrid[i],4))))) + 
               2*Qt2(i,j,k)*(4*pow(1 - rgrid[i],2) - 
                  2*(1 - pow(1 - rgrid[i],2))*
                   (1 + pow(R0,2) + 
                     2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                     pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)\
)) + (4*(1 - pow(1 - rgrid[i],2))*Qt1(i,j,k)*
                  (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
                  sqrt(1 + pow(R0,2) + 
                    2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
                    pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2))\
    ...
    (2*a1.diff(d100,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     (L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
    (4*ar.diff(d010,i,j,k)*L2*pow(1 - rgrid[i],2)*
       (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     (pow(L1,2)*pow(1 + pow(R0,2),0.25)*
       (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))))*
