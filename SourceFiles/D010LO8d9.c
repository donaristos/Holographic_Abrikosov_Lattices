...
elem[120]+=
((-2*Q.diff(d100,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
       (1 - rgrid[i])*Qr2(i,j,k))/
     (L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
    (4*Q.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
       pow(1 - rgrid[i],2)*Qr1(i,j,k)*Qr2(i,j,k))/
     (L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
    (4*Qrr.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
       pow(1 - rgrid[i],2)*Qr1(i,j,k)*Qr2(i,j,k))/
     (L1 + L1*(1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
    (2*Qtt.diff(d100,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
       (1 - rgrid[i])*Qr2(i,j,k))/
     (L1 + L1*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
    (4*Qtt.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
    ...
    (4*B.diff(d010,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     (L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
    (16*Qtt.diff(d001,i,j,k)*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*
...
+ (4*pow(rh,2)*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
    ...
    (4*B.diff(d001,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
       pow(1 - rgrid[i],2)*((pow(1 - pow(1 - rgrid[i],2),2)*
            pow(Qr2(i,j,k),2)*
    ...
    2*(1 - rgrid[i])*((-2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
          Q(i,j,k)*Qr2(i,j,k))/
        (L1 + L1*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
       (L2*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
          ...
          ((1 - pow(1 - rgrid[i],2))*
            ...
            Qtr(i,j,k))*Qtr(i,j,k))/(4.*L1*pow(rh,6)) + 
       (2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*
          Qtt(i,j,k))/(L1 + L1*(1 - pow(1 - rgrid[i],2))*Qtt(i,j,k)) + 
       ...
       (2*L2*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
          Qr2(i,j,k)*(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
             2)))/(L1 + L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2))) - 
       2*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
        (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)) + 
       ((1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
               ...
               (Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
                 (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
                  sqrt(1 + pow(R0 + 
                      (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))/
             (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))))/
        (4.*L1*pow(rh,4)) + (4*L2*(1 - rgrid[i])*Qr2(i,j,k) + 
          (pow(1 - pow(1 - rgrid[i],2),2)*
             ((pow(-1 + rgrid[i],2)*
                  (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                     pow(rgrid[i],2) + 
             ...
             (Qt1(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
               (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
                sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
                   2))))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)))/L1))*
