...
elem[219]+=
(-(Qr1.diff(d100,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
    ...
    (4*Qtt.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,2)*
     ...
     (L2*pow(-1 + rgrid[i],2)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
    (R.diff(d100,i,j,k)*L2*pow(1 + pow(R0,2),0.25)*
    ...
    (2*R.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
       ...
       ((4*pow(rh,2)*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)))/
         ...
         (pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
          ...
          ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
            sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))))\
)/L2 - (2*Qr1.diff(d001,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
       pow(1 - pow(1 - rgrid[i],2),3)*(1 - rgrid[i])*
       (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k))*
    ...
    (2*B.diff(d001,i,j,k)*pow(1 + pow(R0,2),0.25)*
       ...
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) + 
    (8*B.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
       pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
       (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k) + 
       ...
       pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
         ...
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
    Qrr.diff(d010,i,j,k)*L1*pow(1 + pow(R0,2),0.25)*
     pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
    ...
    (pow(1 + pow(R0,2),0.25)*(1 - pow(1 - rgrid[i],2))*
       ((L1*(-2*(1 - pow(1 - rgrid[i],2)) - 16*pow(1 - rgrid[i],2))*
            Qr1(i,j,k))/(1 - rgrid[i]) - 
