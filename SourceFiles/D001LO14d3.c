...
elem[210]+=
((8*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
       Qr2(i,j,k)*Qtr(i,j,k))/(2 + 2*(1 - pow(1 - rgrid[i],2))*Q(i,j,k)) \
- (8*a0.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
    ...
    (16*H*pow(rh,4)*pow(1 - pow(1 - rgrid[i],2),3)*
