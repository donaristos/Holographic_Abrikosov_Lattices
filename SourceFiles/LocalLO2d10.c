...
elem[25]+=
-4*h2.diff(d100,i,j,k)*q*a0(i,j,k)*h1(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) + 
  4*h1.diff(d100,i,j,k)*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],3)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  (Qtr.diff(d100,i,j,k)*pow(-1 + rgrid[i],2)*
   ...
   (2.*pow(rh,2)) + 8*h2.diff(d010,i,j,k)*q*a0(i,j,k)*h1(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr1(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  8*h1.diff(d010,i,j,k)*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr1(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  8*h2.diff(d001,i,j,k)*q*a0(i,j,k)*h1(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
  8*h1.diff(d001,i,j,k)*q*a0(i,j,k)*h2(i,j,k)*
   pow(1 - pow(1 - rgrid[i],2),3)*pow(1 - rgrid[i],4)*Qr2(i,j,k)*
   (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k)) - 
...
)/pow(rh,2) + (Qrr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     (1 - rgrid[i])*pow(-1 + rgrid[i],2)*
     (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
       pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
           pow(rgrid[i],3) + 
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4))))*(1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
     Qtr(i,j,k))/(4.*pow(rh,2)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])) \
- ((1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
                    ...
                    pow(rh,2)*
                     (pow(mu,2)*pow(-2 + rgrid[i],3)*
                       ...
                       4*pow(rh,2)*
                        ...
                        4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
                (2.*pow(rh,4))))/pow(rh,4) + 
          6*(1 - rgrid[i])*pow((pow(-1 + rgrid[i],2)*
                (3*pow(H,2)*pow(-2 + rgrid[i],3)*
                   pow(rgrid[i],2) + 
                  3*pow(H,2)*pow(-2 + rgrid[i],2)*
                   pow(rgrid[i],3) + 
             ...
             ((-1 + rgrid[i])*
              ...
              (2.*pow(rh,4)),2))*
        (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) + 
       (32*pow(1 + pow(R0,2),0.25)*(1 - rgrid[i])*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
  ...
  (Qt1.diff(d100,i,j,k)*L1*(1 - pow(1 - rgrid[i],2))*
   ...
   (pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
     ...
     sqrt(1 + pow(R0,2) + 2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) - (Qrr.diff(d100,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        pow(rgrid[i],3) + pow(rh,2)*
        (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
