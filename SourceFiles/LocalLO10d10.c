...
-6/(1 - pow(1 - rgrid[i],2)) + 
  ((-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
     ...
     (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
       ...
       3*Qtr(i,j,k))*Qtr(i,j,k))/(8.*pow(rh,2)*(1 - rgrid[i])) + 
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)))*Qt1(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,2)) - 
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
               ...
               pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
                  ...
                  4*pow(rh,2)*
                   (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                     4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
           (2.*pow(rh,4)))*Qt2(i,j,k)*Qtr(i,j,k))/(4.*pow(rh,2)) - 
     (L2*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
          pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
              pow(rgrid[i],3) + 
     ...
     (-(((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
        ...
        ((pow(-1 + rgrid[i],2)*
          ...
          ((-1 + rgrid[i])*(pow(H,2)*pow(-2 + rgrid[i],3)*
           ...
           (2.*pow(rh,4))))*(2*(1 - pow(1 - rgrid[i],2))*
        (L1*Qr1(i,j,k)*Qt1(i,j,k) + L2*Qr2(i,j,k)*Qt2(i,j,k)) - 
       3*Qtr(i,j,k))*sqrt(1 + pow(R0,2) + 
       2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
       pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
   (4.*pow(rh,2)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),
        2))) + (64*pow(a0.diff(d010,i,j,k),2)*pow(rh,4)*
...
- (1 - pow(1 - rgrid[i],2))*
  ...
  a0.diff(d010,i,j,k)*((128*a0.diff(d001,i,j,k)*pow(rh,4)*
     ...
     (16*pow(rh,2)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
      ...
      (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
        ...
        (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))*
        sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))) + 
  a0.diff(d100,i,j,k)*((-8*a0.diff(d001,i,j,k)*pow(rh,2)*
  ...
  (pow(rh,6)*((-4*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
       ...
       (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
        (-256*pow(q,2)*pow(a0(i,j,k),2)*
           (pow(h1(i,j,k),2) + pow(h2(i,j,k),2))*
           pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],8)*
           (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
           (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*
           sqrt(1 + pow(R0,2) + 
             2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
          ...
          (8*pow(1 - pow(1 - rgrid[i],2),4)*pow(1 - rgrid[i],2)*
           ...
           pow(rh,4) + (pow(1 - pow(1 - rgrid[i],2),3)*
             ...
             sqrt(1 + pow(R0,2) + 
               2*R0*(1 - pow(1 - rgrid[i],2))*R(i,j,k) + 
               pow(1 - pow(1 - rgrid[i],2),2)*pow(R(i,j,k),2)))/
           (2.*pow(rh,8)) - (pow(1 - pow(1 - rgrid[i],2),2)*
             (6*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
             pow(1 - rgrid[i],2)*pow(-1 + rgrid[i],8)*
             pow(pow(H,2)*pow(-2 + rgrid[i],3)*
                pow(rgrid[i],3) + 
