...
elem[211]+=
((8*a2.diff(d001,i,j,k)*pow(rh,2)*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    (8*a1.diff(d010,i,j,k)*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
         ...
         4*pow(L1,2)*a0(i,j,k)*pow(1 - pow(1 - rgrid[i],2),4)*
          (1 - rgrid[i])*(-(L1*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
               Qr1(i,j,k)*((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
                  Qt2(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) \
- Qt1(i,j,k)*sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))\
) + L2*Qr2(i,j,k)*(Qt1(i,j,k)*
                (R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)) - 
               (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*Qt2(i,j,k)*
