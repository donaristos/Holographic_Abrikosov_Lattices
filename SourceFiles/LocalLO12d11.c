...
elem[186]+=
(4*Qt1.diff(d010,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*((2*pow(1 - rgrid[i],2)*
          pow(-1 + rgrid[i],2)*
...
- (8*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Q(i,j,k)*Qt1(i,j,k))/
   (pow(1 + pow(R0,2),0.25)*
...
+ (4*Q.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (pow(1 + pow(R0,2),0.25)*(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) \
+ (4*Qrr.diff(d010,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*((-2*pow(1 - rgrid[i],2)*
          pow(-1 + rgrid[i],2)*
          (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
...
+ (1 - pow(1 - rgrid[i],2))*
  ...
  (4*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
     (1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],2)*Qt2(i,j,k)*R(i,j,k))/
   (pow(1 + pow(R0,2),0.25)*
     sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
  ...
  (Qr2.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*((8*L2*pow(rh,4)*(1 - rgrid[i])*
  ...
  (4*Qt1.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*
     pow(1 - rgrid[i],2)*(L2*(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
...
- (Qt2.diff(d100,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
  ...
  (Qtr.diff(d001,i,j,k)*pow(1 - pow(1 - rgrid[i],2),3)*
   ...
   (L2*pow(1 + pow(R0,2),0.25)*pow(rh,4)*
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) + 
  (Qr1.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*((8*L1*pow(rh,4)*(1 - rgrid[i])*
          (((1 - rgrid[i])*pow(-1 + rgrid[i],2)*
               (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
                 pow(rh,2)*
                  (pow(mu,2)*pow(-2 + rgrid[i],3)*
  ...
  (Qt2.diff(d010,i,j,k)*L2*(1 - pow(1 - rgrid[i],2))*
     pow(1 - rgrid[i],2)*(-4*(1 - pow(1 - rgrid[i],2))*Qr2(i,j,k) + 
