     ...
     (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
         ...
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) - 
    (16*a0.diff(d100,i,j,k)*pow(rh,2)*
...
+ (L1*(1 - pow(1 - rgrid[i],2))*pow(-1 + rgrid[i],2)*
        ...
        pow(rh,2)) + (64*a0.diff(d010,i,j,k)*pow(rh,4)*
     ...
     (L1*L2*pow(-1 + rgrid[i],4)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (64*H*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*pow(1 - rgrid[i],4)*
     ...
     (L2*pow(-1 + rgrid[i],4)*
       ...
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qtt(i,j,k))) + 
    (64*a2.diff(d010,i,j,k)*pow(rh,4)*(1 - pow(1 - rgrid[i],2))*
    ...
    (128*a0.diff(d001,i,j,k)*pow(rh,4)*
       pow(1 - pow(1 - rgrid[i],2),2)*pow(1 - rgrid[i],6)*Qt1(i,j,k)*
       ((pow(L2,2)*pow(1 - pow(1 - rgrid[i],2),2)*
            pow(-1 + rgrid[i],2)*
            (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
              pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
