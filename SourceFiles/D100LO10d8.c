...
elem[151]+=
(-2*Qr1.diff(d100,i,j,k)*L1*(1 - pow(1 - rgrid[i],2)) - 
    (2*L1*(1 - pow(1 - rgrid[i],2))*Qr1(i,j,k))/(1 - rgrid[i]) - 
    (L1*(-2*(1 - pow(1 - rgrid[i],2)) + 4*pow(1 - rgrid[i],2))*
       Qr1(i,j,k))/(1 - rgrid[i]) - 
    (2*L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k))/
     ...
     (pow(-1 + rgrid[i],2)*(pow(H,2)*pow(-2 + rgrid[i],3)*
          ...
          (pow(mu,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))) - 
    (Q.diff(d100,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
       Qr1(i,j,k))/(1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
    (2*L1*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Q(i,j,k)*Qr1(i,j,k))/
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
    (2*Q.diff(d010,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
       (1 - rgrid[i])*pow(Qr1(i,j,k),2))/
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
    (2*Q.diff(d001,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),3)*
       (1 - rgrid[i])*Qr1(i,j,k)*Qr2(i,j,k))/
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) + 
    (Qrr.diff(d100,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    (Qtt.diff(d100,i,j,k)*L1*pow(1 - pow(1 - rgrid[i],2),2)*
    ...
    ((1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*pow(-1 + rgrid[i],2)*
       (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt2(i,j,k)*Qtr(i,j,k)*
    ...
    (pow(1 - pow(1 - rgrid[i],2),2)*
       ...
       Qt2(i,j,k)*Qtr(i,j,k)*(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k)))/
     (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k)) - 
    (2*L1*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr1(i,j,k)*
       pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))/
     (1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2))) + 
    (2*Qtt.diff(d001,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
    ...
    (R.diff(d100,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),2)*
       Qr2(i,j,k))/
     ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
    ...
    (2*R.diff(d010,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
     ...
     ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) + 
    (2*R.diff(d001,i,j,k)*L2*pow(1 - pow(1 - rgrid[i],2),3)*
       (1 - rgrid[i])*pow(Qr2(i,j,k),2))/
     ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
    (2*L2*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*Qr2(i,j,k)*R(i,j,k))/
     ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2))) - 
       ...
       (pow(H,2)*pow(-2 + rgrid[i],3)*pow(rgrid[i],3) + 
         pow(rh,2)*(pow(mu,2)*pow(-2 + rgrid[i],3)*
            ...
            4*pow(rh,2)*(1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
               4*pow(rgrid[i],3) + pow(rgrid[i],4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
    (2*L2*R0*B(i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
                  ...
                  (pow(mu,2)*pow(-2 + rgrid[i],3)*
                    ...
                    4*pow(rh,2)*
                     (1 + 2*rgrid[i] + 3*pow(rgrid[i],2) - 
                       4*pow(rgrid[i],3) + pow(rgrid[i],4)))))/
             (2.*pow(rh,4))))*
       (1 + (1 - pow(1 - rgrid[i],2))*Qrr(i,j,k))*Qt1(i,j,k)*Qtr(i,j,k)*
       sqrt(1 + pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     ((1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)))*
       (1 + (1 - pow(1 - rgrid[i],2))*Q(i,j,k))) - 
    (2*L2*B(i,j,k)*pow(1 - pow(1 - rgrid[i],2),2)*(1 - rgrid[i])*
       Qr2(i,j,k)*R(i,j,k)*sqrt(1 + 
         pow(R0 + (1 - pow(1 - rgrid[i],2))*R(i,j,k),2)))/
     pow(1 + B(i,j,k)*(1 - pow(1 - rgrid[i],2)),2) - 
    ...
    (2*Qtt.diff(d010,i,j,k)*(1 - pow(1 - rgrid[i],2))*(1 - rgrid[i])*
